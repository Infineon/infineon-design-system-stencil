...
const declaredVersion = packageJson.dependencies['@infineon/infineon-design-system-stencil']

// Display version information
document.addEventListener('DOMContentLoaded', () => {
  const versionDisplay = document.getElementById('version-display')
  if (versionDisplay) {
    const displayVersion = declaredVersion.includes('workspace') ? 'workspace' : declaredVersion.replace(/^[\^~]/, '')
