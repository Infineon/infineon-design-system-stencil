...
import { IfxButton, IfxTextField, IfxTooltip } from '@infineon/infineon-design-system-react';

export function IfxTooltipExample() {
  const [text, setText] = useState("Hi, I'm a tooltip");
  ...
  const [ariaLabel, setAriaLabel] = useState("Tooltip with important information");
  ...
  const formatPropValueForCode = (value: unknown): string => {
	...
	const codeStringWithProps = `import { IfxTooltip } from '@infineon/infineon-design-system-react';
