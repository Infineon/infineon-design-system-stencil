...
import { IfxButton, IfxNotification, IfxTextField } from '@infineon/infineon-design-system-react';

export function IfxNotificationExample() {
  const [label, setLabel] = useState("Sample Notification");
  ...
  const [linkHref, setLinkHref] = useState("https://www.example.com");
  ...
  const formatPropValueForCode = (value: unknown): string => {
    ...
    ["linkText", controlledProps["linkText"]],
    ["linkHref", controlledProps["linkHref"]],
    ["linkTarget", controlledProps["linkTarget"]],
	]
		.map(([name, value]) => `        ${String(name)}=${formatPropValueForCode(value)}`)
		.join("\n");

	const codeStringWithProps = `import { IfxNotification } from '@infineon/infineon-design-system-react';
