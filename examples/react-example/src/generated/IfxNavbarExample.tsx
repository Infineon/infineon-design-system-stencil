...
export function IfxNavbarExample() {
  ...
  return (
      <IfxNavbar
        ...
        showLogoAndAppname={String(controlledProps.showLogoAndAppname ?? "true")}
        ...
        <IfxNavbarItem
          ...
          showLabelOfNavbarItem={String(controlledProps.showLabelOfNavbarItem ?? "true")}
          iconOfNavbarItem={String(controlledProps.iconOfNavbarItem ?? "")}
          numberIndicator={String(controlledProps.numberIndicator ?? "")}
          dotIndicator={String(controlledProps.dotIndicator ?? "false")}
          hrefOfNavbarItem={String(controlledProps.hrefOfNavbarItem ?? "")}
          targetOfnavbarItem={String(controlledProps.targetOfnavbarItem ?? "_self")}
          hideOnMobile={String(controlledProps.hideOnMobile ?? "true")}>
          <IfxNavbarItem
            icon=""
            showLabelOfNavbarItem={String(controlledProps.showLabelOfNavbarItem ?? "true")}
            iconOfNavbarItem={String(controlledProps.iconOfNavbarItem ?? "")}
        ...
        <IfxSearchBar
          ...
          searchBarIsOpen={String(controlledProps.searchBarIsOpen ?? "false")} />
        <IfxNavbarItem
          slot="right-item"
          target="_blank"
          href="http://google.com"
        ...
        <IfxNavbarProfile
          ...
          imageUrl=""
          showLabel={true}
          showNavbarProfileLabel={String(controlledProps.showNavbarProfileLabel ?? "true")}
          href={String(controlledProps.href ?? "http://google.com")}
          profileImageUrl={String(controlledProps.profileImageUrl ?? "")}
          target={String(controlledProps.target ?? "_self")}
          alt={String(controlledProps.alt ?? "profile image")}
          userName={String(controlledProps.userName ?? "")} />
      </IfxNavbar>
  );
