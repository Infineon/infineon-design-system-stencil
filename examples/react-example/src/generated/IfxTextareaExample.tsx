...
export function IfxTextareaExample() {
  return (
	...
	return (
    <>
      <IfxTextarea {...(controlledProps as any)} />
        ...
        <IfxTextField label="cols" type="number" value={String(cols)} onInput={(event) => toggleCols(String((event.target as HTMLInputElement | null)?.value ?? ""))} />
