...
import { IfxButton, IfxTab, IfxTabs, IfxTextField } from '@infineon/infineon-design-system-react';

export function IfxTabsExample() {
  const [amountOfTabs, setAmountOfTabs] = useState(3);
  ...
  const toggleAmountOfTabs = (value: string) => setAmountOfTabs(Number(value));
  ...
  const formatPropValueForCode = (value: unknown): string => {
    ...
    ["amountOfTabs", controlledProps["amountOfTabs"]],
	...
	const codeStringWithProps = `import { IfxTab, IfxTabs } from '@infineon/infineon-design-system-react';
