...
export function IfxSidebarExample() {
  ...
  return (
      <IfxSidebar
        ...
        applicationName={String(controlledProps.applicationName ?? "Application Name")}
        showHeader={String(controlledProps.showHeader ?? "true")}
        showFooter={String(controlledProps.showFooter ?? "true")}
        initialCollapse={String(controlledProps.initialCollapse ?? "true")}
        ...
        termsOfUse={String(controlledProps.termsOfUse ?? "https://yourwebsite.com/terms")}
        privacyPolicy={String(controlledProps.privacyPolicy ?? "https://yourwebsite.com/privacy-policy")}
        copyrightText={String(controlledProps.copyrightText ?? "© 1999 - 2026 Infineon Technologies AG")}
        logoHref={String(controlledProps.logoHref ?? "http://google.com")}
        logoHrefTarget={String(controlledProps.logoHrefTarget ?? "_self")}
        footerHrefTarget={String(controlledProps.footerHrefTarget ?? "_blank")}
        ...
        <IfxSidebarItem
          ...
          hrefOfSidebarItem={String(controlledProps.hrefOfSidebarItem ?? "https://google.com")}
          targetOfSidebarItem={String(controlledProps.targetOfSidebarItem ?? "_self")}
          numberIndicatorOfSidebarItem={String(controlledProps.numberIndicatorOfSidebarItem ?? "")}
          activeSidebarItem={String(controlledProps.activeSidebarItem ?? "false")}
          isActionItem={String(controlledProps.isActionItem ?? "false")}
          hideMenuLabel={String(controlledProps.hideMenuLabel ?? "Hide Menu")}>
          Menu Item
        </IfxSidebarItem>
        <IfxSidebarItem
          href="https://google.com"
