...
const declaredVersion = (packageJson.dependencies as Record<string, string>)['@infineon/infineon-design-system-react'];
...
function App() {
  ...
  return (
    <>
      ...
      <div className="version-info">&#64;infineon/infineon-design-system-react@{ declaredVersion.includes('workspace')  ? 'workspace' : installedVersion }</div>
