export function render(container) {
  ...
  fullWidthState.textContent = textarea.getAttribute('full-width');
  ...
  container.querySelector('#toggle-fullWidth').onclick = () => {
    const currentFullWidth = textarea.getAttribute('full-width') === 'true';
    textarea.setAttribute('full-width', String(!currentFullWidth));
    fullWidthState.textContent = String(!currentFullWidth);
  }
