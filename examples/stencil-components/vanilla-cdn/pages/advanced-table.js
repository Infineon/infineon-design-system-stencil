export function render(container) {
  ...
  `;
    ...
    const table = container.querySelector('ifx-table');
    const paginationState = container.querySelector('#state-pagination');
    const variantState = container.querySelector('#state-variant');

    const variants = ["default", "zebra"];

    paginationState.textContent = table.pagination;
    variantState.textContent = table.variant;

    container.querySelector('#toggle-pagination').onclick = () => {
        table.pagination = !table.pagination;
        paginationState.textContent = String(table.pagination);
    }
