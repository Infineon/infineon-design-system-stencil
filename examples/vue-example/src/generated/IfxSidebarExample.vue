...
import { IfxButton, IfxSidebar, IfxSidebarItem, IfxSidebarTitle } from '@infineon/infineon-design-system-vue';
...
<template>
  <div>
    ...
    <div class="state">
        <div><b>showHeader:</b> {{ String(showHeader.value) }}</div>
        <div><b>showFooter:</b> {{ String(showFooter.value) }}</div>
        <div><b>initialCollapse:</b> {{ String(initialCollapse.value) }}</div>
        <div><b>collapsed:</b> {{ String(collapsed.value) }}</div>
        <div><b>collapsible:</b> {{ String(collapsible.value) }}</div>
        <div><b>icon:</b> {{ String(iconOptions[iconIndex.value]) }}</div>
        <div><b>targetOfSidebarItem:</b> {{ String(targetOfSidebarItemOptions[targetOfSidebarItemIndex.value]) }}</div>
        <div><b>activeSidebarItem:</b> {{ String(activeSidebarItem.value) }}</div>
        <div><b>isActionItem:</b> {{ String(isActionItem.value) }}</div>
    </div>
