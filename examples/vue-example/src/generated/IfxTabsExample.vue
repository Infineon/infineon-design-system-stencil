...
const toggleAmountOfTabs = (nextValue: string) => { amountOfTabs.value = Number(nextValue); };
...
<template>
  <div>
    ...
    <div class="controls controls-input">
        <ifx-text-field label="amountOfTabs" type="text" :value="String(amountOfTabs)" @input="toggleAmountOfTabs(getInputValue($event))" />
