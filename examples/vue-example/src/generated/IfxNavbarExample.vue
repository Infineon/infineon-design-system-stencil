...
import { IfxButton, IfxNavbar, IfxNavbarItem, IfxNavbarProfile, IfxSearchBar } from '@infineon/infineon-design-system-vue';
...
<template>
  <div>
    ...
    <div class="state">
        <div><b>navbarPositionFixed:</b> {{ String(navbarPositionFixed.value) }}</div>
        <div><b>showLogoAndAppname:</b> {{ String(showLogoAndAppname.value) }}</div>
        <div><b>logoHrefTarget:</b> {{ String(logoHrefTargetOptions[logoHrefTargetIndex.value]) }}</div>
        <div><b>showLabelOfNavbarItem:</b> {{ String(showLabelOfNavbarItem.value) }}</div>
        <div><b>iconOfNavbarItem:</b> {{ String(iconOfNavbarItemOptions[iconOfNavbarItemIndex.value]) }}</div>
        <div><b>dotIndicator:</b> {{ String(dotIndicator.value) }}</div>
        <div><b>targetOfnavbarItem:</b> {{ String(targetOfnavbarItemOptions[targetOfnavbarItemIndex.value]) }}</div>
        <div><b>hideOnMobile:</b> {{ String(hideOnMobile.value) }}</div>
        <div><b>showNavbarProfileLabel:</b> {{ String(showNavbarProfileLabel.value) }}</div>
        <div><b>target:</b> {{ String(targetOptions[targetIndex.value]) }}</div>
        <div><b>searchBarIsOpen:</b> {{ String(searchBarIsOpen.value) }}</div>
        <div><b>searchBarPosition:</b> {{ String(searchBarPositionOptions[searchBarPositionIndex.value]) }}</div>
    </div>
