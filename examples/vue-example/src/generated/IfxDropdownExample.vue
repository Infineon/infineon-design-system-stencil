...
<template>
  <div>
    ...
    <div class="controls">
      <IfxButton variant="secondary" @click="togglePlacement">Toggle Placement</IfxButton>
      ...
      <IfxButton variant="secondary" @click="toggleDefaultOpen">Toggle DefaultOpen</IfxButton>
      <IfxButton variant="secondary" @click="toggleNoCloseOnOutsideClick">Toggle NoCloseOnOutsideClick</IfxButton>
      <IfxButton variant="secondary" @click="toggleNoCloseOnMenuClick">Toggle NoCloseOnMenuClick</IfxButton>
      <IfxButton variant="secondary" @click="toggleNoAppendToBody">Toggle NoAppendToBody</IfxButton>
    </div>

    <div class="state">
        <div><b>placement:</b> {{ String(placementOptions[placementIndex.value]) }}</div>
        ...
        <div><b>defaultOpen:</b> {{ String(defaultOpen.value) }}</div>
        <div><b>noCloseOnOutsideClick:</b> {{ String(noCloseOnOutsideClick.value) }}</div>
        <div><b>noCloseOnMenuClick:</b> {{ String(noCloseOnMenuClick.value) }}</div>
        <div><b>noAppendToBody:</b> {{ String(noAppendToBody.value) }}</div>
    </div>
