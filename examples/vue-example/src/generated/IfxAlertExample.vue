...
import { IfxAlert, IfxButton } from '@infineon/infineon-design-system-vue';
...
<template>
  <div>
    ...
    <div class="state">
        ...
        <div><b>closable:</b> {{ String(closable.value) }}</div>
        <div><b>AriaLive:</b> {{ String(ariaLiveOptions[ariaLiveIndex.value]) }}</div>
    </div>
