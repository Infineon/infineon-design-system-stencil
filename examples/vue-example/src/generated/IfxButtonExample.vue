...
const toggleUrl = (event: Event | CustomEvent<{ value?: unknown }>) => { const custom = event as CustomEvent<{ value?: unknown }>; const target = event.target as { value?: unknown } | null; const raw = custom.detail?.value ?? target?.value ?? ''; url.value = String(raw); };
...
<template>
  <div>
	...
	<div class="controls controls-toggle">
      ...
      <IfxButton variant="secondary" @click="toggleHref">Toggle Href</IfxButton>
	...
	<div class="controls controls-input">
      ...
      <IfxTextField label="url" type="text" :value="String(url)" @input="toggleUrl" @ifxInput="toggleUrl" />
    </div>
