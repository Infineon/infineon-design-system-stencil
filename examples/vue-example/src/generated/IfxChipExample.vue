...
import { IfxButton, IfxChip, IfxChipItem } from '@infineon/infineon-design-system-vue';
...
<template>
  <div>
    ...
    <div class="state">
        ...
        <div><b>theme:</b> {{ String(themeOptions[themeIndex.value]) }}</div>
        ...
        <div><b>selected:</b> {{ String(selected.value) }}</div>
    </div>
