...
const toggleAriaLevelNumber = (nextValue: string) => { ariaLevelNumber.value = Number(nextValue); };
...
<template>
  ...
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent volutpat, ligula eu aliquam bibendum, orci nisl cursus ipsum, nec egestas odio sapien eget neque.
    ...
    <div class="controls controls-toggle">
        <ifx-button variant="secondary" @click="toggleAutoCollapse">Toggle AutoCollapse</ifx-button>
        <ifx-button variant="secondary" @click="toggleIcon">Toggle Icon</ifx-button>
    </div>
    <div class="controls controls-input">
        <ifx-text-field label="ariaLevelNumber" type="text" :value="String(ariaLevelNumber)" @input="toggleAriaLevelNumber(getInputValue($event))" />
    </div>
