...
import { Component, signal, OnInit, afterNextRender, Injector, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
IfxAccordionExample, IfxActionListExample, IfxAlertExample, IfxButtonExample, IfxCardExample, IfxCheckboxExample, IfxCheckboxGroupExample, IfxChipExample, IfxContentSwitcherExample, IfxDatePickerExample, IfxDropdownExample, IfxFooterMediumExample, IfxIconButtonExample, IfxIndicatorExample, IfxLinkExample, IfxNavbarExample, IfxSidebarExample, IfxNotificationExample, IfxPaginationExample, IfxProgressBarExample, IfxRadioButtonExample, IfxRadioButtonGroupExample, IfxSearchBarExample, IfxSearchFieldExample, IfxSegmentedControlExample, IfxSelectExample, IfxSpinnerExample, IfxStatusExample, IfxStepperExample, IfxStepperCompactExample, IfxSwitchExample, IfxBasicTableExample, IfxTablePaginationExample, IfxTabsExample, IfxTextFieldExample, IfxTextareaExample, IfxTooltipExample
    /* </AUTO-GENERATED-COMPONENTS> */
  ],
