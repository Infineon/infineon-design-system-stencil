import { IfxButton, IfxFooter, IfxIcon, IfxLink, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-footer-example-medium',
  imports: [ IfxButton, IfxFooter, IfxIcon, IfxLink, IfxTextField ],
  templateUrl: './ifx-footer-example-medium.html',
  styleUrl: './ifx-footer-example-medium.scss'
})
export class IfxFooterMediumExample {
  protected readonly tsCode = `import { IfxButton, IfxFooter, IfxIcon, IfxLink, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-footer-example-medium',
  imports: [ IfxButton, IfxFooter, IfxIcon, IfxLink, IfxTextField ],
