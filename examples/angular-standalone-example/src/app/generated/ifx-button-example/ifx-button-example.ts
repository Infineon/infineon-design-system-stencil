import { IfxButton, IfxIcon, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-button-example',
  imports: [ IfxButton, IfxIcon, IfxTextField ],
  templateUrl: './ifx-button-example.html',
  styleUrl: './ifx-button-example.scss'
})
export class IfxButtonExample {
  protected readonly tsCode = `import { IfxButton, IfxIcon, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-button-example',
  imports: [ IfxButton, IfxIcon, IfxTextField ],
