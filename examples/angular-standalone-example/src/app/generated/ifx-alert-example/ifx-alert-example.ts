import { IfxAlert, IfxButton, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-alert-example',
  imports: [ IfxAlert, IfxButton, IfxTextField ],
  templateUrl: './ifx-alert-example.html',
  styleUrl: './ifx-alert-example.scss'
})
export class IfxAlertExample {
  protected readonly tsCode = `import { IfxAlert, IfxButton, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-alert-example',
  imports: [ IfxAlert, IfxButton, IfxTextField ],
