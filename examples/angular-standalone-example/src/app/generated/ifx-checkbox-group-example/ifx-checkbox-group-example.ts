import { IfxButton, IfxCheckbox, IfxCheckboxGroup, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-checkbox-group-example',
  imports: [ IfxButton, IfxCheckbox, IfxCheckboxGroup, IfxTextField ],
  templateUrl: './ifx-checkbox-group-example.html',
  styleUrl: './ifx-checkbox-group-example.scss'
})
export class IfxCheckboxGroupExample {
  protected readonly tsCode = `import { IfxButton, IfxCheckbox, IfxCheckboxGroup, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-checkbox-group-example',
  imports: [ IfxButton, IfxCheckbox, IfxCheckboxGroup, IfxTextField ],
