import { IfxButton, IfxTextField, IfxTooltip } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-tooltip-example',
  imports: [ IfxButton, IfxTextField, IfxTooltip ],
  templateUrl: './ifx-tooltip-example.html',
  styleUrl: './ifx-tooltip-example.scss'
})
export class IfxTooltipExample {
  protected readonly tsCode = `import { IfxButton, IfxTextField, IfxTooltip } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-tooltip-example',
  imports: [ IfxButton, IfxTextField, IfxTooltip ],
...
export class IfxTooltipExample {
  ...
  protected readonly htmlCode = `  &lt;ifx-tooltip
    ...
    [header]=&quot;header&quot;&gt;I&#039;m the tooltip reference element - Please hover me&lt;/ifx-tooltip&gt;`;
