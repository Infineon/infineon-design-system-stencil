import { IfxButton, IfxTooltip } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';

@Component({
  selector: 'app-ifx-tooltip-example',
  imports: [ IfxButton, IfxTooltip ],
  templateUrl: './ifx-tooltip-example.html',
	styleUrl: './ifx-tooltip-example.scss'
})
export class IfxTooltipExample {
  protected readonly tsCode = `import { IfxButton, IfxTooltip } from &#039;@infineon/infineon-design-system-angular/standalone&#039;;
import { Component } from &#039;@angular/core&#039;;
...
export class IfxTooltipExample {}`;
  protected get htmlCode(): string {
    const controlledAttrs = [
      ...
      ["position", this.controlledProps["position"]],
    ...
    __CONTROLLED_ATTRS__&gt;I&#039;m the tooltip reference element - Please hover me&lt;/ifx-tooltip&gt;`.replace("__CONTROLLED_ATTRS__", controlledAttrs);
  }
  ...
  protected togglePosition() { this.positionIndex = (this.positionIndex + 1) % this.positionOptions.length; }
