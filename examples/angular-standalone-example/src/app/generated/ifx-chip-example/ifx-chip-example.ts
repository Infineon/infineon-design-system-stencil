import { IfxButton, IfxChip, IfxChipItem, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-chip-example',
  imports: [ IfxButton, IfxChip, IfxChipItem, IfxTextField ],
  templateUrl: './ifx-chip-example.html',
  styleUrl: './ifx-chip-example.scss'
})
export class IfxChipExample {
  protected readonly tsCode = `import { IfxButton, IfxChip, IfxChipItem, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-chip-example',
  imports: [ IfxButton, IfxChip, IfxChipItem, IfxTextField ],
