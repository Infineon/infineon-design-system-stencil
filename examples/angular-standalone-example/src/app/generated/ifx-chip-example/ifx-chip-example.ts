import { IfxButton, IfxChip, IfxChipItem } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';

@Component({
  selector: 'app-ifx-chip-example',
  imports: [ IfxButton, IfxChip, IfxChipItem ],
  templateUrl: './ifx-chip-example.html',
	styleUrl: './ifx-chip-example.scss'
})
export class IfxChipExample {
  protected readonly tsCode = `import { IfxButton, IfxChip, IfxChipItem } from &#039;@infineon/infineon-design-system-angular/standalone&#039;;
import { Component } from &#039;@angular/core&#039;;
...
export class IfxChipExample {
  ...
  &lt;/ifx-chip&gt;`.replace("__CONTROLLED_ATTRS__", controlledAttrs);
  }
