import { IfxButton, IfxTextField, IfxTextarea } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-textarea-example',
  imports: [ IfxButton, IfxTextField, IfxTextarea ],
  templateUrl: './ifx-textarea-example.html',
  styleUrl: './ifx-textarea-example.scss'
})
export class IfxTextareaExample {
  protected readonly tsCode = `import { IfxButton, IfxTextField, IfxTextarea } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-textarea-example',
  imports: [ IfxButton, IfxTextField, IfxTextarea ],
