import { IfxButton, IfxNotification, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-notification-example',
  imports: [ IfxButton, IfxNotification, IfxTextField ],
  templateUrl: './ifx-notification-example.html',
  styleUrl: './ifx-notification-example.scss'
})
export class IfxNotificationExample {
  protected readonly tsCode = `import { IfxButton, IfxNotification, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-notification-example',
  imports: [ IfxButton, IfxNotification, IfxTextField ],
...
export class IfxNotificationExample {
  ...
  protected readonly htmlCode = `  &lt;ifx-notification
    ...
    [linkText]=&quot;linkText&quot;
    [linkHref]=&quot;linkHref&quot;
    [linkTarget]=&quot;linkTargetOptions[linkTargetIndex]&quot;&gt;Sample Notification&lt;/ifx-notification&gt;`;
