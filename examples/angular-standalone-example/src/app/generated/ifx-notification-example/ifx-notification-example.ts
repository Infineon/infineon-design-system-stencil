import { IfxButton, IfxNotification } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';

@Component({
  selector: 'app-ifx-notification-example',
  imports: [ IfxButton, IfxNotification ],
  templateUrl: './ifx-notification-example.html',
	styleUrl: './ifx-notification-example.scss'
})
export class IfxNotificationExample {
  protected readonly tsCode = `import { IfxButton, IfxNotification } from &#039;@infineon/infineon-design-system-angular/standalone&#039;;
import { Component } from &#039;@angular/core&#039;;
...
export class IfxNotificationExample {}`;
  protected get htmlCode(): string {
    const controlledAttrs = [
      ...
      ["linkTarget", this.controlledProps["linkTarget"]],
    ]
    ...
    __CONTROLLED_ATTRS__&gt;Sample Notification&lt;/ifx-notification&gt;`.replace("__CONTROLLED_ATTRS__", controlledAttrs);
  }
  ...
  protected toggleLinkTarget() { this.linkTargetIndex = (this.linkTargetIndex + 1) % this.linkTargetOptions.length; }
  ...
  protected get controlledProps(): Record<string, unknown> {
    return {
      ...
      "linkTarget": this.linkTargetOptions[this.linkTargetIndex],
    };
  }
}
