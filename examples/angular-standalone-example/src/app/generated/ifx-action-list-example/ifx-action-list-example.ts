import { IfxActionList, IfxActionListItem, IfxIcon, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-action-list-example',
  imports: [ IfxActionList, IfxActionListItem, IfxIcon, IfxTextField ],
  templateUrl: './ifx-action-list-example.html',
  styleUrl: './ifx-action-list-example.scss'
})
export class IfxActionListExample {
  protected readonly tsCode = `import { IfxActionList, IfxActionListItem, IfxIcon, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-action-list-example',
  imports: [ IfxActionList, IfxActionListItem, IfxIcon, IfxTextField ],
