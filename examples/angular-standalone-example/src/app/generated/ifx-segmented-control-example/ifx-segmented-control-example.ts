import { IfxButton, IfxSegment, IfxSegmentedControl, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-segmented-control-example',
  imports: [ IfxButton, IfxSegment, IfxSegmentedControl, IfxTextField ],
...
export class IfxSegmentedControlExample {
  protected readonly tsCode = `import { IfxButton, IfxSegment, IfxSegmentedControl, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-segmented-control-example',
  imports: [ IfxButton, IfxSegment, IfxSegmentedControl, IfxTextField ],
