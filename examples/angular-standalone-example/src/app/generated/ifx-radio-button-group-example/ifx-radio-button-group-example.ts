import { IfxButton, IfxRadioButton, IfxRadioButtonGroup, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-radio-button-group-example',
  imports: [ IfxButton, IfxRadioButton, IfxRadioButtonGroup, IfxTextField ],
...
export class IfxRadioButtonGroupExample {
  protected readonly tsCode = `import { IfxButton, IfxRadioButton, IfxRadioButtonGroup, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-radio-button-group-example',
  imports: [ IfxButton, IfxRadioButton, IfxRadioButtonGroup, IfxTextField ],
