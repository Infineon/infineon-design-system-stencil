import { IfxButton, IfxSpinner, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-spinner-example',
  imports: [ IfxButton, IfxSpinner, IfxTextField ],
  templateUrl: './ifx-spinner-example.html',
  styleUrl: './ifx-spinner-example.scss'
})
export class IfxSpinnerExample {
  protected readonly tsCode = `import { IfxButton, IfxSpinner, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-spinner-example',
  imports: [ IfxButton, IfxSpinner, IfxTextField ],
