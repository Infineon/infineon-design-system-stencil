import { IfxMultiselect, IfxMultiselectGroup, IfxMultiselectOption } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';

@Component({
  selector: 'app-ifx-multiselect-example-grouped',
  imports: [ IfxMultiselect, IfxMultiselectGroup, IfxMultiselectOption ],
...
export class IfxMultiselectGroupedExample {
  protected readonly tsCode = `import { IfxMultiselect, IfxMultiselectGroup, IfxMultiselectOption } from &#039;@infineon/infineon-design-system-angular/standalone&#039;;
import { Component } from &#039;@angular/core&#039;;
