import { IfxButton, IfxContentSwitcher, IfxContentSwitcherItem, IfxIcon } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';

@Component({
  selector: 'app-ifx-content-switcher-example',
  imports: [ IfxButton, IfxContentSwitcher, IfxContentSwitcherItem, IfxIcon ],
...
export class IfxContentSwitcherExample {
  protected readonly tsCode = `import { IfxButton, IfxContentSwitcher, IfxContentSwitcherItem, IfxIcon } from &#039;@infineon/infineon-design-system-angular/standalone&#039;;
import { Component } from &#039;@angular/core&#039;;
...
export class IfxContentSwitcherExample {
  ...
  protected get htmlCode(): string {
    ...
    return `  &lt;ifx-content-switcher __CONTROLLED_ATTRS__&gt;
    &lt;ifx-content-switcher-item
      value=&quot;item 1&quot;
      (ifxChange)=&quot;handleChange(\$any(\$event))&quot;&gt;
      &lt;ifx-icon icon=&quot;{{ controlledProps[&#039;icon&#039;] }}&quot;&gt;&lt;/ifx-icon&gt;
    &lt;/ifx-content-switcher-item&gt;
    ...
    &lt;ifx-content-switcher-item value=&quot;item 4&quot;&gt;
      &lt;ifx-icon icon=&quot;{{ controlledProps[&#039;icon&#039;] }}&quot;&gt;&lt;/ifx-icon&gt;
    &lt;/ifx-content-switcher-item&gt;
  &lt;/ifx-content-switcher&gt;`.replace("__CONTROLLED_ATTRS__", controlledAttrs);
  }
