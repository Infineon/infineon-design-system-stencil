import { IfxButton, IfxContentSwitcher, IfxContentSwitcherItem, IfxIcon, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-content-switcher-example',
  imports: [ IfxButton, IfxContentSwitcher, IfxContentSwitcherItem, IfxIcon, IfxTextField ],
...
export class IfxContentSwitcherExample {
  protected readonly tsCode = `import { IfxButton, IfxContentSwitcher, IfxContentSwitcherItem, IfxIcon, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-content-switcher-example',
  imports: [ IfxButton, IfxContentSwitcher, IfxContentSwitcherItem, IfxIcon, IfxTextField ],
