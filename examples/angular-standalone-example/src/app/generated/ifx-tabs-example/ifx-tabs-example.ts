...
export class IfxTabsExample {
  ...
  protected get htmlCode(): string {
    const controlledAttrs = [
      ...
      ["iconPosition", this.controlledProps["iconPosition"]],
    ]
  ...
  protected toggleIconPosition() { this.iconPositionIndex = (this.iconPositionIndex + 1) % this.iconPositionOptions.length; }
  ...
  protected get controlledProps(): Record<string, unknown> {
    return {
      ...
      "iconPosition": this.iconPositionOptions[this.iconPositionIndex],
    };
  }
