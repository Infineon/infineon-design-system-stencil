import { IfxButton, IfxIconButton } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';

@Component({
  selector: 'app-ifx-icon-button-example',
  imports: [ IfxButton, IfxIconButton ],
  templateUrl: './ifx-icon-button-example.html',
	styleUrl: './ifx-icon-button-example.scss'
})
export class IfxIconButtonExample {
  protected readonly tsCode = `import { IfxButton, IfxIconButton } from &#039;@infineon/infineon-design-system-angular/standalone&#039;;
import { Component } from &#039;@angular/core&#039;;
...
export class IfxIconButtonExample {}`;
  protected get htmlCode(): string {
    ...
    return `  &lt;ifx-icon-button
    href=&quot;true&quot;
    aria-label=&quot;Icon Button&quot;
    __CONTROLLED_ATTRS__&gt;&lt;/ifx-icon-button&gt;`.replace("__CONTROLLED_ATTRS__", controlledAttrs);
  }
