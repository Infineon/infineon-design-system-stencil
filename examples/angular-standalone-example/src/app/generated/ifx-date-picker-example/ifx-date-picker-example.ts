import { IfxButton, IfxDatePicker, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-date-picker-example',
  imports: [ IfxButton, IfxDatePicker, IfxTextField ],
  templateUrl: './ifx-date-picker-example.html',
  styleUrl: './ifx-date-picker-example.scss'
})
export class IfxDatePickerExample {
  protected readonly tsCode = `import { IfxButton, IfxDatePicker, IfxTextField } from '@infineon/infineon-design-system-angular/standalone';
import { Component } from '@angular/core';
@Component({
  selector: 'app-ifx-date-picker-example',
  imports: [ IfxButton, IfxDatePicker, IfxTextField ],
