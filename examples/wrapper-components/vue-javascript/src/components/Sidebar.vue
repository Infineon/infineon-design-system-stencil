<template>
  <div class="component">
    <h2>Sidebar</h2>
    <ifx-sidebar application-name="Application Name" collapsible="true" collapsed="false" hide-menu-label="Hide Menu"
      show-header="true" show-footer="true" initial-collapse="true" terms-of-use="https://yourwebsite.com/terms"
      imprint="https://yourwebsite.com/imprint" privacy-policy="https://yourwebsite.com/privacy-policy"
      ...
      <ifx-sidebar-item href="https://google.com" target="_self" icon="image-16" number-indicator=""
        isactionitem="false" active="false">Item 1</ifx-sidebar-item>
