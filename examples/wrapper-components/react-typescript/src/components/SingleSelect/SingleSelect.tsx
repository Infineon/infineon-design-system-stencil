...
function App() {
  ...
  return (
    <div>
      <IfxSelect options={JSON.stringify(options)} type="single" value="undefined" onIfxSelect={handleIfxSelect} size="medium (40px)" placeholder="true" search-enabled="true"
