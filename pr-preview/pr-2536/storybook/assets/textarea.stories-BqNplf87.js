...
/>
`;const r=a.querySelector("ifx-textarea");return r.addEventListener("ifxInput",o("ifxInput")),r},t=n.bind({}),l=["Default"];t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`(args: any) => {
...
\`;
  ...
  return textarea;
}`,...t.parameters?.docs?.source}}};export{t as Default,l as __namedExportsOrder,s as default};
