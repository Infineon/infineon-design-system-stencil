import{u as l,j as e,M as r,C as t,a as s}from"./blocks-NbAjOA9n.js";import{T as d,D as o,P as c,S as h,I as u,a as p,b as f,c as b}from"./table.stories-Df51M0d0.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DH2WJQEq.js";function i(a){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",pre:"pre",ul:"ul",...l(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:d}),`
...
`})}),`
`,e.jsxs(n.p,{children:["If you update your database and need the table to reflect the changes without losing the current page, use the ",e.jsx(n.code,{children:"refreshCurrentPage()"})," method:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-javascript",children:`// 1. Update your database
await fetch('/api/cars/1', { method: 'DELETE' });

// 2. Refresh the current page
await table.refreshCurrentPage();
`})}),`
`,e.jsx(n.p,{children:"This will re-fetch the current page data without resetting the pagination back to page 1."}),`
...
`})})]})}function v(a={}){const{wrapper:n}={...l(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(i,{...a})}):i(a)}export{v as default};
