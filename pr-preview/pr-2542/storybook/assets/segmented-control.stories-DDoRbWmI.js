...
${e.error?"error":""}
${e.required?"required":""}>
    ${Array.from({length:e.amountOfSegments},(g,a)=>{const t=document.createElement("ifx-segment");return t.innerText=e.labelOfSegment,t.setAttribute("value",`Value${a+1}`),t.setAttribute("icon",`${e.icon}`),e.selected===!0&&a===1&&t.setAttribute("selected","true"),t.outerHTML}).join(`
    `)}
</ifx-segmented-control>  
`;const o=r.querySelector("ifx-segmented-control");return o.addEventListener("ifxChange",l("ifxChange")),o},n=m.bind({}),c=["Default"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
...
}`,...n.parameters?.docs?.source}}};const d=Object.freeze(Object.defineProperty({__proto__:null,Default:n,__namedExportsOrder:c,default:i},Symbol.toStringTag,{value:"Module"}));export{d as S};
