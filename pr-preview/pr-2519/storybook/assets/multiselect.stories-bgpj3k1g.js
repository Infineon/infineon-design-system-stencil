...
VanillaJs:.addEventListener("ifxOpen", (event) => {//handle change});`}}}}},r=e=>{const a=s`<ifx-multiselect
  name='${e.name}'
  ?disabled='${e.disabled}'
  ...
  <ifx-multiselect-option value="category-f">
...
</ifx-multiselect>`;return setTimeout(()=>{document.querySelector("ifx-multiselect")?.addEventListener("ifxSelect",o("ifxSelect")),document.querySelector("ifx-multiselect")?.addEventListener("ifxOpen",o("ifxOpen"))},0),a},t=r.bind({});t.args={label:"Generic Multi-Level Selection",placeholder:"Select options..."};t.parameters={docs:{description:{story:"The multiselect component supports nested hierarchical options with search, select all, and expand/collapse functionality. Use slot-based syntax for defining options and their nested structure."}}};const i={render:()=>s`
    ...
    `,parameters:{docs:{description:{story:"Use `ifx-multiselect-group` for visual and semantic grouping without selection or expansion. Use an `ifx-multiselect-option` with children when the parent itself must be selectable and expandable."}}}},p=e=>{const a=`<ifx-multiselect
  name='${e.name}'
  ?disabled='${e.disabled}'
  ?read-only='${e.readOnly}'
  ?error='${e.error}'
...
</ifx-multiselect>`;return setTimeout(()=>{const n=document.querySelectorAll("ifx-multiselect")[document.querySelectorAll("ifx-multiselect").length-1];n.addEventListener("ifxSelect",o("ifxSelect")),n.addEventListener("ifxOpen",o("ifxOpen"))},0),a},l=p.bind({});l.args={label:"Single Level Selection",placeholder:"Select options..."};l.parameters={docs:{description:{story:"A simple multiselect with single-level options - no nesting or hierarchical structure. Expand/Collapse controls are automatically hidden for single-level option lists."}}};const u=["Default","Grouped","SingleLevel"];t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  parameters: {
    docs: {
      description: {
        story: "Use \`ifx-multiselect-group\` for visual and semantic grouping without selection or expansion. Use an \`ifx-multiselect-option\` with children when the parent itself must be selectable and expandable."
      }
    }
  }
}`,...i.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return template;
}`,...l.parameters?.docs?.source}}};const d=Object.freeze(Object.defineProperty({__proto__:null,Default:t,Grouped:i,SingleLevel:l,__namedExportsOrder:u,default:c},Symbol.toStringTag,{value:"Module"}));export{t as D,d as S};
