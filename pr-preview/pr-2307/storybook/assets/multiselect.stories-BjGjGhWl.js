...
VanillaJs:.addEventListener("ifxOpen", (event) => {//handle change});`}}}}},r=e=>{const l=s`<ifx-multiselect
  name='${e.name}'
  ?disabled='${e.disabled}'
...
</ifx-multiselect>`;return setTimeout(()=>{document.querySelector("ifx-multiselect")?.addEventListener("ifxSelect",t("ifxSelect")),document.querySelector("ifx-multiselect")?.addEventListener("ifxOpen",t("ifxOpen"))},0),l},i=r.bind({});i.args={label:"Generic Multi-Level Selection",placeholder:"Select options..."};i.parameters={docs:{description:{story:"The multiselect component supports nested hierarchical options with search, select all, and expand/collapse functionality. Use slot-based syntax for defining options and their nested structure."}}};const u=e=>{const l=s`<ifx-multiselect
  name='${e.name}'
  ?disabled='${e.disabled}'
  ?read-only='${e.readOnly}'
  ?error='${e.error}'
...
</ifx-multiselect>`;return setTimeout(()=>{const c=document.querySelectorAll("ifx-multiselect")[document.querySelectorAll("ifx-multiselect").length-1];c.addEventListener("ifxSelect",t("ifxSelect")),c.addEventListener("ifxOpen",t("ifxOpen"))},0),l},o=u.bind({});o.args={label:"Single Level Selection",placeholder:"Select options..."};o.parameters={docs:{description:{story:"A simple multiselect with single-level options - no nesting or hierarchical structure. Expand/Collapse controls are automatically hidden for single-level option lists."}}};const m=e=>{const l=s`<ifx-multiselect
  name='${e.name}'
  ?disabled='${e.disabled}'
  ?required='${e.required}'
  ?error='${e.error}'
...
</ifx-multiselect>`;return setTimeout(()=>{document.querySelector("ifx-multiselect")?.addEventListener("ifxSelect",t("ifxSelect")),document.querySelector("ifx-multiselect")?.addEventListener("ifxOpen",t("ifxOpen"))},0),l},n=m.bind({}),f=e=>{const l=s`<ifx-multiselect
      name='multiselect'
      ?disabled='false'
      ?error='false'
      caption=''
...
`;return setTimeout(()=>{document.querySelector("ifx-multiselect")?.addEventListener("ifxSelect",t("ifxSelect")),document.querySelector("ifx-multiselect")?.addEventListener("ifxOpen",t("ifxOpen"))},0),l},a=f.bind({}),x=["Default","SingleLevel","SeparatorDefault","SeparatorSingleLevel"];i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return template;
}`,...i.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`(args: any) => {
  const template = html\`<ifx-multiselect
  name='\${args.name}'
  ?disabled='\${args.disabled}'
  ?read-only='\${args.readOnly}'
  ...
  return template;
}`,...o.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
  const template = html\`<ifx-multiselect
  name='\${args.name}'
  ?disabled='\${args.disabled}'
  ?required='\${args.required}'
  ...
  return template;
}`,...n.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`(args: any) => {
  const template = html\`<ifx-multiselect
      name='multiselect'
      ?disabled='false'
      ?error='false'
...
\`;
  ...
  return template;
}`,...a.parameters?.docs?.source}}};const h=Object.freeze(Object.defineProperty({__proto__:null,Default:i,SeparatorDefault:n,SeparatorSingleLevel:a,SingleLevel:o,__namedExportsOrder:x,default:p},Symbol.toStringTag,{value:"Module"}));export{i as D,h as S,o as a,n as b,a as c};
