...
VanillaJs:.addEventListener("ifxIfxSortChange", (event) => {//handle input});`}}},showMoreFilters:{description:"Public method that toggles the Topbar Filters. Accepts true or false as arguments. Accessible from the ifx-filter-bar component",table:{category:"ifx-table public methods"}}}},$=e=>{if(e.filterOrientation==="none")return t`<ifx-table
    ...
    `}),v=e.cols.map((n,y)=>{const h=[...new Set(e.rows.map(i=>i[n.field]))].filter(i=>i!=null&&i!=="").map(i=>({value:i,label:i,selected:!1})),x=JSON.stringify(h);return t`
        <ifx-set-filter slot="filter-component-${y+1}"
          ...
          `}),O=e.filterOrientation==="sidebar"?t`<ifx-filter-type-group slot="sidebar-filter" show-sidebar-filters-button="${e.showSidebarFiltersButton}">
  ...
  if (args.filterOrientation === 'none') {
    ...
    const filterTypeGroupComponent = args.filterOrientation === 'sidebar' ? html\`<ifx-filter-type-group slot="sidebar-filter" show-sidebar-filters-button="\${args.showSidebarFiltersButton}">
        <div slot="filter-search">
          <ifx-filter-search filter-orientation="sidebar" filter-name="search"></ifx-filter-search>
        </div>
        \${filterAccordions}
...
}`,...m.parameters?.docs?.source}}};const M=Object.freeze(Object.defineProperty({__proto__:null,DefaultState:o,IncludesBreakingline:u,IncludesButtons:s,IncludesInnerButtons:p,IncludesLink:f,IncludesStatus:c,Pagination:r,ServerSidePagination:l,SidebarFilter:g,TopbarFilter:m,__namedExportsOrder:A,default:J},Symbol.toStringTag,{value:"Module"}));export{o as D,s as I,r as P,l as S,M as T,p as a,g as b,m as c};
