...
VanillaJs:.addEventListener("ifxInput", (event) => {//handle input});`}}}}},w=({error:r,disabled:i,success:n,size:l,placeholder:s,readOnly:o,label:d,caption:u,icon:c,required:p,name:f,maxlength:a,showDeleteIcon:m,value:b,autocomplete:x,type:y,internalId:h,ariaLabel:g})=>{const e=document.createElement("ifx-text-field");return e.setAttribute("error",r),i&&e.setAttribute("disabled",i),e.setAttribute("size",l),e.setAttribute("icon",c),e.setAttribute("success",n),e.setAttribute("placeholder",s),e.setAttribute("read-only",o),e.setAttribute("caption",u),e.setAttribute("label",d),e.setAttribute("required",p),e.setAttribute("name",f),e.setAttribute("show-delete-icon",m),e.setAttribute("value",b),e.setAttribute("autocomplete",x),e.setAttribute("type",y),e.setAttribute("internal-id",h),e.setAttribute("aria-label",g),a&&e.setAttribute("maxlength",a),e.addEventListener("ifxInput",I("ifxInput")),e},t=w.bind({}),T=["Default"];t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`({
  error,
  disabled,
  success,
  size,
  ...
  return element;
}`,...t.parameters?.docs?.source}}};const O=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:T,default:v},Symbol.toStringTag,{value:"Module"}));export{t as D,O as T};
