...
Event Detail: { collapsed: boolean }`}}},ifxSidebarLogoClick:{action:"ifxSidebarLogoClick",description:"Custom event emitted when the sidebar logo image is clicked.",table:{category:"custom events",type:{summary:"Framework integration",detail:`
  ...
  `,i},a=p.bind({});a.storyName="With Hide Menu";a.args={collapsible:!0,collapsed:!1,hideMenuLabel:"Hide Menu"};const r=p.bind({});r.storyName="With Hide Menu (starts collapsed)";r.args={collapsible:!0,collapsed:!0,hideMenuLabel:"Hide Menu"};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
