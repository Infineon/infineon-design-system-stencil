...
VanillaJs:.addEventListener("ifxToastClose", (event) => {//handle change});`}}},ifxToastAction:{action:"ifxToastAction",description:"Emitted when the action is activated (before dismissing).",table:{category:"custom events"}}}},_=t=>x`<ifx-toast
  ...
  return wrapper;
}`,...c.parameters?.docs?.source}}};const V=Object.freeze(Object.defineProperty({__proto__:null,AllVariants:d,AsyncTransition:c,Default:i,LiveDemo:r,__namedExportsOrder:N,default:I},Symbol.toStringTag,{value:"Module"}));export{V as T};
