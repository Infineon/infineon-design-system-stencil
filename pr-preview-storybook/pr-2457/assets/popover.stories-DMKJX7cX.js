const{action:d}=__STORYBOOK_MODULE_ACTIONS__,x={title:"Components/Popover",tags:["autodocs"],args:{popoverTitle:"Popover Title",text:"This is the popover content. It can contain multiple lines of text.",position:"auto",disabled:!1,ariaLabel:"Popover with additional information"},argTypes:{popoverTitle:{description:"Title text displayed in the popover header.",control:"text",table:{category:"ifx-popover props",type:{summary:"string"}}},text:{description:"Body text displayed in the popover content.",control:"text",table:{category:"ifx-popover props",type:{summary:"string"}}},position:{description:"Position of the popover relative to the trigger element.",options:["auto","top","top-start","top-end","bottom","bottom-start","bottom-end","left","right"],control:"select",table:{category:"ifx-popover props",defaultValue:{summary:"auto"}}},disabled:{description:"Whether the popover is disabled.",control:"boolean",table:{category:"ifx-popover props",defaultValue:{summary:"false"}}},ariaLabel:{description:"Accessible label for the popover.",control:"text",table:{category:"ifx-popover props",type:{summary:"string | null"},defaultValue:{summary:"null"}}},ifxOpen:{action:"ifxOpen",description:"Event emitted when an popover is opened.",table:{category:"custom events",type:{summary:"Framework integration",detail:`React: onIfxOpen={handleOpen}
          ...
          VanillaJs: .addEventListener("ifxClose", (event) => {/*handle close*/});`}}},show:{description:"Public method for programatically opening the popover component",table:{category:"ifx-popover public methods"}},hide:{description:"Public method for programatically hiding the popover component",table:{category:"ifx-popover public methods"}}}},f=({popoverTitle:o,text:r,position:i,disabled:t,ariaLabel:n})=>{const e=document.createElement("ifx-popover");e.setAttribute("popover-title",o),e.setAttribute("text",r),e.setAttribute("position",i),t&&e.setAttribute("disabled","true"),n&&e.setAttribute("aria-label",n),e.addEventListener("ifxOpen",d("ifxOpen")),e.addEventListener("ifxClose",d("ifxClose"));const c=document.createElement("ifx-button");c.textContent="Click me",e.appendChild(c);const p=document.createElement("div");return p.style.padding="100px",p.style.textAlign="center",p.appendChild(e),p},m=f.bind({}),v=({popoverTitle:o,text:r,position:i})=>{const t=document.createElement("ifx-popover");t.setAttribute("popover-title",o),t.setAttribute("text",r),t.setAttribute("position",i),t.addEventListener("ifxOpen",d("ifxOpen")),t.addEventListener("ifxClose",d("ifxClose"));const n=document.createElement("ifx-button");n.textContent="Delete Item",t.appendChild(n);const e=document.createElement("div");e.setAttribute("slot","content"),e.style.display="flex",e.style.gap="8px";const c=document.createElement("ifx-button");c.textContent="Confirm",e.appendChild(c);const p=document.createElement("ifx-button");p.setAttribute("variant","secondary"),p.textContent="Cancel",e.appendChild(p),t.appendChild(e);const b=document.createElement("div");return b.style.padding="100px",b.style.textAlign="center",b.appendChild(t),b},a=v.bind({});a.args={popoverTitle:"Confirm Action",text:"Are you sure you want to proceed with this action?",position:"bottom"};const C=()=>{const o=document.createElement("div");return o.style.padding="200px",o.style.display="grid",o.style.gridTemplateColumns="repeat(3, 1fr)",o.style.gap="50px",o.style.placeItems="center",[{position:"top-start",label:"Top Start"},{position:"top",label:"Top"},{position:"top-end",label:"Top End"},{position:"left",label:"Left"},{position:"auto",label:"Auto (Center)"},{position:"right",label:"Right"},{position:"bottom-start",label:"Bottom Start"},{position:"bottom",label:"Bottom"},{position:"bottom-end",label:"Bottom End"}].forEach(({position:i,label:t})=>{const n=document.createElement("ifx-popover");n.setAttribute("popover-title",t),n.setAttribute("text",`Positioned at ${i}`),n.setAttribute("position",i),n.addEventListener("ifxOpen",d("ifxOpen")),n.addEventListener("ifxClose",d("ifxClose"));const e=document.createElement("ifx-button");e.setAttribute("size","small"),e.textContent=t,n.appendChild(e),o.appendChild(n)}),o},u=C.bind({}),h=({popoverTitle:o,text:r,position:i})=>{const t=document.createElement("ifx-popover");t.setAttribute("popover-title",o),t.setAttribute("text",r),t.setAttribute("position",i),t.style.setProperty("--ifx-popover-width","320px");const n=document.createElement("ifx-button");n.textContent="Custom Width",t.appendChild(n);const e=document.createElement("div");return e.style.padding="100px",e.style.textAlign="center",e.appendChild(t),e},s=h.bind({});s.args={popoverTitle:"Custom Width Popover",text:"This popover uses --ifx-popover-width: 320px.",position:"bottom"};const y=({popoverTitle:o,text:r,position:i})=>{const t=document.createElement("ifx-popover");t.setAttribute("popover-title",o),t.setAttribute("text",r),t.setAttribute("position",i),t.setAttribute("open","true");const n=document.createElement("ifx-button");n.textContent="Opened on load",t.appendChild(n);const e=document.createElement("div");return e.style.padding="100px",e.style.textAlign="center",e.appendChild(t),e},l=y.bind({});l.args={popoverTitle:"Initially Open",text:"This popover starts open via the open prop.",position:"bottom"};const g=["Default","WithActions","AllPositions","CustomWidth","InitiallyOpen"];m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`({
  popoverTitle,
  text,
  position,
  disabled,
  ...
  wrapper.appendChild(element);
  return wrapper;
}`,...l.parameters?.docs?.source}}};const A=Object.freeze(Object.defineProperty({__proto__:null,AllPositions:u,CustomWidth:s,Default:m,InitiallyOpen:l,WithActions:a,__namedExportsOrder:g,default:x},Symbol.toStringTag,{value:"Module"}));export{A as P};
