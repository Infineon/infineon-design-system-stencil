...
VanillaJs:.addEventListener("ifxClose", (event) => {//handle change});`}}}}},u=({caption:m,captionAriaLabel:p,closeButtonAriaLabel:b,showCloseButton:y,closeOnOverlayClick:f,variant:B,size:C,alertIcon:s,cancelButtonLabel:x,okButtonLabel:h})=>{const t=document.createElement("ifx-modal");t.setAttribute("caption",m),t.setAttribute("caption-aria-label",p),t.setAttribute("close-button-aria-label",b),t.setAttribute("variant",B),s&&t.setAttribute("alert-icon",s),t.setAttribute("close-on-overlay-click",f),t.setAttribute("show-close-button",y),t.setAttribute("size",C),t.addEventListener("ifxOpen",d("ifxOpen")),t.addEventListener("ifxClose",d("ifxClose"));const i=document.createElement("div");i.setAttribute("slot","content"),i.innerHTML=`
  ...
  storyElement.appendChild(openButton);
  return storyElement;
}`,...n.parameters?.docs?.source}}};const k=Object.freeze(Object.defineProperty({__proto__:null,Alert:n,Default:e,__namedExportsOrder:L,default:E},Symbol.toStringTag,{value:"Module"}));export{n as A,e as D,k as M};
