...
Event Detail: { collapsed: boolean }`}}},ifxSidebarLogoClick:{action:"ifxSidebarLogoClick",description:"Custom event emitted when the sidebar logo image is clicked.",table:{category:"custom events",type:{summary:"Framework integration",detail:`
  ...
  `,i},a=p.bind({});a.storyName="With Hide Menu";a.args={collapsible:!0,collapsed:!1,hideMenuLabel:"Hide Menu"};const n=p.bind({});n.storyName="With Hide Menu (starts collapsed)";n.args={collapsible:!0,collapsed:!0,hideMenuLabel:"Hide Menu"};const I=["Default","WithSubmenu","WithNumberIndicator","Collapsible","CollapsibleStartsCollapsed"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  \`;
  return sidebarElement;
}`,...n.parameters?.docs?.source}}};const v=Object.freeze(Object.defineProperty({__proto__:null,Collapsible:a,CollapsibleStartsCollapsed:n,Default:r,WithNumberIndicator:o,WithSubmenu:s,__namedExportsOrder:I,default:g},Symbol.toStringTag,{value:"Module"}));export{r as D,v as S,s as W,o as a};
