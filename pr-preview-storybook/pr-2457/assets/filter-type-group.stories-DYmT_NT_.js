const{action:l}=__STORYBOOK_MODULE_ACTIONS__,a={title:"Components/Filter Type Group",tags:["hidden"]},n=[{filterName:"Filter 1",value:!0},{filterName:"Filter 2",value:!1},{filterName:"Filter 3",value:!1},{filterName:"Filter 4",value:!1},{filterName:"Filter 5",value:!0},{filterName:"Filter 6",value:!1},{filterName:"Filter 7",value:!1},{filterName:"Filter 8",value:!1}],i=()=>n.map((e,r)=>r===0?`
...
`,e.querySelector("ifx-filter-type-group").addEventListener("ifxSidebarFilterChange",l("ifxSidebarFilterChange")),e},o=["Default"];t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
...
\`;
  ...
  return wrapper;
}`,...t.parameters?.docs?.source}}};const f=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:o,default:a},Symbol.toStringTag,{value:"Module"}));export{t as D,f as F};
