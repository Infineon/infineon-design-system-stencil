...
VanillaJs:.addEventListener("ifxInput", (event) => {//handle input});`}}},clearSelection:{description:"Public method for clearing the selected options",table:{category:"ifx-select public methods"}}}},s=e=>{const l=`<ifx-select 
  ...
  return template;
}`,...t.parameters?.docs?.source}}};const n=["Default"],i=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:n,default:r},Symbol.toStringTag,{value:"Module"}));export{i as S};
