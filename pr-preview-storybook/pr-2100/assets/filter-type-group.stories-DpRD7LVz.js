const{action:l}=__STORYBOOK_MODULE_ACTIONS__,a={title:"Components/Filter Type Group"},o=[{filterName:"Filter 1",value:!0},{filterName:"Filter 2",value:!1},{filterName:"Filter 3",value:!1},{filterName:"Filter 4",value:!1},{filterName:"Filter 5",value:!0},{filterName:"Filter 6",value:!1},{filterName:"Filter 7",value:!1},{filterName:"Filter 8",value:!1}],i=()=>o.map((e,r)=>r===0?`
...
\`;
  ...
  return wrapper;
}`,...t.parameters?.docs?.source}}};const f=["Default"],s=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:f,default:a},Symbol.toStringTag,{value:"Module"}));export{t as D,s as F};
