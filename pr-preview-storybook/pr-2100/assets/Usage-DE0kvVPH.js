import{j as n,M as o}from"./WithTooltip-SK46ZJ2J-Dk6xP2TK.js";import{useMDXComponents as s}from"./index-Ba6_DNLG.js";import{P as a}from"./pagination.stories-CdpMoUt-.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-1HBkPUig.js";import"./_commonjsHelpers-CqkleIqs.js";const r=""+new URL("pagination-desktop-B1fdjCtQ.png",import.meta.url).href,l=""+new URL("pagination-mobile-DmqYQKHO.png",import.meta.url).href,h=""+new URL("pagination-more-anatomy-DNUDFXrO.png",import.meta.url).href,d=""+new URL("pagination-positioning-desktop-o-SOm1u5.png",import.meta.url).href,c=""+new URL("pagination-positioning-mobile-Du2jzE1e.png",import.meta.url).href,p=""+new URL("pagination-states-C9imtLhq.png",import.meta.url).href;function t(i){const e={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(o,{of:a}),`
...
|-----------------------------------------------------------------------------------------------------------------------------|
| `,n.jsx(e.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=2393-3987",rel:"nofollow",children:"Figma pagination component →"})," |"]}),`
...
`,n.jsx("img",{src:p,alt:"Pagination States"})]})}function f(i={}){const{wrapper:e}={...s(),...i.components};return e?n.jsx(e,{...i,children:n.jsx(t,{...i})}):t(i)}export{f as default};
