import{j as e,M as t}from"./WithTooltip-SK46ZJ2J-DFS1GOK_.js";import{useMDXComponents as s}from"./index-DPVndWBa.js";import{B as o}from"./breadcrumb.stories-Bb-s2sAF.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-D9lRGvzE.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icons-C_9-zI1i.js";const a=""+new URL("breadcrumb-anatomy-DLg5M6GN.png",import.meta.url).href,c=""+new URL("breadcrumb-mouse-interaction-DtNaHYK3.png",import.meta.url).href,h=""+new URL("breadcrumb-positioning-desktop-BLn88AZD.png",import.meta.url).href,d=""+new URL("breadcrumb-positioning-mobile-C9iW2d6A.png",import.meta.url).href;function i(r){const n={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:o}),`
...
|-----------------------------------------------------------------------------------------------------------------------------|
| `,e.jsx(n.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=2549-3262",rel:"nofollow",children:"Figma breadcrumb component →"})," |"]}),`
...
`,e.jsx("img",{src:h,alt:"Breadcrumb Position Desktop"}),`
`,e.jsx(n.h3,{id:"mobile",children:"Mobile"}),`
`,e.jsx("img",{src:d,alt:"Breadcrumb Position Mobile"}),`
...
`,e.jsx("img",{src:c,alt:"Breadcrumb Mouse Interaction"})]})}function j(r={}){const{wrapper:n}={...s(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(i,{...r})}):i(r)}export{j as default};
