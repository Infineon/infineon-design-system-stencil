import{j as e,M as r}from"./WithTooltip-SK46ZJ2J-Dk6xP2TK.js";import{useMDXComponents as t}from"./index-Ba6_DNLG.js";import{S as a}from"./search-field.stories-Brx6EDyF.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-1HBkPUig.js";import"./_commonjsHelpers-CqkleIqs.js";const c=""+new URL("search-field-anatomy-BN_vy2dc.png",import.meta.url).href,o=""+new URL("search-field-states-CFRg9iug.png",import.meta.url).href,l=""+new URL("search-field-sizes-5_CdVZCG.png",import.meta.url).href,h=""+new URL("search-suggest-search-C-TMH7-1.png",import.meta.url).href,d=""+new URL("search-recent-suggest-JTCYd3Xe.png",import.meta.url).href;function i(s){const n={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:a}),`
...
|--------------------------------------------------------------------------------------------------------------------------------|
| `,e.jsx(n.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=38242-6618",rel:"nofollow",children:"Figma search field component →"})," |"]}),`
...
`,e.jsx("img",{src:o,alt:"Search Field States"}),`
...
`,e.jsx("img",{src:l,alt:"Search Field Sizes"}),`
...
`,e.jsx(n.p,{children:"The DDS provides a recent- and search suggest feature. If the user clicks on the search field, recently displayed search keywords and/or trend keywords can be displayed. Does the user start typing if possible, only the suggested searches should be visible."}),`
`,e.jsx("img",{src:h,alt:"Search Field Suggest"})]})}function j(s={}){const{wrapper:n}={...t(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{j as default};
