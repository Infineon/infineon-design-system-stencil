import{j as e,M as i}from"./WithTooltip-SK46ZJ2J-DFS1GOK_.js";import{useMDXComponents as s}from"./index-DPVndWBa.js";import{T as o}from"./tree-view.stories-DBP7_Kas.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-D9lRGvzE.js";import"./_commonjsHelpers-CqkleIqs.js";const a=""+new URL("tree-view-anatomy-PABvETN7.png",import.meta.url).href,h=""+new URL("tree-view-example-with-checkboxes-yEigrrfE.png",import.meta.url).href,c=""+new URL("tree-view-states-with-checkboxes-jS9qAv-a.png",import.meta.url).href;function r(t){const n={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:o}),`
...
|-------------------------------------------------------------------------------------------------------------------------|
| `,e.jsx(n.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=71476-1851",rel:"nofollow",children:"Figma tree view component →"})," |"]}),`
...
`,e.jsx("img",{src:a,alt:"Tree View Anatomy"}),`
...
`,e.jsx("img",{src:c,alt:"Tree View States With Checkboxes"})]})}function u(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{u as default};
