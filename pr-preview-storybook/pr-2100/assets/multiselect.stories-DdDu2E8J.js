...
VanillaJs:.addEventListener("ifxOpen", (event) => {//handle change});`}}}}},s=e=>{const o=`<ifx-multiselect
  name='${e.name}'
  disabled='${e.disabled}'
  required='${e.required}'
  error='${e.error}'
...
</ifx-multiselect>`;return setTimeout(()=>{document.querySelector("ifx-multiselect").addEventListener("ifxSelect",i("ifxSelect")),document.querySelector("ifx-multiselect").addEventListener("ifxOpen",i("ifxOpen"))},0),o},t=s.bind({});t.args={label:"Generic Multi-Level Selection",placeholder:"Select options..."};t.parameters={docs:{description:{story:"The multiselect component supports nested hierarchical options with search, select all, and expand/collapse functionality. Use slot-based syntax for defining options and their nested structure."}}};const c=e=>{const o=`<ifx-multiselect
  name='${e.name}'
  disabled='${e.disabled}'
  error='${e.error}'
  caption='${e.caption}'
...
</ifx-multiselect>`;return setTimeout(()=>{const a=document.querySelectorAll("ifx-multiselect")[document.querySelectorAll("ifx-multiselect").length-1];a.addEventListener("ifxSelect",i("ifxSelect")),a.addEventListener("ifxOpen",i("ifxOpen"))},0),o},l=c.bind({});l.args={label:"Single Level Selection",placeholder:"Select options..."};l.parameters={docs:{description:{story:"A simple multiselect with single-level options - no nesting or hierarchical structure. Expand/Collapse controls are automatically hidden for single-level option lists."}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`args => {
  ...
  return template;
}`,...l.parameters?.docs?.source}}};const r=["Default","SingleLevel"],p=Object.freeze(Object.defineProperty({__proto__:null,Default:t,SingleLevel:l,__namedExportsOrder:r,default:n},Symbol.toStringTag,{value:"Module"}));export{t as D,p as S};
