import{j as t,M as i}from"./WithTooltip-SK46ZJ2J-DFS1GOK_.js";import{useMDXComponents as o}from"./index-DPVndWBa.js";import{C as r}from"./content-switcher.stories-CnVBxOtF.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-D9lRGvzE.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icons-C_9-zI1i.js";const a=""+new URL("content-switcher-anatomy-LL2dglav.png",import.meta.url).href,c=""+new URL("content-switcher-mouse-interaction-Dpkm47uq.png",import.meta.url).href,h=""+new URL("content-switcher-states-D8-NYDwM.png",import.meta.url).href,l=""+new URL("content-switcher-variants-C8-vmase.png",import.meta.url).href;function s(n){const e={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...o(),...n.components};return t.jsxs(t.Fragment,{children:[t.jsx(i,{of:r}),`
...
`,t.jsxs(e.p,{children:[`| Resources                                                                                                                |
|--------------------------------------------------------------------------------------------------------------------------|
| `,t.jsx(e.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=63857-4879",rel:"nofollow",children:"Figma Content Switcher component →"})," |"]}),`
...
`,t.jsx("img",{src:l,alt:"Content Switcher Variants"})]})}function b(n={}){const{wrapper:e}={...o(),...n.components};return e?t.jsx(e,{...n,children:t.jsx(s,{...n})}):s(n)}export{b as default};
