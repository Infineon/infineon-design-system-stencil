import{j as e,M as i}from"./WithTooltip-SK46ZJ2J-DFS1GOK_.js";import{useMDXComponents as t}from"./index-DPVndWBa.js";import{S as r}from"./status.stories-DfIDV5hh.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-D9lRGvzE.js";import"./_commonjsHelpers-CqkleIqs.js";const l=""+new URL("status-variant-outline-CMVaN4to.png",import.meta.url).href,a=""+new URL("status-variant-simple-CE5J_zOA.png",import.meta.url).href,c=""+new URL("status-usage-info-B_h9yFEG.png",import.meta.url).href,d=""+new URL("status-usage-table-DjV2Vdh9.png",import.meta.url).href;function s(o){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",ul:"ul",...t(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:r}),`
...
|----------------------------------------------------------------------------------------------------------------------------------------------------|
| `,e.jsx(n.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=22477-15125&t=aY9BfRC7bLZytmWu-4",rel:"nofollow",children:"Figma status component →"})," |"]}),`
...
`,e.jsxs(n.p,{children:["Also check out the infineon ",e.jsx(n.a,{href:"https://infineon.github.io/infineon-design-system-stencil/?path=/docs/foundations-colors--development",rel:"nofollow",children:"Colors Foundation →"})]})]})}function j(o={}){const{wrapper:n}={...t(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{j as default};
