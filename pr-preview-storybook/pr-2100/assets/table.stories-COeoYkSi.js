...
VanillaJs:.addEventListener("ifxSelectionChange", (event) => {//handle input});`}}}}},h=e=>{if(e.filterOrientation==="none")return`<ifx-table
    ...
    `}).join(""),S=e.columnDefs.map((t,w)=>{const m=[...new Set(e.rowData.map(n=>n[t.field]))].filter(n=>n!=null&&n!=="").map(n=>({value:n,label:n,selected:!1})),$=JSON.stringify(m);return`
        <ifx-set-filter slot="filter-component-${w+1}"
          ...
          `}).join(`
`),v=e.filterOrientation==="sidebar"?`<ifx-filter-type-group slot="sidebar-filter">
    ...
    <ifx-table
      ...
      <ifx-button slot="inner-button">Button</ifx-button>
    </ifx-table>`,l=P.bind({});l.args={rowHeight:"default",columnDefs:D,rowData:C,filterOrientation:"none",pagination:!1};const s=I.bind({});s.args={rowHeight:"default",columnDefs:x,rowData:k,filterOrientation:"none",pagination:!1};const f=V.bind({});f.args={rowHeight:"default",columnDefs:N,rowData:H,filterOrientation:"none",pagination:!1};const c=T.bind({});c.args={rowHeight:"default",columnDefs:x,rowData:O,filterOrientation:"none",pagination:!1};const g=B.bind({});g.args={rowHeight:"default",columnDefs:x,rowData:d,filterOrientation:"topbar",pagination:!1};const p=h.bind({});p.args={rowHeight:"default",columnDefs:b,rowData:d,filterOrientation:"sidebar"};const u=h.bind({});u.args={headline:"Matching results",rowHeight:"default",columnDefs:b,rowData:d,filterOrientation:"topbar"};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`args => {
