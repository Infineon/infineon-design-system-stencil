import{i as e}from"./icons-C_9-zI1i.js";const l={title:"Components/Footer",tags:["autodocs"],args:{copyrightText:"© 1999 - 2024 Infineon Technologies AG",href:"http://infineon.com",icon:"home-16",ariaLabelOfLink:"Go to Homepage"},argTypes:{copyrightText:{description:"Sets the text for the copyright.",control:"text",table:{category:"ifx-footer props"}},icon:{description:"Sets the icon for the footer.",options:Object.keys(e),control:{type:"select"},table:{category:"ifx-icon props",type:{summary:"string"}}},href:{description:"Sets the link for the footer.",control:"text",table:{category:"ifx-link props"}},ariaLabelOfLink:{name:"ariaLabel",description:"Sets the aria-label for the link. Enhances accessibility.",control:"text",table:{category:"ifx-link props",type:{summary:"Options",detail:"Follow us on..."}}}}},r=i=>`
    <ifx-footer copyright-text="${i.copyrightText}">
    <div slot="socials">
    <ifx-link variant="title" href="${i.href}" aria-label="${i.ariaLabelOfLink}">
        <ifx-icon icon=${i.icon}></ifx-icon>
      </ifx-link>
...
</ifx-footer>`,n=a.bind({}),t=r.bind({}),o=f.bind({});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`args => {
  return \`
...
}`,...o.parameters?.docs?.source}}};const k=["Small","Medium","Large"],s=Object.freeze(Object.defineProperty({__proto__:null,Large:o,Medium:t,Small:n,__namedExportsOrder:k,default:l},Symbol.toStringTag,{value:"Module"}));export{s as F};
