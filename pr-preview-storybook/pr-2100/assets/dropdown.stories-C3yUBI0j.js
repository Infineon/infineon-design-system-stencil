...
</ifx-dropdown>`;const n=o.querySelector("ifx-dropdown"),t=n.querySelector("ifx-dropdown-menu");return n.addEventListener("ifxOpen",r("ifxOpen")),n.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),o},a=l.bind({}),m=e=>{const o=document.createElement("div");o.innerHTML=`<ifx-dropdown
...
</ifx-dropdown>`;const n=o.querySelector("ifx-dropdown"),t=n.querySelector("ifx-dropdown-menu");return n.addEventListener("ifxOpen",r("ifxOpen")),n.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),o},i=m.bind({});i.argTypes={label:{table:{disable:!0}},variant:{table:{disable:!0}}};const u=e=>{const o=document.createElement("div");o.innerHTML=`<ifx-dropdown
  placement="${e.placement}"
  default-open="${e.defaultOpen}"
  no-close-on-outside-click="${e.noCloseOnOutsideClick}"
  no-close-on-menu-click="${e.noCloseOnOutsideClick}"
...
</ifx-dropdown>`;const n=o.querySelector("ifx-dropdown"),t=n.querySelector("ifx-dropdown-menu");return n.addEventListener("ifxOpen",r("ifxOpen")),n.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),o},p=w.bind({}),x=e=>{const o=document.createElement("div");o.innerHTML=`<ifx-dropdown
  placement="${e.placement}"
  default-open="${e.defaultOpen}"
   no-close-on-outside-click="${e.noCloseOnOutsideClick}"
  no-close-on-menu-click="${e.noCloseOnOutsideClick}"
...
</ifx-dropdown>`;const n=o.querySelector("ifx-dropdown"),t=n.querySelector("ifx-dropdown-menu");return n.addEventListener("ifxOpen",r("ifxOpen")),n.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),o},f=x.bind({});a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`args => {
