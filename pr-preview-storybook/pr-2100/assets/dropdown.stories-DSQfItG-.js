...
VanillaJs:.addEventListener("ifxDropdownMenuItem", (event) => {//handle change});`}}}}},l=e=>{const n=document.createElement("div");n.innerHTML=`<ifx-dropdown placement="${e.placement}" 
  disabled="${e.disabled}" 
  ...
  <ifx-dropdown-menu size="${e.size}">
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}">Menu Item</ifx-dropdown-item>
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}">Menu Item</ifx-dropdown-item>
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}">Menu Item</ifx-dropdown-item>
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}">Menu Item</ifx-dropdown-item>
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}">Menu Item</ifx-dropdown-item>
  </ifx-dropdown-menu>
</ifx-dropdown>`;const o=n.querySelector("ifx-dropdown"),t=o.querySelector("ifx-dropdown-menu");return o.addEventListener("ifxOpen",r("ifxOpen")),o.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),n},a=l.bind({}),m=e=>{const n=document.createElement("div");n.innerHTML=`<ifx-dropdown
...
</ifx-dropdown>`;const o=n.querySelector("ifx-dropdown"),t=o.querySelector("ifx-dropdown-menu");return o.addEventListener("ifxOpen",r("ifxOpen")),o.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),n},i=m.bind({});i.argTypes={label:{table:{disable:!0}},variant:{table:{disable:!0}}};const u=e=>{const n=document.createElement("div");n.innerHTML=`<ifx-dropdown
  placement="${e.placement}"
  default-open="${e.defaultOpen}"
  no-close-on-outside-click="${e.noCloseOnOutsideClick}"
  no-close-on-menu-click="${e.noCloseOnOutsideClick}"
...
</ifx-dropdown>`;const o=n.querySelector("ifx-dropdown"),t=o.querySelector("ifx-dropdown-menu");return o.addEventListener("ifxOpen",r("ifxOpen")),o.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),n},d=u.bind({});d.argTypes={label:{table:{disable:!0}},variant:{table:{disable:!0}}};const w=e=>{const n=document.createElement("div");n.innerHTML=`<ifx-dropdown
  placement="${e.placement}"
  default-open="${e.defaultOpen}"
  no-close-on-outside-click="${e.noCloseOnOutsideClick}"
  no-close-on-menu-click="${e.noCloseOnOutsideClick}"
...
</ifx-dropdown>`;const o=n.querySelector("ifx-dropdown"),t=o.querySelector("ifx-dropdown-menu");return o.addEventListener("ifxOpen",r("ifxOpen")),o.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),n},p=w.bind({}),x=e=>{const n=document.createElement("div");n.innerHTML=`<ifx-dropdown
  placement="${e.placement}"
  default-open="${e.defaultOpen}"
   no-close-on-outside-click="${e.noCloseOnOutsideClick}"
  no-close-on-menu-click="${e.noCloseOnOutsideClick}"
...
</ifx-dropdown>`;const o=n.querySelector("ifx-dropdown"),t=o.querySelector("ifx-dropdown-menu");return o.addEventListener("ifxOpen",r("ifxOpen")),o.addEventListener("ifxClose",r("ifxClose")),t.addEventListener("ifxDropdownMenuItem",r("ifxDropdownMenuItem")),n},f=x.bind({});a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`args => {
  ...
  dropdownMenu.addEventListener("ifxDropdownMenuItem", action("ifxDropdownMenuItem"));
  return wrapper;
}`,...f.parameters?.docs?.source}}};const h=["Default","LabelTrigger","Header","SearchField","Separator"],g=Object.freeze(Object.defineProperty({__proto__:null,Default:a,Header:d,LabelTrigger:i,SearchField:p,Separator:f,__namedExportsOrder:h,default:s},Symbol.toStringTag,{value:"Module"}));export{g as D};
