import{j as e,M as o}from"./WithTooltip-SK46ZJ2J-Dk6xP2TK.js";import{useMDXComponents as i}from"./index-Ba6_DNLG.js";import{D as s}from"./dropdown.stories-CBaXfkxk.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-1HBkPUig.js";import"./_commonjsHelpers-CqkleIqs.js";import"./icons-C_9-zI1i.js";const a=""+new URL("dropdown-menu-variants-DU4Q9Rc_.png",import.meta.url).href,d=""+new URL("dropdown-menu-trigger-GnLGIp1v.png",import.meta.url).href,h=""+new URL("dropdown-menu-states-DN1NfuA8.png",import.meta.url).href,l=""+new URL("dropdown-menu-sizes-j7IIyYqG.png",import.meta.url).href,c=""+new URL("dropdown-menu-scroll-behavior-uVmLXrsy.png",import.meta.url).href,p=""+new URL("dropdown-menu-filter-search-agY7clb3.png",import.meta.url).href,u=""+new URL("dropdown-menu-filter-search-flow-Cp6OFgpu.png",import.meta.url).href;function t(r){const n={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",h5:"h5",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{of:s}),`
...
|--------------------------------------------------------------------------------------------------------------------------------|
| `,e.jsx(n.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=2602-6446",rel:"nofollow",children:"Figma dropdown menu component →"})," |"]}),`
...
`,e.jsx("img",{src:h,alt:"Dropdown Menu States"})]})}function D(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{D as default};
