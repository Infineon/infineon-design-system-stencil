...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:e.jsx(n.a,{href:"./?path=/docs/setup-installation-framework-integration-angular--docs",children:"Angular"})})," - Supports both Standalone Components and NgModule approaches"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:e.jsx(n.a,{href:"./?path=/docs/setup-installation-framework-integration-react--docs",children:"React"})})," - Provides React-specific interfaces with proper prop and event handling"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:e.jsx(n.a,{href:"./?path=/docs/setup-installation-framework-integration-vue--docs",children:"Vue"})})," - Includes v-model support and Vue 3 composition API compatibility"]}),`
`]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:e.jsx(n.a,{href:"./?path=/docs/setup-installation-framework-integration-html--docs",children:"HTML"})})," - CDN or bundler approach for plain HTML/JavaScript projects"]}),`
`]}),`
