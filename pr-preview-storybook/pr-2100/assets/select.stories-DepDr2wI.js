...
VanillaJs:.addEventListener("ifxInput", (event) => {//handle input});`}}},clearSelection:{description:"Public method for clearing the selected options",table:{category:"ifx-select public methods"}}}},s=e=>{const l=`<ifx-select 
  size='${e.size}'
 ...
 </ifx-select>`;return setTimeout(()=>{document.querySelector("ifx-select")?.addEventListener("ifxSelect",a("ifxSelect")),document.querySelector("ifx-select")?.addEventListener("ifxInput",a("ifxInput"))},0),l},t=s.bind({});t.args={options:o};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`args => {
  ...
  return template;
}`,...t.parameters?.docs?.source}}};const n=["Single"],i=Object.freeze(Object.defineProperty({__proto__:null,Single:t,__namedExportsOrder:n,default:r},Symbol.toStringTag,{value:"Module"}));export{i as S,t as a};
