import{j as e,M as s}from"./blocks-CGU_Vj0y.js";import{useMDXComponents as o}from"./index-B6554Ctt.js";import{M as r}from"./modal.stories-BEbRb-kE.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-hVO8VkC8.js";import"./icons-C_9-zI1i.js";const a=""+new URL("modal-alert-desktop-1BTLoSxu.png",import.meta.url).href,l=""+new URL("modal-default-desktop-J64utPUB.png",import.meta.url).href,d=""+new URL("modal-mobile-360-CnPUBXaO.png",import.meta.url).href,h=""+new URL("modal-anatomy-BwiW9-sD.png",import.meta.url).href,c=""+new URL("modal-alert-status-DdD8sR71.png",import.meta.url).href;function i(n){const t={a:"a",blockquote:"blockquote",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:r}),`
...
|------------------------------------------------------------------------------------------------------------------------|
| `,e.jsx(t.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=2424-2513",rel:"nofollow",children:"Figma modal component →"})," |"]}),`
...
`,e.jsx("img",{src:l,alt:"Modal Default Desktop"}),`
...
`,e.jsx("img",{src:d,alt:"Modal Mobile < 360px"})]})}function w(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{w as default};
