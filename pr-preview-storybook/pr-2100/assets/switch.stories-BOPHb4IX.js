...
VanillaJs:.addEventListener("ifxChange", (event) => {//handle change});`}},action:"ifxChange"}}},r=t=>{const e=document.createElement("ifx-switch");e.setAttribute("checked",t.checked),e.setAttribute("name",t.name),e.setAttribute("value",t.value),e.setAttribute("disabled",t.disabled),e.addEventListener("ifxChange",i=>{const n=i,o=n.detail;c("ifxChange")(n),t.value=o});const s=document.createTextNode(t.label);return e.appendChild(s),e},a=r.bind({});a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`args => {
  ...
  return element;
}`,...a.parameters?.docs?.source}}};const d=["Default"],u=Object.freeze(Object.defineProperty({__proto__:null,Default:a,__namedExportsOrder:d,default:l},Symbol.toStringTag,{value:"Module"}));export{u as S};
