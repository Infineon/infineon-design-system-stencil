...
VanillaJs:.addEventListener("ifxOpen", (event) => {//handle change});`}}}}},n=e=>{const o=`<ifx-multiselect
  name='${e.name}'
  disabled='${e.disabled}'
  required='${e.required}'
  error='${e.error}'
...
</ifx-multiselect>`;return setTimeout(()=>{document.querySelector("ifx-multiselect").addEventListener("ifxSelect",i("ifxSelect")),document.querySelector("ifx-multiselect").addEventListener("ifxOpen",i("ifxOpen"))},0),o},t=n.bind({});t.args={label:"Generic Multi-Level Selection",placeholder:"Select options..."};t.parameters={docs:{description:{story:"The multiselect component supports nested hierarchical options with search, select all, and expand/collapse functionality. Use slot-based syntax for defining options and their nested structure."}}};const c=e=>{const o=`<ifx-multiselect
  name='${e.name}'
  disabled='${e.disabled}'
  error='${e.error}'
  caption='${e.caption}'
  ...
  return template;
}`,...l.parameters?.docs?.source}}};const r=["Default","SingleLevel"],p=Object.freeze(Object.defineProperty({__proto__:null,Default:t,SingleLevel:l,__namedExportsOrder:r,default:s},Symbol.toStringTag,{value:"Module"}));export{t as D,p as S};
