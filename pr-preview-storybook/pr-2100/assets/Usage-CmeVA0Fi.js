import{j as e,M as o}from"./WithTooltip-SK46ZJ2J-DFS1GOK_.js";import{useMDXComponents as i}from"./index-DPVndWBa.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-D9lRGvzE.js";import"./_commonjsHelpers-CqkleIqs.js";const l=""+new URL("select-sizes-B_WdOFH1.png",import.meta.url).href,r=""+new URL("select-field-anatomy-DbLBY75m.png",import.meta.url).href,c=""+new URL("select-field-mouse-interaction-D8JkTYR3.png",import.meta.url).href,a=""+new URL("select-single-options-states-COCfONds.png",import.meta.url).href,h=""+new URL("select-single-states-BYINJMLM.png",import.meta.url).href,d=""+new URL("select-multi-partial-BSxoVmor.png",import.meta.url).href,p=""+new URL("select-multi-options-states-D_W23MvJ.png",import.meta.url).href,u=""+new URL("select-multi-states-BMhC4Z1l.png",import.meta.url).href;function s(n){const t={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Components/Select/Usage"}),`
...
|---------------------------------------------------------------------------------------------------------------------------|
| `,e.jsx(t.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=31285-18615",rel:"nofollow",children:"Figma select component →"})," |"]}),`
...
`,e.jsx("img",{src:u,alt:"Select Multi States"}),`
