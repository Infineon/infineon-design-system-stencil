...
disabled="${e.disabled}"
>
  ${Array.from({length:e.amountOfChipItems},(u,n)=>{const r=document.createElement("ifx-chip-item");return r.innerHTML=e.chipItemLabel+" "+(n+1),r.setAttribute("value",e.value+" "+(n+1)),e.selected&&n===1&&r.setAttribute("selected","true"),e.readOnly&&(e.variant==="multi"||n===0)&&r.setAttribute("selected","true"),r.outerHTML}).join(`
    `)}
</ifx-chip>`;const o=l.querySelector("ifx-chip");return o.addEventListener("ifxChange",m("ifxChange")),o},s=c.bind({});s.tags=["!dev","!autodocs"];const t=c.bind({});t.args={variant:"single"};t.argTypes={variant:{table:{disable:!0}}};const i=c.bind({});i.args={variant:"multi"};i.argTypes={variant:{table:{disable:!0}}};const a=c.bind({});a.args={readOnly:!0,variant:"multi"};a.argTypes={readOnly:{table:{disable:!0}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`args => {
...
>
  ...
  chip.addEventListener('ifxChange', action('ifxChange'));
  return chip;
}`,...a.parameters?.docs?.source}}};const h=["Default","Single","Multi","ReadOnly"],g=Object.freeze(Object.defineProperty({__proto__:null,Default:s,Multi:i,ReadOnly:a,Single:t,__namedExportsOrder:h,default:d},Symbol.toStringTag,{value:"Module"}));export{g as C};
