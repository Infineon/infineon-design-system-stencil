import{j as e,M as r}from"./WithTooltip-SK46ZJ2J-DFS1GOK_.js";import{useMDXComponents as t}from"./index-DPVndWBa.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-D9lRGvzE.js";import"./_commonjsHelpers-CqkleIqs.js";const a=""+new URL("grid-4px-example-oAebkAhy.png",import.meta.url).href,o=""+new URL("grid-placement-CKKDADJE.png",import.meta.url).href,l=""+new URL("grid-sizes-B4s6x0Gx.png",import.meta.url).href;function s(i){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Foundations/Grid"}),`
...
`,e.jsx("img",{src:a,alt:"Grid Basics"}),`
...
`,e.jsx("img",{src:l,alt:"Grid Sizes"}),`
...
`,e.jsxs(n.p,{children:[`| size | token | media queries | container (width) | margin | columns | gutter |
|------|------------|-----------------------|---------------------|---------|---------|---------|
| xs | `,e.jsx("code",{children:"$ifxBreakpointXs"}),` | min-width: 360px | scaling | 16px | 4 | 16px |
| s | `,e.jsx("code",{children:"$ifxBreakpointS"}),` | min-width: 576px | scaling | 16px | 8 | 16px |
| m | `,e.jsx("code",{children:"$ifxBreakpointM"}),` | min-width: 768px | scaling | 24px | 8 | 24px |
| l | `,e.jsx("code",{children:"$ifxBreakpointL"}),` | min-width: 992px | scaling | 32px | 12 | 24px |
| xl | `,e.jsx("code",{children:"$ifxBreakpointXl"}),` | min-width: 1200px | scaling | 56px | 12 | 32px |
| 2xl | `,e.jsx("code",{children:"$ifxBreakpoint2Xl"}),` | min-width: 1400px | scaling | 56px | 12 | 32px |
| 3xl | `,e.jsx("code",{children:"$ifxBreakpoint3Xl"})," | min-width: 1920px | scaling | 56px | 16 | 32px |"]}),`
...
`,e.jsx("img",{src:o,alt:"Grid Placement"})]})}function u(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{u as default};
