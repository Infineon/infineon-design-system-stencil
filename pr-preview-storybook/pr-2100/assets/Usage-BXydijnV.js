import{j as e,M as t}from"./WithTooltip-SK46ZJ2J-Dk6xP2TK.js";import{useMDXComponents as o}from"./index-Ba6_DNLG.js";import{P as i}from"./progress-bar.stories-CLS87y6c.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-1HBkPUig.js";import"./_commonjsHelpers-CqkleIqs.js";const a=""+new URL("progressbar-4px-ClpBuYmp.png",import.meta.url).href,h=""+new URL("progressbar-20px-CxjrYnFs.png",import.meta.url).href,l=""+new URL("progressbar-anatomy-CZShaRpP.png",import.meta.url).href;function n(r){const s={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...o(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(t,{of:i}),`
...
`,e.jsxs(s.p,{children:[`| Resources                                                                                                                     |
|-------------------------------------------------------------------------------------------------------------------------------|
| `,e.jsx(s.a,{href:"https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=2393-3988",rel:"nofollow",children:"Figma progress bar component →"})," |"]}),`
