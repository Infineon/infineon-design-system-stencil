import{u as o,j as e,M as s}from"./blocks-DEXNr0dk.js";import{M as r}from"./modal.stories-BuygrX0J.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-Kmmx51e9.js";import"./icons-CBa5BGDq.js";const a=""+new URL("modal-alert-desktop-1BTLoSxu.png",import.meta.url).href,d=""+new URL("modal-default-desktop-J64utPUB.png",import.meta.url).href,l=""+new URL("modal-mobile-360-CnPUBXaO.png",import.meta.url).href,h=""+new URL("modal-anatomy-BwiW9-sD.png",import.meta.url).href,c=""+new URL("modal-alert-status-DdD8sR71.png",import.meta.url).href;function i(n){const t={a:"a",blockquote:"blockquote",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...o(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:r}),`
...
`,e.jsx("img",{src:l,alt:"Modal Mobile < 360px"})]})}function b(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{b as default};
