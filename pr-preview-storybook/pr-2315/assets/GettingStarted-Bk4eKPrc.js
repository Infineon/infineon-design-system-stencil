import{u as i,j as e,M as o}from"./blocks-hFIzXCHy.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DYbI5rEQ.js";function t(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Setup & installation/Getting started"}),`
...
If the user doesn't set `,e.jsx(n.code,{children:"--ifx-font-family"})," in the global stylesheet, the font family will default to ",e.jsx(n.code,{children:"tokens.$ifxFontFamilyBody"}),"."]})]})}function h(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{h as default};
