import{u as t,j as e,M as r}from"./blocks-hFIzXCHy.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DYbI5rEQ.js";const d=""+new URL("grid-4px-example-oAebkAhy.png",import.meta.url).href,l=""+new URL("grid-placement-CKKDADJE.png",import.meta.url).href,c=""+new URL("grid-sizes-B4s6x0Gx.png",import.meta.url).href;function s(i){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Foundations/Grid"}),`
...
`,e.jsx("img",{src:l,alt:"Grid Placement"})]})}function j(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{j as default};
