...
variant='${a.variant}'>
</ifx-basic-table>`,e=o.bind({});e.args={cols:i,rows:r,tableHeight:"auto"};const t=o.bind({});t.args={tableHeight:"400px",cols:i,rows:r};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"args => html`<ifx-basic-table \ncols='${JSON.stringify(args.cols)}' \nrows='${JSON.stringify(args.rows)}'\ntable-height='${args.tableHeight}'\nrow-height='${args.rowHeight}'\nvariant='${args.variant}'>\n</ifx-basic-table>`",...e.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"args => html`<ifx-basic-table \ncols='${JSON.stringify(args.cols)}' \nrows='${JSON.stringify(args.rows)}'\ntable-height='${args.tableHeight}'\nrow-height='${args.rowHeight}'\nvariant='${args.variant}'>\n</ifx-basic-table>`",...t.parameters?.docs?.source}}};const l=["Default","FixedHeight"],c=Object.freeze(Object.defineProperty({__proto__:null,Default:e,FixedHeight:t,__namedExportsOrder:l,default:s},Symbol.toStringTag,{value:"Module"}));export{e as D,t as F,c as T};
