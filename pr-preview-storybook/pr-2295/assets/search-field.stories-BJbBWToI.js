...
VanillaJs: .addEventListener("ifxBlur", (event) => {//handle blur});`}}}}},T=({disabled:i,size:v,showDeleteIcon:L,placeholder:n,maxlength:o,value:w,autocomplete:I,showSuggestions:a,enableHistory:r,maxSuggestions:q,maxHistoryItems:E,historyKey:l,historyHeaderText:R,ariaLabelText:u,ariaLabelledBy:d,ariaDescribedBy:c,ariaExpanded:g,ariaControls:m,deleteIconAriaLabel:b,historyDeleteAriaLabel:f,dropdownAriaLabel:h,suggestionAriaLabel:y,historyItemAriaLabel:p})=>{const e=document.createElement("ifx-search-field");return e.setAttribute("size",v),i&&e.setAttribute("disabled",i),e.setAttribute("show-delete-icon",L),e.setAttribute("show-suggestions",a),e.setAttribute("enable-history",r),e.setAttribute("max-suggestions",q),e.setAttribute("max-history-items",E),e.setAttribute("history-key",l),e.setAttribute("history-header-text",R),e.setAttribute("value",w),e.setAttribute("autocomplete",I),n!==void 0&&e.setAttribute("placeholder",n),o!==void 0&&e.setAttribute("maxlength",o),u!==void 0&&e.setAttribute("aria-label-text",u),d!==void 0&&e.setAttribute("aria-labelledby",d),c!==void 0&&e.setAttribute("aria-describedby",c),g!==void 0&&e.setAttribute("aria-expanded",g),m!==void 0&&e.setAttribute("aria-controls",m),b!==void 0&&e.setAttribute("delete-icon-aria-label",b),f!==void 0&&e.setAttribute("history-delete-aria-label",f),h!==void 0&&e.setAttribute("dropdown-aria-label",h),y!==void 0&&e.setAttribute("suggestion-aria-label",y),p!==void 0&&e.setAttribute("history-item-aria-label",p),setTimeout(()=>{a&&(e.suggestions=S),r&&typeof localStorage<"u"&&H(l)},100),e.addEventListener("ifxInput",t("ifxInput")),e.addEventListener("ifxSuggestionRequested",t("ifxSuggestionRequested")),e.addEventListener("ifxSuggestionSelected",t("ifxSuggestionSelected")),e.addEventListener("ifxFocus",t("ifxFocus")),e.addEventListener("ifxBlur",t("ifxBlur")),e.addEventListener("ifxSuggestionRequested",D=>{const x=D.detail;if(x&&a){const C=S.filter(F=>F.text.toLowerCase().includes(x.toLowerCase()));e.suggestions=C}}),e},A=T.bind({}),k=({disabled:i,size:v,showDeleteIcon:L,placeholder:n,maxlength:o,value:w,autocomplete:I,showSuggestions:a,enableHistory:r,maxSuggestions:q,maxHistoryItems:E,historyKey:l,historyHeaderText:R,ariaLabelText:u,ariaLabelledBy:d,ariaDescribedBy:c,ariaExpanded:g,ariaControls:m,deleteIconAriaLabel:b,historyDeleteAriaLabel:f,dropdownAriaLabel:h,suggestionAriaLabel:y,historyItemAriaLabel:p})=>{const e=document.createElement("ifx-search-field");return e.setAttribute("size",v),i&&e.setAttribute("disabled",i),e.setAttribute("show-delete-icon",L),e.setAttribute("show-suggestions",a),e.setAttribute("enable-history",r),e.setAttribute("max-suggestions",q),e.setAttribute("max-history-items",E),e.setAttribute("history-key",l),e.setAttribute("history-header-text",R),e.setAttribute("value",w),e.setAttribute("autocomplete",I),n!==void 0&&e.setAttribute("placeholder",n),o!==void 0&&e.setAttribute("maxlength",o),u!==void 0&&e.setAttribute("aria-label-text",u),d!==void 0&&e.setAttribute("aria-labelledby",d),c!==void 0&&e.setAttribute("aria-describedby",c),m!==void 0&&e.setAttribute("aria-controls",m),g!==void 0&&e.setAttribute("aria-expanded",g),b!==void 0&&e.setAttribute("delete-icon-aria-label",b),f!==void 0&&e.setAttribute("history-delete-aria-label",f),h!==void 0&&e.setAttribute("dropdown-aria-label",h),y!==void 0&&e.setAttribute("suggestion-aria-label",y),p!==void 0&&e.setAttribute("history-item-aria-label",p),setTimeout(()=>{e.suggestions=S,r&&typeof localStorage<"u"&&H(l)},100),e.addEventListener("ifxInput",t("ifxInput")),e.addEventListener("ifxSuggestionRequested",t("ifxSuggestionRequested")),e.addEventListener("ifxSuggestionSelected",t("ifxSuggestionSelected")),e.addEventListener("ifxFocus",t("ifxFocus")),e.addEventListener("ifxBlur",t("ifxBlur")),e.addEventListener("ifxSuggestionRequested",D=>{const x=D.detail;if(x){const C=S.filter(F=>F.text.toLowerCase().includes(x.toLowerCase()));e.suggestions=C}}),e},s=k.bind({});s.args={showDeleteIcon:!0,disabled:!1,size:"m",value:"",placeholder:"Search with suggestions...",autocomplete:"off",showSuggestions:!0,enableHistory:!0,maxSuggestions:10,maxHistoryItems:5,historyKey:"storybook-search-history",historyHeaderText:"Recent Searches",ariaLabelText:"Search field",deleteIconAriaLabel:"Clear search",historyDeleteAriaLabel:"Remove from history",dropdownAriaLabel:"Search suggestions and history",suggestionAriaLabel:"Search suggestion",historyItemAriaLabel:"Search history item"};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`({
  disabled,
  size,
  showDeleteIcon,
  placeholder,
  ...
  return element;
}`,...s.parameters?.docs?.source}}};const z=["Default","SearchSuggestions"],_=Object.freeze(Object.defineProperty({__proto__:null,Default:A,SearchSuggestions:s,__namedExportsOrder:z,default:B},Symbol.toStringTag,{value:"Module"}));export{A as D,_ as S};
