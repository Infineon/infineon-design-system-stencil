...
`;const o=r.querySelector("ifx-segmented-control");return o.addEventListener("ifxChange",l("ifxChange")),o},n=c.bind({});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
