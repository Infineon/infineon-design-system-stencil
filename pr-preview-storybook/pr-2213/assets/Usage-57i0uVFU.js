import{u as i,j as e,M as s}from"./blocks-ChQICO6H.js";import{P as r}from"./popover.stories-DmFtDgog.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DXJHQe3t.js";const a=""+new URL("popover-anatomy-Dufxffps.png",import.meta.url).href,c=""+new URL("popover-mouse-interaction-DN17wxF0.png",import.meta.url).href,h=""+new URL("popover-compact-wTnr0PWD.png",import.meta.url).href,l=""+new URL("popover-interactive-elements-D4TlWy7c.png",import.meta.url).href,p=""+new URL("popover-directions-Cn9chssL.png",import.meta.url).href,d=""+new URL("popover-feature-comparison-tjp1150_.png",import.meta.url).href,m=""+new URL("popover-dismissible-iO--29HJ.png",import.meta.url).href;function o(t){const n={a:"a",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:r}),`
...
`,e.jsx("img",{src:l,alt:"Popover Interactive Elements"})]})}function f(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{f as default};
