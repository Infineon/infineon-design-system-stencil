...
`,e.jsx("img",{src:x,alt:"Radio Button Group Inline states"}),`
`,e.jsx(t.h2,{id:"block-1",children:"Block"}),`
`,e.jsx("img",{src:m,alt:"Radio Button Group Block states"})]})}function R(n={}){const{wrapper:t}={...i(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{R as default};
