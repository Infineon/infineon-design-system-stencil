import{u as t,j as e,M as s}from"./blocks-ChQICO6H.js";import{B as a}from"./breadcrumb.stories-CN7S7TvA.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DXJHQe3t.js";import"./icons-CBa5BGDq.js";const o=""+new URL("breadcrumb-anatomy-DLg5M6GN.png",import.meta.url).href,c=""+new URL("breadcrumb-mouse-interaction-DtNaHYK3.png",import.meta.url).href,d=""+new URL("breadcrumb-positioning-desktop-BLn88AZD.png",import.meta.url).href,h=""+new URL("breadcrumb-positioning-mobile-C9iW2d6A.png",import.meta.url).href;function i(r){const n={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:a}),`
...
`,e.jsx("img",{src:o,alt:"Breadcrumb Anatomy"}),`
...
`,e.jsx("img",{src:c,alt:"Breadcrumb Mouse Interaction"})]})}function g(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(i,{...r})}):i(r)}export{g as default};
