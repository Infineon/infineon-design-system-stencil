import{i as u}from"./icons-DxYTBSFo.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,l={title:"Components/Accordion",component:"ifx-accordion",args:{amountOfItems:3,ariaLevelNumber:3,autoCollapse:!1,icon:""},argTypes:{amountOfItems:{control:"number",name:"Amount of Items",description:"Control the number of *<ifx-accordion-item>*.",table:{category:"story controls",type:{summary:"number"}}},ariaLevelNumber:{control:"number",min:1,max:6,description:"The aria-level attribute for the accordion item header.",table:{defaultValue:{summary:"3"},category:"ifx-accordion-item props",type:{summary:"number"}}},autoCollapse:{control:"boolean",description:"Collapse the other items when one item is opened.",table:{category:"ifx-accordion props",defaultValue:{summary:"false"},type:{summary:"boolean"}}},ifxOpen:{action:"ifxOpen",description:"Event emitted when an accordion item is opened.",table:{category:"custom events",type:{summary:"Framework integration",detail:`React: onIfxOpen={handleOpen}
          ...
          VanillaJs: .addEventListener("ifxClose", (event) => {/*handle close*/});`}}},icon:{name:"icon",control:{type:"select"},options:Object.keys(u),description:"Set the icon of the accordion. Use an empty string to remove the icon.",table:{category:"ifx-accordion props",defaultValue:{summary:""}}}}},c=e=>{const o=document.createElement("ifx-accordion"),t=document.createElement("ifx-accordion-item");t.setAttribute("caption","Label"),t.setAttribute("open","true"),t.setAttribute("aria-level-number",e.ariaLevelNumber),t.setAttribute("mutable",e.mutable),t.addEventListener("ifxOpen",a("ifxOpen")),t.addEventListener("ifxClose",a("ifxClose"));var s=e.icon==="none"?"":e.icon;t.setAttribute("icon",s),t.innerHTML=`
  ...
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent volutpat, ligula eu aliquam bibendum, orci nisl cursus ipsum, nec egestas odio sapien eget neque.
`,t.setAttribute("caption","Label"),o.append(t),o.setAttribute("auto-collapse",e.autoCollapse);for(let r=1;r<e.amountOfItems;r++){const i=document.createElement("ifx-accordion-item");i.setAttribute("caption","Label"),i.setAttribute("open","false"),i.setAttribute("aria-level-number",e.ariaLevelNumber),i.setAttribute("mutable",e.mutable);var s=e.icon==="none"?"":e.icon;i.setAttribute("icon",s),i.innerHTML=`
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent volutpat, ligula eu aliquam bibendum, orci nisl cursus ipsum, nec egestas odio sapien eget neque.
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent volutpat, ligula eu aliquam bibendum, orci nisl cursus ipsum, nec egestas odio sapien eget neque.
    `,i.addEventListener("ifxOpen",a("ifxOpen")),i.addEventListener("ifxClose",a("ifxClose")),o.append(i)}return o},n=c.bind({});n.args={amountOfItems:3,mutable:!0,icon:"",ariaLevelNumber:3};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
