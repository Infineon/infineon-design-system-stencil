...
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`pnpm add -D @infineon/infineon-design-system-mcp@<your-dds-version>
`})}),`
...
`,e.jsx(n.p,{children:"Once configured, AI assistants can automatically access DDS documentation when you ask questions:"}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Sample prompts to try:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.code,{children:'"List all available DDS components for React"'})}),`
`,e.jsx(n.li,{children:e.jsx(n.code,{children:'"Show me how to use ifx-button with all its properties"'})}),`
`,e.jsx(n.li,{children:e.jsx(n.code,{children:'"What are the available color tokens in DDS?"'})}),`
`,e.jsx(n.li,{children:e.jsx(n.code,{children:'"How do I set up DDS in an Angular project?"'})}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Example interaction:"})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{children:`You: "Show me the ifx-card component for React"

AI queries dds.getComponent → Gets official docs

AI responds with accurate code using:
- Correct import paths
- Real property names and types
- Working code examples from the design system
`})}),`
`,e.jsx(n.h3,{id:"benefits",children:"Benefits"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Always Up to Date"})," - Reads directly from your installed DDS version"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Framework-Specific"})," - Get examples for your exact framework (React, Vue, Angular, HTML)"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Complete Documentation"})," - All properties, events, slots, and CSS variables"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Team Consistency"})," - Everyone uses the same version via git-committed config"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Faster Development"})," - No need to search Storybook manually"]}),`
`]}),`
`,e.jsx(n.h3,{id:"requirements",children:"Requirements"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"VS Code with GitHub Copilot enabled"}),`
`,e.jsx(n.li,{children:"Node.js 18+ (for running the MCP server)"}),`
`]}),`
`,e.jsx(n.h3,{id:"learn-more",children:"Learn More"}),`
`,e.jsxs(n.p,{children:["See the ",e.jsx(n.a,{href:"https://github.com/Infineon/infineon-design-system-stencil/tree/master/packages/mcp",rel:"nofollow",children:"DDS MCP Server README"})," for advanced configuration and development details."]}),`
...
`]}),`
`,e.jsx(n.h3,{id:"requirements-1",children:"Requirements"}),`
`,e.jsxs(n.ul,{children:[`
...
`]}),`
`,e.jsx(n.h3,{id:"learn-more-1",children:"Learn More"}),`
`,e.jsxs(n.ul,{children:[`
