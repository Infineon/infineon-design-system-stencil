import{u as t,j as e,M as o}from"./blocks-DNTmtOQK.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-DDeJWSSJ.js";function i(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Setup & installation/AI Integration"}),`
...
`,e.jsx(n.h4,{id:"infineon-managed-devices",children:"Infineon managed devices"}),`
`,e.jsxs(n.p,{children:["If you are using GitHub Copilot on an Infineon managed device, install the MCP server through the ",e.jsx(n.a,{href:"vscode:extension/Infineon/design-system-mcp",children:"VS Code extension"}),"."]}),`
`,e.jsxs(n.p,{children:["For more Infineon-specific setup and operational guidance, see the ",e.jsx(n.a,{href:"https://devdocs.icp.infineon.com/devstack/GenAI/MCP/",rel:"nofollow",children:"internal MCP documentation"}),"."]}),`
`,e.jsx(n.h4,{id:"all-other-setups",children:"All other setups"}),`
`,e.jsx(n.p,{children:"Use the npm-based steps below."}),`
...
`,e.jsx(n.h4,{id:"infineon-managed-devices-1",children:"Infineon managed devices"}),`
`,e.jsxs(n.p,{children:["If you are using GitHub Copilot on an Infineon managed device, install the Figma MCP server through the ",e.jsx(n.a,{href:"vscode:extension/figma/figma-mcp-server",children:"VS Code extension"}),"."]}),`
`,e.jsx(n.h4,{id:"all-other-setups-1",children:"All other setups"}),`
