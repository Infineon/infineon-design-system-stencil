...
VanillaJs:.addEventListener("ifxOpen", (event) => {//handle change});`}}}}},c=e=>{const i=n`<ifx-multiselect
  name='${e.name}'
  ?disabled='${e.disabled}'
...
</ifx-multiselect>`;return setTimeout(()=>{document.querySelector("ifx-multiselect")?.addEventListener("ifxSelect",o("ifxSelect")),document.querySelector("ifx-multiselect")?.addEventListener("ifxOpen",o("ifxOpen"))},0),i},t=c.bind({});t.args={label:"Generic Multi-Level Selection",placeholder:"Select options..."};t.parameters={docs:{description:{story:"The multiselect component supports nested hierarchical options with search, select all, and expand/collapse functionality. Use slot-based syntax for defining options and their nested structure."}}};const r=e=>{const i=`<ifx-multiselect
  name='${e.name}'
  ?disabled='${e.disabled}'
  ?read-only='${e.readOnly}'
  ?error='${e.error}'
...
</ifx-multiselect>`;return setTimeout(()=>{const a=document.querySelectorAll("ifx-multiselect")[document.querySelectorAll("ifx-multiselect").length-1];a.addEventListener("ifxSelect",o("ifxSelect")),a.addEventListener("ifxOpen",o("ifxOpen"))},0),i},l=r.bind({});l.args={label:"Single Level Selection",placeholder:"Select options..."};l.parameters={docs:{description:{story:"A simple multiselect with single-level options - no nesting or hierarchical structure. Expand/Collapse controls are automatically hidden for single-level option lists."}}};const p=["Default","SingleLevel"];t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return template;
}`,...t.parameters?.docs?.source}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return template;
}`,...l.parameters?.docs?.source}}};const m=Object.freeze(Object.defineProperty({__proto__:null,Default:t,SingleLevel:l,__namedExportsOrder:p,default:s},Symbol.toStringTag,{value:"Module"}));export{t as D,m as S};
