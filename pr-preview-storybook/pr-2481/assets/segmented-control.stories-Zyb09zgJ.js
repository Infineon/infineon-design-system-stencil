...
`;const o=r.querySelector("ifx-segmented-control");return o.addEventListener("ifxChange",l("ifxChange")),o},n=c.bind({}),m=["Default"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
...
}`,...n.parameters?.docs?.source}}};const d=Object.freeze(Object.defineProperty({__proto__:null,Default:n,__namedExportsOrder:m,default:i},Symbol.toStringTag,{value:"Module"}));export{d as S};
