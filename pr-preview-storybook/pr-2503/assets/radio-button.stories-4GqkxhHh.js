...
VanillaJs:.addEventListener("ifxError", (event) => {//handle error});`}}}}},o=t=>{const e=document.createElement("ifx-radio-button");return e.disabled=t.disabled,e.error=t.error,e.readOnly=t.readOnly,e.checked=t.checked,e.setAttribute("size",t.size),e.setAttribute("name",t.name),e.setAttribute("value",t.value),e.textContent=t.label,e.addEventListener("ifxChange",a("ifxChange")),e.addEventListener("ifxError",a("ifxError")),e},n=o.bind({}),i=["Default"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  // Return the element
  return element;
}`,...n.parameters?.docs?.source}}};const s=Object.freeze(Object.defineProperty({__proto__:null,Default:n,__namedExportsOrder:i,default:r},Symbol.toStringTag,{value:"Module"}));export{n as D,s as R};
