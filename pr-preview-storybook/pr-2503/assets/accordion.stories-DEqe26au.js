import{i as u}from"./icons-CdnviRe7.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,l={title:"Components/Accordion",component:"ifx-accordion",args:{amountOfItems:3,ariaLevelNumber:3,autoCollapse:!1,icon:""},argTypes:{amountOfItems:{control:"number",name:"Amount of Items",description:"Control the number of *<ifx-accordion-item>*.",table:{category:"story controls",type:{summary:"number"}}},ariaLevelNumber:{control:"number",min:1,max:6,description:"The aria-level attribute for the accordion item header.",table:{defaultValue:{summary:"3"},category:"ifx-accordion-item props",type:{summary:"number"}}},autoCollapse:{control:"boolean",description:"Collapse the other items when one item is opened.",table:{category:"ifx-accordion props",defaultValue:{summary:"false"},type:{summary:"boolean"}}},ifxOpen:{action:"ifxOpen",description:"Event emitted when an accordion item is opened.",table:{category:"custom events",type:{summary:"Framework integration",detail:`React: onIfxOpen={handleOpen}
...
`,e.setAttribute("caption","Label"),o.append(e),o.setAttribute("auto-collapse",t.autoCollapse);for(let r=1;r<t.amountOfItems;r++){const i=document.createElement("ifx-accordion-item");i.setAttribute("caption","Label"),i.setAttribute("open","false"),i.setAttribute("aria-level-number",t.ariaLevelNumber);var s=t.icon==="none"?"":t.icon;i.setAttribute("icon",s),i.innerHTML=`
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent volutpat, ligula eu aliquam bibendum, orci nisl cursus ipsum, nec egestas odio sapien eget neque.
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent volutpat, ligula eu aliquam bibendum, orci nisl cursus ipsum, nec egestas odio sapien eget neque.
    `,i.addEventListener("ifxOpen",a("ifxOpen")),i.addEventListener("ifxClose",a("ifxClose")),o.append(i)}return o},n=c.bind({});n.args={amountOfItems:3,icon:"",ariaLevelNumber:3};const m=["Default"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
...
}`,...n.parameters?.docs?.source}}};const d=Object.freeze(Object.defineProperty({__proto__:null,Default:n,__namedExportsOrder:m,default:l},Symbol.toStringTag,{value:"Module"}));export{d as A,n as D};
