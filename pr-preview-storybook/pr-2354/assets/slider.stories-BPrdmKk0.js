...
VanillaJs:.addEventListener("ifxChange", (event) => {//handle change});`}}}}},l=e=>{const t=document.createElement("ifx-slider");return t.setAttribute("value",e.value),t.setAttribute("min",e.min),t.setAttribute("max",e.max),t.setAttribute("step",e.step),t.setAttribute("min-value-handle",e.minValueHandle),t.setAttribute("max-value-handle",e.maxValueHandle),t.setAttribute("type",e.type),t.setAttribute("aria-label-text",e.ariaLabelText),e.showPercentage&&t.setAttribute("show-percentage","true"),e.disabled&&t.setAttribute("disabled","true"),e.leftIcon&&t.setAttribute("left-icon",e.leftIcon),e.rightIcon&&t.setAttribute("right-icon",e.rightIcon),e.leftText&&t.setAttribute("left-text",e.leftText),e.rightText&&t.setAttribute("right-text",e.rightText),t.addEventListener("ifxChange",o("ifxChange")),t},r=l.bind({});r.args={min:0,max:100,step:1,value:50,minValueHandle:20,maxValueHandle:80,showPercentage:!1,disabled:!1,type:"single"};const n=l.bind({});n.args={...r.args,showPercentage:!0,disabled:!1};const i=l.bind({});i.args={...r.args,leftIcon:"cogwheel-16",rightIcon:"cogwheel-16"};const s=l.bind({});s.args={...r.args,leftText:"LeftText",rightText:"RightText"};const a=l.bind({});a.args={...r.args,disabled:!0};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  sliderElement.addEventListener("ifxChange", action("ifxChange"));
  return sliderElement;
}`,...n.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`(args: any) => {
  const sliderElement = document.createElement("ifx-slider");
  sliderElement.setAttribute("value", args.value);
  sliderElement.setAttribute("min", args.min);
  sliderElement.setAttribute("max", args.max);
  ...
  sliderElement.addEventListener("ifxChange", action("ifxChange"));
  return sliderElement;
}`,...i.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`(args: any) => {
  const sliderElement = document.createElement("ifx-slider");
  sliderElement.setAttribute("value", args.value);
  sliderElement.setAttribute("min", args.min);
  sliderElement.setAttribute("max", args.max);
