...
}`}}},variant:{description:"Sets the variant of the table.",table:{category:"ifx-table props",defaultValue:{summary:"default"}},options:["default","zebra"],control:{type:"radio"}},headline:{description:"Sets the headline of the table.",table:{category:"ifx-table props",defaultValue:{summary:"matching results"}}},headlineNumber:{description:"Sets the number in brackets right of the headline. When null, headline number is automatically set to the number of rows",table:{category:"ifx-table props",defaultValue:{summary:"matching results"}}},showSidebarFiltersButton:{description:'Shows or hides the sidebar filters toggle button. Only applies when filterOrientation is "sidebar".',control:{type:"boolean"},table:{category:"ifx-table props",defaultValue:{summary:!0},type:{summary:"Boolean"}}},ifxSelectionChange:{action:"ifxSelectionChange",description:"A custom event triggered on checkbox selection",table:{category:"custom events",type:{summary:"Framework integration",detail:`React: onIfxSelectionChange={handleInput}
...
VanillaJs:.addEventListener("ifxIfxSortChange", (event) => {//handle input});`}}},showMoreFilters:{description:"Public method that toggles the Topbar Filters. Accepts true or false as arguments. Accessible from the ifx-filter-bar component",table:{category:"ifx-table public methods"}}}},$=e=>{if(e.filterOrientation==="none")return t`<ifx-table
    ...
    </ifx-table>`,s=k.bind({});s.args={rowHeight:"default",cols:N,rows:C,filterOrientation:"none",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const f=B.bind({});f.args={rowHeight:"default",cols:w,rows:H,filterOrientation:"none",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const c=W.bind({});c.args={rowHeight:"default",cols:P,rows:J,filterOrientation:"none",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const g=T.bind({});g.args={rowHeight:"default",cols:w,rows:I,filterOrientation:"none",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const u=q.bind({});u.args={headline:"Matching results",rowHeight:"default",cols:w,rows:m,filterOrientation:"topbar",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const d=$.bind({});d.args={rowHeight:"default",cols:b,rows:m,filterOrientation:"sidebar",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',showSidebarFiltersButton:!0};const p=$.bind({});p.args={headline:"Matching results",rowHeight:"default",cols:b,rows:m,filterOrientation:"topbar",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return table;
}`,...g.parameters?.docs?.source}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`(args: any) => {
  const table = html\`
    <ifx-table
      headline="\${args.headline}"
      row-height="\${args.rowHeight}"
...
}`,...p.parameters?.docs?.source}}};const F=["DefaultState","Pagination","ServerSidePagination","IncludesButtons","IncludesStatus","IncludesLink","IncludesBreakingline","IncludesInnerButtons","SidebarFilter","TopbarFilter"],M=Object.freeze(Object.defineProperty({__proto__:null,DefaultState:r,IncludesBreakingline:g,IncludesButtons:s,IncludesInnerButtons:u,IncludesLink:c,IncludesStatus:f,Pagination:o,ServerSidePagination:l,SidebarFilter:d,TopbarFilter:p,__namedExportsOrder:F,default:V},Symbol.toStringTag,{value:"Module"}));export{r as D,s as I,o as P,l as S,M as T,u as a,d as b,p as c};
