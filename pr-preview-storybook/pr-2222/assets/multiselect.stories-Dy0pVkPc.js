...
VanillaJs:.addEventListener("ifxOpen", (event) => {//handle change});`}}}}},c=e=>{const o=n`<ifx-multiselect
  name='${e.name}'
  ?disabled='${e.disabled}'
