...
VanillaJs:.addEventListener("ifxError", (event) => {//handle error});`}}}}},b=({error:o,disabled:a,readOnly:n,checked:c,indeterminate:i,size:s,label:l,name:d})=>{const e=document.createElement("ifx-checkbox");return e.setAttribute("error",o),e.setAttribute("disabled",a),e.setAttribute("read-only",n),e.setAttribute("checked",c),e.setAttribute("size",s),e.setAttribute("indeterminate",i),e.setAttribute("name",d),e.addEventListener("ifxChange",r("ifxChange")),e.addEventListener("ifxError",r("ifxError")),e.innerHTML=`${l}`,e},t=b.bind({});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`({
  error,
  disabled,
  readOnly,
  checked,
  ...
  return checkbox;
}`,...t.parameters?.docs?.source}}};const x=["Default"],u=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:x,default:h},Symbol.toStringTag,{value:"Module"}));export{u as C};
