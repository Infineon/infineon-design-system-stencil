...
VanillaJs:.addEventListener("ifxChange", (event) => {//handle change});`}}}}},n=e=>{const t=document.createElement("ifx-slider");return t.setAttribute("value",e.value),t.setAttribute("min",e.min),t.setAttribute("max",e.max),t.setAttribute("step",e.step),t.setAttribute("min-value-handle",e.minValueHandle),t.setAttribute("max-value-handle",e.maxValueHandle),t.setAttribute("type",e.type),t.setAttribute("aria-label",e.ariaLabel),e.showPercentage&&t.setAttribute("show-percentage","true"),e.disabled&&t.setAttribute("disabled","true"),e.readOnly&&t.setAttribute("read-only","true"),e.leftIcon&&t.setAttribute("left-icon",e.leftIcon),e.rightIcon&&t.setAttribute("right-icon",e.rightIcon),e.leftText&&t.setAttribute("left-text",e.leftText),e.rightText&&t.setAttribute("right-text",e.rightText),t.addEventListener("ifxChange",o("ifxChange")),t},r=n.bind({});r.args={min:0,max:100,step:1,value:50,minValueHandle:20,maxValueHandle:80,showPercentage:!1,disabled:!1,readOnly:!1,type:"single"};const i=n.bind({});i.args={...r.args,showPercentage:!0,disabled:!1};const s=n.bind({});s.args={...r.args,leftIcon:"cogwheel-16",rightIcon:"cogwheel-16"};const l=n.bind({});l.args={...r.args,leftText:"LeftText",rightText:"RightText"};const a=n.bind({});a.args={...r.args,disabled:!0};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => {
  ...
  sliderElement.addEventListener("ifxChange", action("ifxChange"));
  return sliderElement;
}`,...a.parameters?.docs?.source}}};const m=["Default","WithPercentageDisplay","WithIcons","WithTexts","Disabled"],c=Object.freeze(Object.defineProperty({__proto__:null,Default:r,Disabled:a,WithIcons:s,WithPercentageDisplay:i,WithTexts:l,__namedExportsOrder:m,default:u},Symbol.toStringTag,{value:"Module"}));export{c as S};
