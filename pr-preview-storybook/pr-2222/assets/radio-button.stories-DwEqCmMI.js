...
VanillaJs:.addEventListener("ifxError", (event) => {//handle error});`}}}}},o=t=>{const e=document.createElement("ifx-radio-button");return e.disabled=t.disabled,e.readOnly=t.readOnly,e.error=t.error,e.checked=t.checked,e.setAttribute("size",t.size),e.setAttribute("name",t.name),e.setAttribute("value",t.value),e.textContent=t.label,e.addEventListener("ifxChange",r("ifxChange")),e.addEventListener("ifxError",r("ifxError")),e},n=o.bind({});n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`args => {
