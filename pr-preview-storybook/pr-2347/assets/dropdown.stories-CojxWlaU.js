...
VanillaJs:.addEventListener("ifxDropdownMenuItem", (event) => {//handle change});`}}}}},l=e=>{const o=document.createElement("div");o.innerHTML=`<ifx-dropdown placement="${e.placement}" 
  ...
  <ifx-dropdown-menu size="${e.size}">
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}" error="${e.error}" ${e.itemDisabled?"disabled":""}>Menu Item</ifx-dropdown-item>
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}" error="${e.error}" ${e.itemDisabled?"disabled":""}>Menu Item</ifx-dropdown-item>
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}" error="${e.error}" ${e.itemDisabled?"disabled":""}>Menu Item</ifx-dropdown-item>
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}" error="${e.error}" ${e.itemDisabled?"disabled":""}>Menu Item</ifx-dropdown-item>
    <ifx-dropdown-item icon="${e.icon==="none"?"":e.icon}" target="${e.target}" href="${e.href!==""?e.href:""}" error="${e.error}" ${e.itemDisabled?"disabled":""}>Menu Item</ifx-dropdown-item>
  ...
  dropdownMenu?.addEventListener("ifxDropdownMenuItem", action("ifxDropdownMenuItem"));
  return wrapper;
}`,...i.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`(args: any) => {
  const wrapper = document.createElement("div");
  wrapper.innerHTML = \`<ifx-dropdown
  placement="\${args.placement}"
  default-open="\${args.defaultOpen}"
  ...
  dropdownMenu?.addEventListener("ifxDropdownMenuItem", action("ifxDropdownMenuItem"));
  return wrapper;
}`,...p.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`(args: any) => {
  const wrapper = document.createElement("div");
  wrapper.innerHTML = \`<ifx-dropdown
  placement="\${args.placement}"
  default-open="\${args.defaultOpen}"
