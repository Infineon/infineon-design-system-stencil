...
`),O=e.filterOrientation==="sidebar"?t`<ifx-filter-type-group slot="sidebar-filter">
    ...
    filter-orientation="${e.filterOrientation}">
    ${O}
</ifx-table>`}},a=$.bind({});a.args={pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",enableSelection:!1,cols:b,rows:m,filterOrientation:"none"};const o=$.bind({});o.args={pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",cols:b,rows:m,filterOrientation:"none"};const l=$.bind({});l.args={pagination:!0,serverSidePagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",cols:b,rows:m,filterOrientation:"none"};const k=e=>t`
    <ifx-table
      row-height="${e.rowHeight}"
      .cols='${JSON.stringify(e.cols)}'
      .rows='${JSON.stringify(e.rows)}'
