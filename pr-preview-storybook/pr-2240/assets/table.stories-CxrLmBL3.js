...
VanillaJs:.addEventListener("ifxIfxSortChange", (event) => {//handle input});`}}},ifxFilterButtons:{action:"ifxShowFilterButtons",description:"Controls Show More and Show Less filters Buttons of Topbar Filter",table:{category:"custom events"}}}},$=e=>{if(e.filterOrientation==="none")return t`<ifx-table
    ...
    filter-orientation="${e.filterOrientation}">
    ${O}
</ifx-table>`}},r=$.bind({});r.args={pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",enableSelection:!1,cols:b,rows:m,filterOrientation:"none"};const o=$.bind({});o.args={pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",cols:b,rows:m,filterOrientation:"none"};const l=$.bind({});l.args={pagination:!0,serverSidePagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",cols:b,rows:m,filterOrientation:"none"};const k=e=>t`
    <ifx-table
      row-height="${e.rowHeight}"
      cols='${JSON.stringify(e.cols)}'
      rows='${JSON.stringify(e.rows)}'
    ...
    </ifx-table>`,s=k.bind({});s.args={rowHeight:"default",cols:N,rows:C,filterOrientation:"none",pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const f=W.bind({});f.args={rowHeight:"default",cols:w,rows:H,filterOrientation:"none",pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const c=T.bind({});c.args={rowHeight:"default",cols:P,rows:J,filterOrientation:"none",pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const g=q.bind({});g.args={rowHeight:"default",cols:w,rows:I,filterOrientation:"none",pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const p=B.bind({});p.args={headline:"Matching results",rowHeight:"default",cols:w,rows:m,filterOrientation:"topbar",pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const d=$.bind({});d.args={rowHeight:"default",cols:b,rows:m,filterOrientation:"sidebar",pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const u=$.bind({});u.args={headline:"Matching results",rowHeight:"default",cols:b,rows:m,filterOrientation:"topbar",pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return table;
}`,...p.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`(args: any) => {
  if (args.filterOrientation === 'none') {
    const table = html\`<ifx-table
    row-height="\${args.rowHeight}"
    cols='\${JSON.stringify(args.cols)}'
...
}`,...u.parameters?.docs?.source}}};const A=["DefaultState","Pagination","ServerSidePagination","IncludesButtons","IncludesStatus","IncludesLink","IncludesBreakingline","IncludesInnerButtons","SidebarFilter","TopbarFilter"],D=Object.freeze(Object.defineProperty({__proto__:null,DefaultState:r,IncludesBreakingline:g,IncludesButtons:s,IncludesInnerButtons:p,IncludesLink:c,IncludesStatus:f,Pagination:o,ServerSidePagination:l,SidebarFilter:d,TopbarFilter:u,__namedExportsOrder:A,default:V},Symbol.toStringTag,{value:"Module"}));export{r as D,s as I,o as P,l as S,D as T,p as a,d as b,u as c};
