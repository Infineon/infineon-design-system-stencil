import{j as e,M as i}from"./blocks-pZoiMIWN.js";import{useMDXComponents as s}from"./index-wO_wMMn3.js";import{T as o}from"./tabs.stories-fFsWGqvS.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-BCwuh1lD.js";import"./icons-DxYTBSFo.js";const r=""+new URL("tabs-anatomy-GvP5f5cF.png",import.meta.url).href,c=""+new URL("tabs-desktop-horizontal-HW9VZwC_.png",import.meta.url).href,l=""+new URL("tabs-desktop-vertical-KjcIP_Tf.png",import.meta.url).href,h=""+new URL("tabs-mobile-horizontal-B3V-SVRR.png",import.meta.url).href,d=""+new URL("tabs-states-D1XGmyHJ.png",import.meta.url).href,b=""+new URL("tabs-size-CH7W4IaW.png",import.meta.url).href,m=""+new URL("tabs-mouse-interaction-BmGJali2.png",import.meta.url).href,u=""+new URL("tabs-advanced-VUxXTmxE.png",import.meta.url).href,p=""+new URL("tabs-sticky-CbMcsEFk.png",import.meta.url).href;function a(n){const t={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{of:o}),`
...
`,e.jsx("img",{src:c,alt:"Tabs Desktop Horizontal"}),`
...
`,e.jsx("img",{src:l,alt:"Tabs Desktop Vertical"}),`
`,e.jsx(t.h4,{id:"mobile",children:"Mobile"}),`
`,e.jsx("img",{src:h,alt:"Tabs Mobile Use",width:"50%"}),`
`,e.jsxs(t.ul,{children:[`
...
`]}),`
`,e.jsx(t.h3,{id:"advanced",children:"Advanced"}),`
`,e.jsx(t.p,{children:"This variant enhances the standard tab with a subline text and an optional indicator (label or number), providing additional context and visual cues."}),`
`,e.jsx("img",{src:u,alt:"Tabs Advanced"}),`
`,e.jsx(t.h2,{id:"sticky-behaviour",children:"Sticky behaviour"}),`
`,e.jsx(t.p,{children:"Enables the tab to stick to the top of the viewport, remaining visible and accessible as the user scrolls down the page."}),`
`,e.jsx("img",{src:p,alt:"Tabs Sticky"}),`
...
`,e.jsx("img",{src:b,alt:"Tabs Size"}),`
`,e.jsx(t.h2,{id:"mouse-interaction",children:"Mouse Interaction"}),`
`,e.jsx(t.p,{children:"The whole tab item area should be clickable."}),`
`,e.jsx("img",{src:m,alt:"Tabs Mouse Interaction"}),`
`,e.jsx(t.h2,{id:"state",children:"State"}),`
`,e.jsx("img",{src:d,alt:"Tabs States"})]})}function y(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}export{y as default};
