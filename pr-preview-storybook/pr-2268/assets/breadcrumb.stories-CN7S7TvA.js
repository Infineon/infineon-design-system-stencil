...
</ifx-breadcrumb>`,t.querySelector("ifx-breadcrumb").querySelectorAll("ifx-breadcrumb-item").forEach(n=>{n.querySelector("ifx-dropdown-menu")?.addEventListener("ifxDropdownMenuItem",m("ifxDropdownMenuItem"))}),t},r=a.bind({});r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
