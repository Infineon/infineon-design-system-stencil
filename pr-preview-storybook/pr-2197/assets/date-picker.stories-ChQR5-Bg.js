...
VanillaJs:.addEventListener("ifxDate", (event) => {//handle input});`}}},clearSelection:{description:"Public method for clearing the date",table:{category:"ifx-date-picker public methods"}}}},h=({error:a,disabled:r,success:i,size:s,value:o,max:n,min:l,caption:c,label:d,ariaLabelText:p,required:u,name:m,autocomplete:b,type:f})=>{const e=document.createElement("ifx-date-picker");return e.setAttribute("name",m),e.setAttribute("error",a),e.setAttribute("disabled",r),e.setAttribute("size",s),e.setAttribute("success",i),e.setAttribute("value",o),e.setAttribute("max",n),e.setAttribute("min",l),e.setAttribute("label",d),e.setAttribute("caption",c),e.setAttribute("aria-label-text",p),e.setAttribute("required",u),e.setAttribute("autocomplete",b),e.setAttribute("type",f),e.addEventListener("ifxDate",y("ifxDate")),e},t=h.bind({});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`({
  error,
  disabled,
  success,
  size,
