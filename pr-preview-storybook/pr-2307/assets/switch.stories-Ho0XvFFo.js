...
Vanilla: element.addEventListener("ifxChange", (e) => console.log(e.detail));`}}}}},e={render:({label:t,checked:a,name:n,value:s,disabled:i})=>o`
            <ifx-switch
                ...
                value=${s}
                ?disabled=${i}
                @ifxChange=${c=>l("ifxChange")(c.detail)}
            >
                ${t}
            </ifx-switch>
  ...
  render: ({
    ...
    disabled
        ...
        \`
}`,...e.parameters?.docs?.source}}};const h=["Default"],m=Object.freeze(Object.defineProperty({__proto__:null,Default:e,__namedExportsOrder:h,default:r},Symbol.toStringTag,{value:"Module"}));export{m as S};
