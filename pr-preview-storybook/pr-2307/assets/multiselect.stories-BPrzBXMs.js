...
</ifx-multiselect>`;return setTimeout(()=>{document.querySelector("ifx-multiselect")?.addEventListener("ifxSelect",t("ifxSelect")),document.querySelector("ifx-multiselect")?.addEventListener("ifxOpen",t("ifxOpen"))},0),l},a=m.bind({}),f=e=>{const l=s`<ifx-multiselect
      name='multiselect'
      ?disabled='false'
      ?error='false'
      caption=''
...
`;return setTimeout(()=>{document.querySelector("ifx-multiselect")?.addEventListener("ifxSelect",t("ifxSelect")),document.querySelector("ifx-multiselect")?.addEventListener("ifxOpen",t("ifxOpen"))},0),l},n=f.bind({});i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`(args: any) => {
...
\`;
  ...
  return template;
}`,...n.parameters?.docs?.source}}};const x=["Default","SingleLevel","SeparatorDefault","SeparatorSingleLevel"],h=Object.freeze(Object.defineProperty({__proto__:null,Default:i,SeparatorDefault:a,SeparatorSingleLevel:n,SingleLevel:o,__namedExportsOrder:x,default:p},Symbol.toStringTag,{value:"Module"}));export{i as D,h as S,o as a,a as b,n as c};
