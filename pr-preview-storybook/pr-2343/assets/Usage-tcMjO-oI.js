import{u as i,j as e,M as s}from"./blocks-CgNKXVji.js";import{D as o}from"./dropdown.stories-Bq_I99UR.js";import"./preload-helper-PPVm8Dsz.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-IpKW8pPL.js";import"./icons-CBa5BGDq.js";const d=""+new URL("dropdown-menu-variants-nj_ehdMx.png",import.meta.url).href,a=""+new URL("dropdown-menu-trigger-GnLGIp1v.png",import.meta.url).href,h=""+new URL("dropdown-menu-states-BzE357yv.png",import.meta.url).href,l=""+new URL("dropdown-menu-sizes-DPpZsXwR.png",import.meta.url).href,c=""+new URL("dropdown-menu-scroll-behavior-uVmLXrsy.png",import.meta.url).href,p=""+new URL("dropdown-menu-filter-search-agY7clb3.png",import.meta.url).href,u=""+new URL("dropdown-menu-filter-search-flow-Cp6OFgpu.png",import.meta.url).href;function t(r){const n={a:"a",br:"br",h1:"h1",h2:"h2",h3:"h3",h5:"h5",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{of:o}),`
...
`,e.jsx("img",{src:d,alt:"Dropdown Menu Variants"}),`
...
`,e.jsx("img",{src:a,alt:"Dropdown Menu Trigger"}),`
...
`,e.jsx(n.p,{children:"There are two dropdown menu sizes: M and S."}),`
`,e.jsx("img",{src:l,alt:"Dropdown Menu Sizes"}),`
`,e.jsx(n.h2,{id:"states",children:"States"}),`
`,e.jsx("img",{src:h,alt:"Dropdown Menu States"})]})}function b(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{b as default};
