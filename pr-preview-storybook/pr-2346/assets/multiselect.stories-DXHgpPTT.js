...
VanillaJs:.addEventListener("ifxOpen", (event) => {//handle change});`}}}}},c=e=>{const i=n`<ifx-multiselect
  ...
  return template;
}`,...l.parameters?.docs?.source}}};const p=["Default","SingleLevel"],m=Object.freeze(Object.defineProperty({__proto__:null,Default:t,SingleLevel:l,__namedExportsOrder:p,default:s},Symbol.toStringTag,{value:"Module"}));export{t as D,m as S};
