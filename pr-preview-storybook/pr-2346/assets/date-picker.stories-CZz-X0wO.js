...
VanillaJs:.addEventListener("ifxDate", (event) => {//handle input});`}}},clearSelection:{description:"Public method for clearing the date",table:{category:"ifx-date-picker public methods"}}}},k=({error:a,disabled:r,readOnly:i,success:s,size:n,value:o,max:l,min:c,caption:d,label:p,ariaLabelText:u,required:m,name:b,autocomplete:y,type:f})=>{const e=document.createElement("ifx-date-picker");return e.setAttribute("name",b),e.setAttribute("error",a),e.setAttribute("disabled",r),e.setAttribute("read-only",i),e.setAttribute("size",n),e.setAttribute("success",s),e.setAttribute("value",o),e.setAttribute("max",l),e.setAttribute("min",c),e.setAttribute("label",p),e.setAttribute("caption",d),e.setAttribute("aria-label-text",u),e.setAttribute("required",m),e.setAttribute("autocomplete",y),e.setAttribute("type",f),e.addEventListener("ifxDate",x("ifxDate")),e},t=k.bind({});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`({
  ...
  return element;
}`,...t.parameters?.docs?.source}}};const A=["Default"],g=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:A,default:h},Symbol.toStringTag,{value:"Module"}));export{g as D};
