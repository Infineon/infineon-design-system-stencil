...
Event Detail: { collapsed: boolean }`}}},ifxSidebarLogoClick:{action:"ifxSidebarLogoClick",description:"Custom event emitted when the sidebar logo image is clicked.",table:{category:"custom events",type:{summary:"Framework integration",detail:`
  ...
  `,i},n=h.bind({}),S=e=>{const i=document.createElement("ifx-sidebar");i.setAttribute("application-name",e.applicationName),i.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),i.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),i.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),i.setAttribute("initial-collapse",e.initialCollapse),i.setAttribute("position",e.position),i.setAttribute("collapsible",e.collapsible?"true":"false"),i.setAttribute("collapsed",e.collapsed?"true":"false"),e.collapsible&&(i.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),i.setAttribute("hide-menu-label",e.hideMenuLabel));for(let b=0;b<3;b++){const c=document.createElement("ifx-sidebar-item");c.textContent=`Header Section ${b+1}`;for(let m=0;m<3;m++){const d=document.createElement("ifx-sidebar-item");if(d.setAttribute("icon",e.icon?"image-16":""),d.textContent=`Menu Item ${m+1}`,m===0)for(let f=0;f<3;f++){const u=document.createElement("ifx-sidebar-item");u.textContent=`Sub Menu Item ${f+1}`,d.appendChild(u)}c.appendChild(d)}i.appendChild(c)}const l=i.querySelectorAll("ifx-sidebar-item")[0].querySelectorAll("ifx-sidebar-item")[0];return l.querySelectorAll("ifx-sidebar-item")[0].setAttribute("active","true"),l.querySelectorAll("ifx-sidebar-item")[0].setAttribute("is-action-item","false"),l.querySelectorAll("ifx-sidebar-item")[1].setAttribute("is-action-item","true"),l.querySelectorAll("ifx-sidebar-item")[2].setAttribute("is-action-item","true"),i},s=S.bind({}),I=e=>{const i=document.createElement("ifx-sidebar");return i.setAttribute("application-name",e.applicationName||"Application name"),i.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),i.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),i.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),i.setAttribute("collapsible",e.collapsible?"true":"false"),i.setAttribute("collapsed",e.collapsed?"true":"false"),e.collapsible&&(i.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),i.setAttribute("hide-menu-label",e.hideMenuLabel)),i.setAttribute("show-header",e.showHeader),i.setAttribute("show-footer",e.showFooter),i.setAttribute("initial-collapse",e.initialCollapse),i.setAttribute("terms-of-use",e.termsOfUse),i.setAttribute("imprint",e.imprint),i.setAttribute("privacy-policy",e.privacyPolicy),i.setAttribute("copyright-text",e.copyrightText),i.setAttribute("position",e.position),i.innerHTML=`
  ...
  \`;
  return sidebarElement;
}`,...r.parameters?.docs?.source}}};const y=["Default","WithSubmenu","WithNumberIndicator","Collapsible","CollapsibleStartsCollapsed"],v=Object.freeze(Object.defineProperty({__proto__:null,Collapsible:a,CollapsibleStartsCollapsed:r,Default:n,WithNumberIndicator:o,WithSubmenu:s,__namedExportsOrder:y,default:g},Symbol.toStringTag,{value:"Module"}));export{n as D,v as S,s as W,o as a};
