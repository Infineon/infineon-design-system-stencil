import{b as r}from"./iframe-B_DHzPLT.js";import"./preload-helper-PPVm8Dsz.js";const{action:o}=__STORYBOOK_MODULE_ACTIONS__,{useArgs:s}=__STORYBOOK_MODULE_PREVIEW_API__,c={title:"Components/Counter",tags:["autodocs"],args:{value:0},argTypes:{value:{description:"Initial value of the counter.",table:{category:"IFX-Counter-Unit Props"},control:{type:"number",min:0}},ifxChange:{description:"Custom event emitted when the counter value changes.",action:"ifxChange",table:{category:"custom events",type:{summary:"Framework integration",detail:`React: onIfxChange={handleChange}
