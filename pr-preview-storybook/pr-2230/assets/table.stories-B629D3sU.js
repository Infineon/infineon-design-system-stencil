...
</ifx-table>`;{const r=e.cols.map(n=>{const S=[...new Set(e.rows.map(h=>h[n.field]))].map((h,x)=>t`<ifx-list-entry slot="slot${x}" label="${h}" value="false"></ifx-list-entry>`);return t`
...
`),O=e.filterOrientation==="sidebar"?t`<ifx-filter-type-group slot="sidebar-filter">
    ...
    filter-orientation="${e.filterOrientation}">
    ${O}
</ifx-table>`}},a=$.bind({});a.args={pagination:!1,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}]',rowHeight:"default",enableSelection:!1,cols:b,rows:m,filterOrientation:"none"};const o=$.bind({});o.args={pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}]',rowHeight:"default",cols:b,rows:m,filterOrientation:"none"};const l=$.bind({});l.args={pagination:!0,serverSidePagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}]',rowHeight:"default",cols:b,rows:m,filterOrientation:"none"};const k=e=>t`
    <ifx-table
      row-height="${e.rowHeight}"
      .cols='${JSON.stringify(e.cols)}'
      .rows='${JSON.stringify(e.rows)}'
    ...
    <ifx-table
      ...
      <ifx-button slot="inner-button">Button</ifx-button>
    </ifx-table>`,s=k.bind({});s.args={rowHeight:"default",cols:C,rows:H,filterOrientation:"none",pagination:!1};const f=W.bind({});f.args={rowHeight:"default",cols:w,rows:J,filterOrientation:"none",pagination:!1};const c=q.bind({});c.args={rowHeight:"default",cols:I,rows:P,filterOrientation:"none",pagination:!1};const d=T.bind({});d.args={rowHeight:"default",cols:w,rows:N,filterOrientation:"none",pagination:!1};const u=B.bind({});u.args={rowHeight:"default",cols:w,rows:m,filterOrientation:"topbar",pagination:!1};const p=$.bind({});p.args={rowHeight:"default",cols:b,rows:m,filterOrientation:"sidebar"};const g=$.bind({});g.args={headline:"Matching results",rowHeight:"default",cols:b,rows:m,filterOrientation:"topbar"};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`(args: any) => {
...
}`,...a.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`(args: any) => {
  if (args.filterOrientation === 'none') {
    const table = html\`<ifx-table
    row-height="\${args.rowHeight}"
    cols='\${JSON.stringify(args.cols)}'
  ...
  return table;
}`,...c.parameters?.docs?.source}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`(args: any) => {
  const table = html\`
    <ifx-table
      row-height="\${args.rowHeight}"
      .cols='\${JSON.stringify(args.cols)}'
  ...
  return table;
}`,...d.parameters?.docs?.source}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`(args: any) => {
  const table = html\`
    <ifx-table
      row-height="\${args.rowHeight}"
      .cols='\${JSON.stringify(args.cols)}'
...
}`,...g.parameters?.docs?.source}}};const A=["DefaultState","Pagination","ServerSidePagination","IncludesButtons","IncludesStatus","IncludesLink","IncludesBreakingline","IncludesInnerButtons","SidebarFilter","TopbarFilter"],_=Object.freeze(Object.defineProperty({__proto__:null,DefaultState:a,IncludesBreakingline:d,IncludesButtons:s,IncludesInnerButtons:u,IncludesLink:c,IncludesStatus:f,Pagination:o,ServerSidePagination:l,SidebarFilter:p,TopbarFilter:g,__namedExportsOrder:A,default:V},Symbol.toStringTag,{value:"Module"}));export{a as D,s as I,o as P,l as S,_ as T,u as a,p as b,g as c};
