...
Event Detail: { collapsed: boolean }`}}},ifxSidebarLogoClick:{action:"ifxSidebarLogoClick",description:"Custom event emitted when the sidebar logo image is clicked.",table:{category:"custom events",type:{summary:"Framework integration",detail:`
  ...
  \`;
  return sidebarElement;
}`,...n.parameters?.docs?.source}}};const y=["Default","WithSubmenu","WithNumberIndicator","Collapsible","CollapsibleStartsCollapsed"],v=Object.freeze(Object.defineProperty({__proto__:null,Collapsible:a,CollapsibleStartsCollapsed:n,Default:r,WithNumberIndicator:o,WithSubmenu:s,__namedExportsOrder:y,default:g},Symbol.toStringTag,{value:"Module"}));export{r as D,v as S,s as W,o as a};
