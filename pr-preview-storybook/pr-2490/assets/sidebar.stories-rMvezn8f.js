...
Event Detail: { collapsed: boolean }`}}},ifxSidebarLogoClick:{action:"ifxSidebarLogoClick",description:"Custom event emitted when the sidebar logo image is clicked.",table:{category:"custom events",type:{summary:"Framework integration",detail:`
  ...
  `,i},r=S.bind({}),I=e=>{const i=document.createElement("ifx-sidebar");i.setAttribute("application-name",e.applicationName),i.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),i.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),i.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),i.setAttribute("initial-collapse",e.initialCollapse),i.setAttribute("position",e.position),i.setAttribute("collapsible",e.collapsible?"true":"false"),i.setAttribute("collapsed",e.collapsed?"true":"false"),e.collapsible&&(i.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),i.setAttribute("hide-menu-label",e.hideMenuLabel));for(let f=0;f<3;f++){const c=document.createElement("ifx-sidebar-item");c.textContent=`Header Section ${f+1}`;for(let l=0;l<3;l++){const b=document.createElement("ifx-sidebar-item");if(b.setAttribute("icon",e.icon?"image-16":""),b.textContent=`Menu Item ${l+1}`,l===0)for(let u=0;u<3;u++){const g=document.createElement("ifx-sidebar-item");g.textContent=`Sub Menu Item ${u+1}`,b.appendChild(g)}c.appendChild(b)}i.appendChild(c)}const d=i.querySelectorAll("ifx-sidebar-item")[0].querySelectorAll("ifx-sidebar-item")[0];return d.querySelectorAll("ifx-sidebar-item")[0].setAttribute("active","true"),d.querySelectorAll("ifx-sidebar-item")[0].setAttribute("is-action-item","false"),d.querySelectorAll("ifx-sidebar-item")[1].setAttribute("is-action-item","true"),d.querySelectorAll("ifx-sidebar-item")[2].setAttribute("is-action-item","true"),i},o=I.bind({}),y=e=>{const i=document.createElement("ifx-sidebar");return i.setAttribute("application-name",e.applicationName||"Application name"),i.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),i.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),i.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),i.setAttribute("collapsible",e.collapsible?"true":"false"),i.setAttribute("collapsed",e.collapsed?"true":"false"),e.collapsible&&(i.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),i.setAttribute("hide-menu-label",e.hideMenuLabel)),i.setAttribute("show-header",e.showHeader),i.setAttribute("show-footer",e.showFooter),i.setAttribute("initial-collapse",e.initialCollapse),i.setAttribute("terms-of-use",e.termsOfUse),i.setAttribute("imprint",e.imprint),i.setAttribute("privacy-policy",e.privacyPolicy),i.setAttribute("copyright-text",e.copyrightText),i.setAttribute("position",e.position),i.innerHTML=`
  ...
  `,i},a=x.bind({});a.storyName="With Hide Menu";a.args={collapsible:!0,collapsed:!1,hideMenuLabel:"Hide Menu"};const n=x.bind({});n.storyName="With Hide Menu (starts collapsed)";n.args={collapsible:!0,collapsed:!0,hideMenuLabel:"Hide Menu"};const E=e=>{const i=document.createElement("ifx-sidebar");return i.setAttribute("application-name",e.applicationName),i.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),i.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),i.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),i.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),i.setAttribute("show-header",e.showHeader),i.setAttribute("show-footer",e.showFooter),i.setAttribute("initial-collapse",e.initialCollapse),i.setAttribute("terms-of-use",e.termsOfUse),i.setAttribute("imprint",e.imprint),i.setAttribute("privacy-policy",e.privacyPolicy),i.setAttribute("copyright-text",e.copyrightText),i.setAttribute("position",e.position),i.setAttribute("fixed",e.fixed?"true":"false"),i.setAttribute("logo-href",e.logoHref),i.setAttribute("logo-href-target",e.logoHrefTarget),i.setAttribute("footer-target",e.footerHrefTarget),i.innerHTML=`
    <ifx-sidebar-title>Menu Items</ifx-sidebar-title>
    <ifx-sidebar-item font-weight="${e.fontWeight}" href='https://google.com' target='_blank' icon="${e.icon==="none"?"":e.icon}">Menu Item</ifx-sidebar-item>
    <ifx-sidebar-item font-weight="${e.fontWeight}" href='https://google.com' target='_blank' icon="${e.icon==="none"?"":e.icon}">Menu Item</ifx-sidebar-item>
    <ifx-sidebar-item font-weight="${e.fontWeight}" href='https://google.com' target='_blank' icon="${e.icon==="none"?"":e.icon}">Menu Item</ifx-sidebar-item>
    ...
    <ifx-sidebar-item font-weight="${e.fontWeight}" href='https://google.com' target='_blank' icon="${e.icon==="none"?"":e.icon}">Item 2</ifx-sidebar-item>
    <ifx-sidebar-separator></ifx-sidebar-separator>
  `,i},m=E.bind({}),A=["Default","WithSubmenu","WithNumberIndicator","Collapsible","CollapsibleStartsCollapsed","Separator"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return sidebarElement;
}`,...o.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`(args: any) => {
  const sidebarElement = document.createElement("ifx-sidebar") as HTMLIfxSidebarElement;
  ...
  \`;
  return sidebarElement;
}`,...s.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`(args: any) => {
  const sidebarElement = document.createElement("ifx-sidebar") as HTMLIfxSidebarElement;
  sidebarElement.setAttribute("application-name", args.applicationName);
  sidebarElement.addEventListener("ifxSidebarNavigationItem", action(\`ifxSidebarNavigationItem\`));
  sidebarElement.addEventListener("ifxSidebarActionItem", action(\`ifxSidebarActionItem\`));
  ...
  \`;
  return sidebarElement;
}`,...n.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`(args: any) => {
  const sidebarElement = document.createElement("ifx-sidebar") as HTMLIfxSidebarElement;
  sidebarElement.setAttribute("application-name", args.applicationName);
  sidebarElement.addEventListener("ifxSidebarNavigationItem", action(\`ifxSidebarNavigationItem\`));
  sidebarElement.addEventListener("ifxSidebarActionItem", action(\`ifxSidebarActionItem\`));
  ...
  \`;
  return sidebarElement;
}`,...m.parameters?.docs?.source}}};const w=Object.freeze(Object.defineProperty({__proto__:null,Collapsible:a,CollapsibleStartsCollapsed:n,Default:r,Separator:m,WithNumberIndicator:s,WithSubmenu:o,__namedExportsOrder:A,default:h},Symbol.toStringTag,{value:"Module"}));export{r as D,w as S,o as W,s as a,m as b};
