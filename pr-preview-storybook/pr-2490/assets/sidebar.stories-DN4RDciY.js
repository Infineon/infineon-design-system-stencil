...
Event Detail: { collapsed: boolean }`}}},ifxSidebarLogoClick:{action:"ifxSidebarLogoClick",description:"Custom event emitted when the sidebar logo image is clicked.",table:{category:"custom events",type:{summary:"Framework integration",detail:`
    ...
    Section
    <ifx-sidebar-item font-weight="${e.fontWeight}" href='https://google.com' target='_blank' icon="${e.icon==="none"?"":e.icon}">Menu Item</ifx-sidebar-item>
    <ifx-sidebar-item font-weight="${e.fontWeight}" icon='image-16'>
    Menu Item
    <ifx-sidebar-item font-weight="${e.fontWeight}">Sub menu item</ifx-sidebar-item>
    <ifx-sidebar-item font-weight="${e.fontWeight}" active=true>Sub menu item</ifx-sidebar-item>
    <ifx-sidebar-item font-weight="${e.fontWeight}">Sub menu item</ifx-sidebar-item>
    </ifx-sidebar-item>
    <ifx-sidebar-item font-weight="${e.fontWeight}" href='https://google.com' target='_blank'>Menu Item</ifx-sidebar-item>
    <ifx-sidebar-item font-weight="${e.fontWeight}" href='https://google.com' target='_blank'>Menu Item</ifx-sidebar-item>
    </ifx-sidebar-item>
    <ifx-sidebar-title>Items group</ifx-sidebar-title>
    <ifx-sidebar-item font-weight="${e.fontWeight}" href="${e.hrefOfSidebarItem}" target="${e.targetOfSidebarItem}" icon="${e.icon==="none"?"":e.icon}" number-indicator="${e.numberIndicatorOfSidebarItem===""?"":e.numberIndicatorOfSidebarItem}" isActionItem="${e.isActionItem}" active="${e.activeSidebarItem}">Item 1</ifx-sidebar-item>
    <ifx-sidebar-item font-weight="${e.fontWeight}" href='https://google.com' target='_blank' icon="${e.icon==="none"?"":e.icon}">Item 2</ifx-sidebar-item>
  `,i},r=h.bind({}),S=e=>{const i=document.createElement("ifx-sidebar");i.setAttribute("application-name",e.applicationName),i.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),i.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),i.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),i.setAttribute("initial-collapse",e.initialCollapse),i.setAttribute("position",e.position),i.setAttribute("collapsible",e.collapsible?"true":"false"),i.setAttribute("collapsed",e.collapsed?"true":"false"),e.collapsible&&(i.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),i.setAttribute("hide-menu-label",e.hideMenuLabel));for(let b=0;b<3;b++){const f=document.createElement("ifx-sidebar-item");f.textContent=`Header Section ${b+1}`;for(let m=0;m<3;m++){const d=document.createElement("ifx-sidebar-item");if(d.setAttribute("icon",e.icon?"image-16":""),d.textContent=`Menu Item ${m+1}`,m===0)for(let c=0;c<3;c++){const u=document.createElement("ifx-sidebar-item");u.textContent=`Sub Menu Item ${c+1}`,d.appendChild(u)}f.appendChild(d)}i.appendChild(f)}const l=i.querySelectorAll("ifx-sidebar-item")[0].querySelectorAll("ifx-sidebar-item")[0];return l.querySelectorAll("ifx-sidebar-item")[0].setAttribute("active","true"),l.querySelectorAll("ifx-sidebar-item")[0].setAttribute("is-action-item","false"),l.querySelectorAll("ifx-sidebar-item")[1].setAttribute("is-action-item","true"),l.querySelectorAll("ifx-sidebar-item")[2].setAttribute("is-action-item","true"),i},s=S.bind({}),y=e=>{const i=document.createElement("ifx-sidebar");return i.setAttribute("application-name",e.applicationName||"Application name"),i.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),i.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),i.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),i.setAttribute("collapsible",e.collapsible?"true":"false"),i.setAttribute("collapsed",e.collapsed?"true":"false"),e.collapsible&&(i.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),i.setAttribute("hide-menu-label",e.hideMenuLabel)),i.setAttribute("show-header",e.showHeader),i.setAttribute("show-footer",e.showFooter),i.setAttribute("initial-collapse",e.initialCollapse),i.setAttribute("terms-of-use",e.termsOfUse),i.setAttribute("imprint",e.imprint),i.setAttribute("privacy-policy",e.privacyPolicy),i.setAttribute("copyright-text",e.copyrightText),i.setAttribute("position",e.position),i.innerHTML=`
  ...
  `,i},a=p.bind({});a.storyName="With Hide Menu";a.args={collapsible:!0,collapsed:!1,hideMenuLabel:"Hide Menu"};const n=p.bind({});n.storyName="With Hide Menu (starts collapsed)";n.args={collapsible:!0,collapsed:!0,hideMenuLabel:"Hide Menu"};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
...
}`,...r.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`(args: any) => {
  const sidebarElement = document.createElement("ifx-sidebar") as HTMLIfxSidebarElement;
  sidebarElement.setAttribute("application-name", args.applicationName);
  sidebarElement.addEventListener("ifxSidebarNavigationItem", action("ifxSidebarNavigationItem"));
  sidebarElement.addEventListener("ifxSidebarActionItem", action("ifxSidebarActionItem"));
  ...
  \`;
  return sidebarElement;
}`,...n.parameters?.docs?.source}}};const I=["Default","WithSubmenu","WithNumberIndicator","Collapsible","CollapsibleStartsCollapsed"],v=Object.freeze(Object.defineProperty({__proto__:null,Collapsible:a,CollapsibleStartsCollapsed:n,Default:r,WithNumberIndicator:o,WithSubmenu:s,__namedExportsOrder:I,default:g},Symbol.toStringTag,{value:"Module"}));export{r as D,v as S,s as W,o as a};
