...
VanillaJs:.addEventListener("ifxInput", (event) => {//handle input});`}}},clearSelection:{description:"Public method for clearing the selected options",table:{category:"ifx-select public methods"}}}},s=e=>{const l=o`<ifx-select 
  size='${e.size}'
 ...
 </ifx-select>`;return setTimeout(()=>{document.querySelector("ifx-select")?.addEventListener("ifxSelect",a("ifxSelect")),document.querySelector("ifx-select")?.addEventListener("ifxInput",a("ifxInput"))},0),l},t=s.bind({});t.args={options:r};const i=["Default"];t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return template;
}`,...t.parameters?.docs?.source}}};const d=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:i,default:n},Symbol.toStringTag,{value:"Module"}));export{t as D,d as S};
