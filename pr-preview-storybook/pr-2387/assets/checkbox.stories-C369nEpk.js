...
VanillaJs:.addEventListener("ifxError", (event) => {//handle error});`}}}}},x=({error:n,disabled:o,readOnly:c,checked:s,indeterminate:i,size:l,label:d,name:h})=>{const e=document.createElement("ifx-checkbox");return e.setAttribute("error",n),e.setAttribute("disabled",o),e.setAttribute("read-only",c),e.setAttribute("checked",s),e.setAttribute("size",l),e.setAttribute("indeterminate",i),e.setAttribute("name",h),e.addEventListener("ifxChange",r=>{a("ifxChange")(r.detail)}),e.addEventListener("ifxError",r=>{a("ifxError")(r.detail)}),e.innerHTML=`${d}`,e},t=x.bind({});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`({
  error,
  disabled,
  readOnly,
  checked,
