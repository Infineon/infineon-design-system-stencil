import{b as n}from"./iframe-BzglkqXW.js";const{action:t}=__STORYBOOK_MODULE_ACTIONS__,$=[{headerName:"ID",field:"id",sortable:!0,sort:"desc",unSortIcon:!0},{headerName:"Item",field:"item",sortable:!0,unSortIcon:!0},{headerName:"Price",field:"price"},{headerName:"Date",field:"date"}],m=[{id:"1",item:"Item 1",price:356,date:"2025-06-25"},{id:"2",item:"Item 2",price:55,date:"2025-03-26"},{id:"3",item:"Item 3",price:24},{id:"4",item:"x",price:874},{id:"5",item:"x",price:689},{id:"6",item:"x",price:46},{id:"7",item:"Item 7",price:421},{id:"8",item:"Item 8",price:17},{id:"9",item:"x",price:752},{id:"10",item:"Item 10",price:73},{id:"11",item:"x",price:94}],I=[{id:1,item:`Item 1
 ...
 Item 11.2`,price:94}],N=[{headerName:"ID",field:"id",sortable:!0,sort:"desc",unSortIcon:!0},{headerName:"Item",field:"item",sortable:!0,unSortIcon:!0},{headerName:"Price",field:"price"},{headerName:"Date",field:"date"},{headerName:"",field:"button"}],w=[{headerName:"ID",field:"id",sortable:!0,sort:"desc",unSortIcon:!0},{headerName:"Item",field:"item",sortable:!0,unSortIcon:!0},{headerName:"Price",field:"price"},{headerName:"Date",field:"date"},{headerName:"Status",field:"status"}],P=[{headerName:"ID",field:"id",sortable:!0,sort:"desc",unSortIcon:!0},{headerName:"Item",field:"item",sortable:!0,unSortIcon:!0},{headerName:"Price",field:"price"},{headerName:"Date",field:"date"},{headerName:"Link",field:"link"}],H=[{id:1,item:"Item 1",price:356,date:"2025-06-25",button:{disabled:!1,variant:"secondary",size:"s",target:"_blank",href:"https://www.w3schools.com/",theme:"default",type:"button",fullWidth:!0,text:"Button"}},{id:2,item:"Item 2",price:55,date:"2025-03-26",button:{disabled:!1,variant:"secondary",size:"s",target:"_blank",href:"https://www.w3schools.com/",theme:"default",type:"button",fullWidth:!0,text:"Button"}},{id:3,item:"Item 3",price:24,button:{disabled:!1,variant:"secondary",size:"s",target:"_blank",href:"https://www.w3schools.com/",theme:"default",type:"button",fullWidth:!0,text:"Button"}}],J=[{id:1,item:"Item 1",price:356,date:"2025-06-25",status:{label:"Available",color:"green-500",border:!0}},{id:2,item:"Item 2",price:55,date:"2025-03-26",status:{label:"Out of Stock",color:"red-500",border:!0}},{id:3,item:"Item 3",price:24,status:{label:"Coming Soon",color:"orange-500",border:!0}}],V=[{id:1,item:"Item 1",price:356,date:"2025-06-25",link:{disabled:!1,variant:"bold",size:"s",target:"_blank",href:"https://www.google.com/",text:"Link"}},{id:2,item:"Item 2",price:55,date:"2025-03-26",link:{disabled:!1,variant:"underlined",size:"s",target:"_blank",href:"https://www.yahoo.com/",text:"Link"}},{id:3,item:"Item 3",price:24,link:{disabled:!1,variant:"title",size:"s",target:"_blank",href:"https://www.bing.com/",text:"Link"}}],k={title:"Components/Table (advanced)",args:{tableHeight:"auto",pagination:!0,serverSidePagination:!1,rowHeight:40,showLoading:!1,variant:"default",headline:"Matching results",headlineNumber:0,enableSelection:!1,fitColumns:!1,columnMinWidth:200,columnWidth:100},argTypes:{tableHeight:{description:"Set the height of the table.",table:{category:"ifx-table props",type:{summary:"Options",detail:`Default: "auto"
...
VanillaJs:.addEventListener("ifxIfxSortChange", (event) => {//handle input});`}}},showMoreFilters:{description:"Public method that toggles the Topbar Filters. Accepts true or false as arguments. Accessible from the ifx-filter-bar component",table:{category:"ifx-table public methods"}}}},x=e=>{if(e.filterOrientation==="none")return n`<ifx-table
    @ifxSortChange=${t("ifxSortChange")}
    @ifxSelectionChange=${t("ifxSelectionChange")}
...
</ifx-table>`;{const r=e.cols.map(i=>{const C=[...new Set(e.rows.map(b=>b[i.field]))].map((b,S)=>n`<ifx-list-entry slot="slot${S}" label="${b}" value="false"></ifx-list-entry>`);return n`
      <ifx-filter-accordion slot="filter-accordion" filter-group-name="${i.field}">
        <ifx-list slot="list" type="checkbox" name="${i.field}" max-visible-items="6">
          ${C}
        </ifx-list>
      </ifx-filter-accordion>
    `}),v=e.cols.map((i,y)=>{const b=[...new Set(e.rows.map(a=>a[i.field]))].filter(a=>a!=null&&a!=="").map(a=>({value:a,label:a,selected:!1})),S=JSON.stringify(b);return n`
        <ifx-set-filter slot="filter-component-${y+1}"
            options='${S}'
            filter-label='${i.headerName}'
            filter-name='${i.field}'
            type='multi-select'
            placeholder='Select ${i.headerName}'>
          </ifx-set-filter>
          `}),O=e.filterOrientation==="sidebar"?n`<ifx-filter-type-group slot="sidebar-filter">
        <div slot="filter-search">
          <ifx-filter-search filter-orientation="sidebar" filter-name="search"></ifx-filter-search>
        </div>
        ${r}
    </ifx-filter-type-group>`:n`<ifx-filter-bar slot="topbar-filter" max-shown-filters="3">
        <ifx-filter-search slot="filter-search" filter-orientation="topbar"></ifx-filter-search>
        ${v}
   </ifx-filter-bar>`;return n`<ifx-table
    @ifxSortChange=${t("ifxSortChange")}
    @ifxSelectionChange=${t("ifxSelectionChange")}
    headline="${e.headline}"
    row-height="${e.rowHeight}"
    ...
    filter-orientation="${e.filterOrientation}">
    ${O}
</ifx-table>`}},o=x.bind({});o.args={pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",enableSelection:!1,cols:$,rows:m,filterOrientation:"none"};const l=x.bind({});l.args={pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",cols:$,rows:m,filterOrientation:"none"};const s=x.bind({});s.args={pagination:!0,serverSidePagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]',rowHeight:"default",cols:$,rows:m,filterOrientation:"none"};const T=e=>n`
    <ifx-table
      @ifxSortChange=${t("ifxSortChange")}
      @ifxSelectionChange=${t("ifxSelectionChange")}
      row-height="${e.rowHeight}"
    ...
    </ifx-table>`,f=T.bind({});f.args={rowHeight:"default",cols:N,rows:H,filterOrientation:"none",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const c=W.bind({});c.args={rowHeight:"default",cols:w,rows:J,filterOrientation:"none",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const g=q.bind({});g.args={rowHeight:"default",cols:P,rows:V,filterOrientation:"none",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const p=B.bind({});p.args={rowHeight:"default",cols:w,rows:I,filterOrientation:"none",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const u=A.bind({});u.args={headline:"Matching results",rowHeight:"default",cols:w,rows:m,filterOrientation:"topbar",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const d=x.bind({});d.args={rowHeight:"default",cols:$,rows:m,filterOrientation:"sidebar",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};const h=x.bind({});h.args={headline:"Matching results",rowHeight:"default",cols:$,rows:m,filterOrientation:"topbar",pagination:!0,paginationItemsPerPage:'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}, {"value":"all","selected":false}]'};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`(args: any) => {
...
}`,...d.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`(args: any) => {
  if (args.filterOrientation === 'none') {
    const table = html\`<ifx-table
    @ifxSortChange=\${action("ifxSortChange")}
    @ifxSelectionChange=\${action("ifxSelectionChange")}
...
}`,...h.parameters?.docs?.source}}};const _=["DefaultState","Pagination","ServerSidePagination","IncludesButtons","IncludesStatus","IncludesLink","IncludesBreakingline","IncludesInnerButtons","SidebarFilter","TopbarFilter"],D=Object.freeze(Object.defineProperty({__proto__:null,DefaultState:o,IncludesBreakingline:p,IncludesButtons:f,IncludesInnerButtons:u,IncludesLink:g,IncludesStatus:c,Pagination:l,ServerSidePagination:s,SidebarFilter:d,TopbarFilter:h,__namedExportsOrder:_,default:k},Symbol.toStringTag,{value:"Module"}));export{o as D,f as I,l as P,s as S,D as T,u as a,d as b,h as c};
