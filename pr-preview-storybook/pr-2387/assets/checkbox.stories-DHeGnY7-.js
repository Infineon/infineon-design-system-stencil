...
VanillaJs:.addEventListener("ifxError", (event) => {//handle error});`}}}}},x=({error:a,disabled:o,readOnly:c,checked:s,indeterminate:i,size:l,label:d,name:h})=>{const e=document.createElement("ifx-checkbox");return e.setAttribute("disabled",o),e.setAttribute("read-only",c),e.setAttribute("checked",s),e.setAttribute("size",l),e.setAttribute("indeterminate",i),e.setAttribute("name",h),e.addEventListener("ifxChange",r=>{n("ifxChange")(r.detail)}),e.addEventListener("ifxError",r=>{n("ifxError")(r.detail)}),e.innerHTML=`${d}`,e.componentOnReady?.().then(()=>{e.error=a}),e},t=x.bind({});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`({
  error,
  disabled,
  readOnly,
  checked,
  ...
  return checkbox;
}`,...t.parameters?.docs?.source}}};const m=["Default"],f=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:m,default:b},Symbol.toStringTag,{value:"Module"}));export{f as C};
