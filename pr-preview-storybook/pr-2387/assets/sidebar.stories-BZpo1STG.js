...
Event Detail: { collapsed: boolean }`}}},ifxSidebarLogoClick:{action:"ifxSidebarLogoClick",description:"Custom event emitted when the sidebar logo image is clicked.",table:{category:"custom events",type:{summary:"Framework integration",detail:`
                        ...
                        Event Detail: { collapsed: boolean }`}}},logoHref:{control:{type:"text"},description:"The URL of the logo link.",table:{category:"ifx-sidebar props"}},logoHrefTarget:{description:"The target of the logo link.",options:["_self","_blank","_parent"],control:{type:"radio"},table:{defaultValue:{summary:"_self"},category:"ifx-sidebar props",type:{summary:"_self | _blank | _parent"}}},footerHrefTarget:{description:"The target attribute for the footer links.",options:["_self","_blank","_parent"],control:{type:"radio"},if:{arg:"showFooter",eq:!0},table:{category:"ifx-sidebar props",defaultValue:{summary:"_blank"},type:{summary:"_self | _blank | _parent"}}}}},h=i=>{const e=document.createElement("ifx-sidebar");return e.setAttribute("application-name",i.applicationName),e.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),e.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),e.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),e.addEventListener("ifxSidebarLogoClick",t("ifxSidebarLogoClick")),e.setAttribute("collapsible",i.collapsible?"true":"false"),e.setAttribute("collapsed",i.collapsed?"true":"false"),i.collapsible&&(e.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),e.setAttribute("hide-menu-label",i.hideMenuLabel)),e.setAttribute("show-header",i.showHeader),e.setAttribute("show-footer",i.showFooter),e.setAttribute("initial-collapse",i.initialCollapse),e.setAttribute("terms-of-use",i.termsOfUse),e.setAttribute("imprint",i.imprint),e.setAttribute("privacy-policy",i.privacyPolicy),e.setAttribute("copyright-text",i.copyrightText),e.setAttribute("position",i.position),e.setAttribute("logo-href",i.logoHref),e.setAttribute("logo-href-target",i.logoHrefTarget),e.setAttribute("footer-target",i.footerHrefTarget),e.innerHTML=`
    <ifx-sidebar-title>Menu Items</ifx-sidebar-title>
    <ifx-sidebar-item href='https://google.com' target='_blank' icon="${i.icon==="none"?"":i.icon}">Menu Item</ifx-sidebar-item>
    <ifx-sidebar-item href='https://google.com' target='_blank' icon="${i.icon==="none"?"":i.icon}">Menu Item</ifx-sidebar-item>
    <ifx-sidebar-item href='https://google.com' target='_blank' icon="${i.icon==="none"?"":i.icon}">Menu Item</ifx-sidebar-item>
    <ifx-sidebar-item href='https://google.com' target='_blank' icon="${i.icon==="none"?"":i.icon}">Menu Item</ifx-sidebar-item>
    <ifx-sidebar-item>
    ...
    <ifx-sidebar-item href="${i.hrefOfSidebarItem}" target="${i.targetOfSidebarItem}" icon="${i.icon==="none"?"":i.icon}" number-indicator="${i.numberIndicatorOfSidebarItem===""?"":i.numberIndicatorOfSidebarItem}" isActionItem="${i.isActionItem}" active="${i.activeSidebarItem}">Item 1</ifx-sidebar-item>
    <ifx-sidebar-item href='https://google.com' target='_blank' icon="${i.icon==="none"?"":i.icon}">Item 2</ifx-sidebar-item>
  `,e},n=h.bind({}),S=i=>{const e=document.createElement("ifx-sidebar");e.setAttribute("application-name",i.applicationName),e.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),e.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),e.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),e.addEventListener("ifxSidebarLogoClick",t("ifxSidebarLogoClick")),e.setAttribute("initial-collapse",i.initialCollapse),e.setAttribute("position",i.position),e.setAttribute("collapsible",i.collapsible?"true":"false"),e.setAttribute("collapsed",i.collapsed?"true":"false"),i.collapsible&&(e.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),e.setAttribute("hide-menu-label",i.hideMenuLabel));for(let b=0;b<3;b++){const c=document.createElement("ifx-sidebar-item");c.textContent=`Header Section ${b+1}`;for(let d=0;d<3;d++){const m=document.createElement("ifx-sidebar-item");if(m.setAttribute("icon",i.icon?"image-16":""),m.textContent=`Menu Item ${d+1}`,d===0)for(let f=0;f<3;f++){const u=document.createElement("ifx-sidebar-item");u.textContent=`Sub Menu Item ${f+1}`,m.appendChild(u)}c.appendChild(m)}e.appendChild(c)}const l=e.querySelectorAll("ifx-sidebar-item")[0].querySelectorAll("ifx-sidebar-item")[0];return l.querySelectorAll("ifx-sidebar-item")[0].setAttribute("active","true"),l.querySelectorAll("ifx-sidebar-item")[0].setAttribute("is-action-item","false"),l.querySelectorAll("ifx-sidebar-item")[1].setAttribute("is-action-item","true"),l.querySelectorAll("ifx-sidebar-item")[2].setAttribute("is-action-item","true"),e},s=S.bind({}),E=i=>{const e=document.createElement("ifx-sidebar");return e.setAttribute("application-name",i.applicationName||"Application name"),e.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),e.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),e.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),e.addEventListener("ifxSidebarLogoClick",t("ifxSidebarLogoClick")),e.setAttribute("collapsible",i.collapsible?"true":"false"),e.setAttribute("collapsed",i.collapsed?"true":"false"),i.collapsible&&(e.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),e.setAttribute("hide-menu-label",i.hideMenuLabel)),e.setAttribute("show-header",i.showHeader),e.setAttribute("show-footer",i.showFooter),e.setAttribute("initial-collapse",i.initialCollapse),e.setAttribute("terms-of-use",i.termsOfUse),e.setAttribute("imprint",i.imprint),e.setAttribute("privacy-policy",i.privacyPolicy),e.setAttribute("copyright-text",i.copyrightText),e.setAttribute("position",i.position),e.innerHTML=`
  ...
  `,e},o=E.bind({}),p=i=>{const e=document.createElement("ifx-sidebar");return e.setAttribute("application-name",i.applicationName),e.addEventListener("ifxSidebarNavigationItem",t("ifxSidebarNavigationItem")),e.addEventListener("ifxSidebarActionItem",t("ifxSidebarActionItem")),e.addEventListener("ifxSidebarMenu",t("ifxSidebarMenu")),e.addEventListener("ifxSidebarLogoClick",t("ifxSidebarLogoClick")),e.addEventListener("ifxSidebarCollapseChange",t("ifxSidebarCollapseChange")),e.setAttribute("show-header",i.showHeader),e.setAttribute("show-footer",i.showFooter),e.setAttribute("initial-collapse",i.initialCollapse),e.setAttribute("terms-of-use",i.termsOfUse),e.setAttribute("imprint",i.imprint),e.setAttribute("privacy-policy",i.privacyPolicy),e.setAttribute("copyright-text",i.copyrightText),e.setAttribute("position",i.position),e.setAttribute("collapsible",i.collapsible?"true":"false"),e.setAttribute("collapsed",i.collapsed?"true":"false"),i.collapsible&&e.setAttribute("hide-menu-label",i.hideMenuLabel||"Hide Menu"),e.innerHTML=`
  ...
  `,e},a=p.bind({});a.storyName="With Hide Menu";a.args={collapsible:!0,collapsed:!1,hideMenuLabel:"Hide Menu"};const r=p.bind({});r.storyName="With Hide Menu (starts collapsed)";r.args={collapsible:!0,collapsed:!0,hideMenuLabel:"Hide Menu"};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return sidebarElement;
}`,...s.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`(args: any) => {
  const sidebarElement = document.createElement("ifx-sidebar") as HTMLIfxSidebarElement;
  ...
  \`;
  return sidebarElement;
}`,...o.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`(args: any) => {
  const sidebarElement = document.createElement("ifx-sidebar") as HTMLIfxSidebarElement;
  sidebarElement.setAttribute("application-name", args.applicationName);
  sidebarElement.addEventListener("ifxSidebarNavigationItem", action(\`ifxSidebarNavigationItem\`));
  sidebarElement.addEventListener("ifxSidebarActionItem", action(\`ifxSidebarActionItem\`));
  ...
  \`;
  return sidebarElement;
}`,...a.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
  const sidebarElement = document.createElement("ifx-sidebar") as HTMLIfxSidebarElement;
  sidebarElement.setAttribute("application-name", args.applicationName);
  sidebarElement.addEventListener("ifxSidebarNavigationItem", action(\`ifxSidebarNavigationItem\`));
  sidebarElement.addEventListener("ifxSidebarActionItem", action(\`ifxSidebarActionItem\`));
  ...
  \`;
  return sidebarElement;
}`,...r.parameters?.docs?.source}}};const I=["Default","WithSubmenu","WithNumberIndicator","Collapsible","CollapsibleStartsCollapsed"],v=Object.freeze(Object.defineProperty({__proto__:null,Collapsible:a,CollapsibleStartsCollapsed:r,Default:n,WithNumberIndicator:o,WithSubmenu:s,__namedExportsOrder:I,default:g},Symbol.toStringTag,{value:"Module"}));export{n as D,v as S,s as W,o as a};
