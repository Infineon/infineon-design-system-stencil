function o(t){t.innerHTML=`
    ...
    <div class="controls">
      ...
      <ifx-filter-type-group slot="sidebar-filter">
        <div slot="filter-search">
          <ifx-filter-search filter-orientation="sidebar" filter-name="search">
          </ifx-filter-search>
        </div>
        ...
        <ifx-filter-accordion slot="filter-accordion" filter-group-name="id">
          <ifx-list slot="list" type="checkbox" name="id" max-visible-items="6">
            <ifx-list-entry slot="slot0" label="1" value="false"></ifx-list-entry><ifx-list-entry slot="slot1" label="2"
              ...
              value="false"></ifx-list-entry><ifx-list-entry slot="slot10" label="11" value="false">
            </ifx-list-entry>
          </ifx-list>
        ...
        <ifx-filter-accordion slot="filter-accordion" filter-group-name="item">
          <ifx-list slot="list" type="checkbox" name="item" max-visible-items="6">
            <ifx-list-entry slot="slot0" label="Item 1" value="false"></ifx-list-entry><ifx-list-entry slot="slot1"
              ...
              value="false"></ifx-list-entry><ifx-list-entry slot="slot6" label="Item 10" value="false">
            </ifx-list-entry>
          </ifx-list>
        </ifx-filter-accordion>
        ...
        <ifx-filter-accordion slot="filter-accordion" filter-group-name="price">
          <ifx-list slot="list" type="checkbox" name="price" max-visible-items="6">
            <ifx-list-entry slot="slot0" label="356" value="false"></ifx-list-entry><ifx-list-entry slot="slot1" label="55"
              value="false"></ifx-list-entry><ifx-list-entry slot="slot2" label="24"
              ...
              value="false"></ifx-list-entry><ifx-list-entry slot="slot10" label="94" value="false">
            </ifx-list-entry>
          </ifx-list>
        </ifx-filter-accordion>
    ...
    <div class="controls">
      ...
      <ifx-filter-bar slot="topbar-filter" max-shown-filters="3">
        <ifx-filter-search slot="filter-search" filter-orientation="topbar">
        </ifx-filter-search>
  ...
  `;const e=t.querySelector("ifx-table"),i=t.querySelector("#state-pagination"),a=t.querySelector("#state-variant"),l=["default","zebra"];i.textContent=e.pagination,a.textContent=e.variant,t.querySelector("#toggle-pagination").onclick=()=>{e.pagination=!e.pagination,i.textContent=String(e.pagination)},t.querySelector("#toggle-variant").onclick=()=>{const s=(l.indexOf(e.variant)+1)%l.length;e.variant=l[s],a.textContent=e.variant}}export{o as render};
