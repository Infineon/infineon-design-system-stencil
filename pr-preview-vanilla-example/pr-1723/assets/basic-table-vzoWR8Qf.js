function n(e){e.innerHTML=`
  ...
  `;const t=e.querySelector("ifx-basic-table"),a=e.querySelector("#state-variant"),i=["default","zebra"];a.textContent=t.variant,e.querySelector("#toggle-variant").onclick=()=>{const r=(i.indexOf(t.variant)+1)%i.length;t.variant=i[r],a.textContent=t.variant}}export{n as render};
