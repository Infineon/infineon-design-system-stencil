...
</ifx-footer>`,n=f.bind({}),t=a.bind({}),o=k.bind({}),x=["Small","Medium","Large"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`(args: any) => {
  return html\`
...
}`,...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`(args: any) => {
  return html\`
    <ifx-footer copyright-text="\${args.copyrightText}">
    <div slot="socials">
      <ifx-link variant="title" href="http://facebook.com/infineon" aria-label="Follow us on Facebook">
...
}`,...t.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`(args: any) => {
  return html\`
  <ifx-footer copyright-text="\${args.copyrightText}">
  <ifx-footer-column slot="col">
    <h5 slot="title">Title</h5>
...
}`,...o.parameters?.docs?.source}}};const m=Object.freeze(Object.defineProperty({__proto__:null,Large:o,Medium:t,Small:n,__namedExportsOrder:x,default:r},Symbol.toStringTag,{value:"Module"}));export{m as F};
