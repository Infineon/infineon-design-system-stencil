...
>
  ${Array.from({length:e.amountOfChipItems},(u,s)=>{const a=document.createElement("ifx-chip-item");return a.innerHTML=e.chipItemLabel+" "+(s+1),a.setAttribute("value",e.value+" "+(s+1)),e.selected&&s===1&&a.setAttribute("selected","true"),e.readOnly&&(e.variant==="multi"||s===0)&&a.setAttribute("selected","true"),a.outerHTML}).join(`
    `)}
</ifx-chip>`;const o=l.querySelector("ifx-chip");return o.addEventListener("ifxChange",m("ifxChange")),o},r=c.bind({});r.tags=["!dev","!autodocs"];const t=c.bind({});t.args={variant:"single"};t.argTypes={variant:{table:{disable:!0}}};const n=c.bind({});n.args={variant:"multi"};n.argTypes={variant:{table:{disable:!0}}};const i=c.bind({});i.args={readOnly:!0,variant:"multi"};i.argTypes={readOnly:{table:{disable:!0}}};const h=["Default","Single","Multi","ReadOnly"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
...
>
  ...
  return chip;
}`,...r.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`(args: any) => {
  const wrapper = document.createElement("div");
  wrapper.innerHTML = \`
<ifx-chip
placeholder="\${args.placeholder}"
...
>
  ...
  chip.addEventListener("ifxChange", action("ifxChange"));
  return chip;
}`,...i.parameters?.docs?.source}}};const g=Object.freeze(Object.defineProperty({__proto__:null,Default:r,Multi:n,ReadOnly:i,Single:t,__namedExportsOrder:h,default:d},Symbol.toStringTag,{value:"Module"}));export{g as C};
