...
VanillaJs:.addEventListener("ifxChange", (event) => {//handle change});`}}}}},h=({amountOfItems:o,label:a,value:r,icon:c,selected:s})=>{const i=document.createElement("ifx-content-switcher");for(let e=0;e<o;e++){const n=document.createElement("ifx-content-switcher-item");n.setAttribute("value",`${r} ${e+1}`),n.innerHTML=`
    ...
    `,e===1&&s&&n.setAttribute("selected","true"),i.appendChild(n)}return i.addEventListener("ifxChange",m("ifxChange")),i},t=h.bind({}),u=["Default"];t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`({
  amountOfItems,
  label,
  value,
  icon,
  ...
  return element;
}`,...t.parameters?.docs?.source}}};const p=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:u,default:d},Symbol.toStringTag,{value:"Module"}));export{p as C};
