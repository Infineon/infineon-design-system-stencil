...
VanillaJs:.addEventListener("ifxDropdownMenuItem", (event) => {//handle change});`}}}}},a=e=>{const o=e.icon==="none"?"":e.icon,t=document.createElement("div");return t.innerHTML=`<ifx-breadcrumb>
...
</ifx-breadcrumb>`,t.querySelector("ifx-breadcrumb").querySelectorAll("ifx-breadcrumb-item").forEach(n=>{n.querySelector("ifx-dropdown-menu")?.addEventListener("ifxDropdownMenuItem",m("ifxDropdownMenuItem"))}),t},r=a.bind({}),c=["Default"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`(args: any) => {
  ...
  return wrapper;
}`,...r.parameters?.docs?.source}}};const l=Object.freeze(Object.defineProperty({__proto__:null,Default:r,__namedExportsOrder:c,default:d},Symbol.toStringTag,{value:"Module"}));export{l as B};
