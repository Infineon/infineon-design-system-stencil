...
🌐 The [Digital Design System](https://dds-brandportal.infineon.com/) is the single source of truth for building digital experiences at Infineon. Built with [Stencil](https://stenciljs.com/), it delivers framework-agnostic web components.
