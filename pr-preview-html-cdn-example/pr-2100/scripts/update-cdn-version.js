...
if (packageJson.dependencies && packageJson.dependencies['@infineon/infineon-design-system-stencil']) {
  delete packageJson.dependencies['@infineon/infineon-design-system-stencil'];
  console.log('Removed @infineon/infineon-design-system-stencil from dependencies');
...
console.log(`Successfully updated ${packageJsonFile} - removed local development dependency`);