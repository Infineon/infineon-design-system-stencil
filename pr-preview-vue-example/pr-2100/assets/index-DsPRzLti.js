const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ifx-action-list.entry-fj0IN7uq.js","./dom-utils-CtINY9El-CZY0_Num.js","./tracking-DNHOWgWh-BE-DLK5Z.js","./ifx-action-list-item.entry-DEAWRQaj.js","./index-BfTCfPZ1-CrzGNZJJ.js","./ifx-breadcrumb.entry-CvoNKble.js","./ifx-card.entry-3hzAeWnq.js","./ifx-checkbox-group.entry-DrQ1ClST.js","./ifx-content-switcher.entry-DqU_L_-C.js","./ifx-date-picker.entry-Bfk4R50n.js","./ifx-dropdown.entry-BsDMNgr3.js","./popper-BfP9ezJQ-CAMpDiU4.js","./ifx-file-upload.entry-DSxb-wmC.js","./ifx-footer.entry-DtSkjyFI.js","./ifx-icons-preview.entry-BjwCsk0f.js","./icons-CmdmgBUp-DE211srv.js","./ifx-navbar.entry-LCwWxuBA.js","./ifx-radio-button-group.entry-Cz8XkYDa.js","./ifx-search-bar.entry-BjPYYzO8.js","./ifx-segmented-control.entry-C6mi6Fnt.js","./ifx-sidebar.entry-BjhfMzqt.js","./ifx-slider.entry-D6FUezCw.js","./ifx-status.entry-CtFC1Ysw.js","./ifx-stepper.entry-60qXBHW8.js","./ifx-switch.entry-CauWTxXX.js","./ifx-tabs.entry-DzDq5VBn.js","./ifx-textarea.entry-DTASy2K9.js","./ifx-tooltip.entry-BRodzFu0.js","./ifx-tree-view.entry-Dq8Z9Dwb.js","./ifx-notification.entry-D_CDfQxC.js","./ifx-progress-bar.entry-C5PMQwXT.js","./ifx-radio-button.entry-CdKcXq_X.js","./ifx-search-field.entry-CHWzXgoy.js","./ifx-button.entry-BWo8b6HF.js","./ifx-icon-button.entry-DaNhwfGR.js","./ifx-indicator.entry-x45X9y6f.js","./ifx-checkbox.entry-CgUq3fkr.js","./ifx-link.entry-rkkgLEpA.js","./ifx-icon.entry-lLRFJzyu.js","./ifx-select.entry-Bj1Anrc4.js","./ifx-basic-table.entry-135TWMyx.js","./main.esm-ByHlxOiP-Dxp3GBcE.js","./ifx-modal.entry-BJu5AdTF.js","./ifx-accordion_2.entry-a1Qu5oRZ.js","./ifx-alert_2.entry-Corqa3e9.js","./ifx-multiselect_2.entry-BhK290Pt.js","./ifx-spinner_2.entry-BoXGCj7w.js","./ifx-chip_3.entry-DCF62X0l.js","./ifx-table.entry-D9hPtSFo.js"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function i(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=i(r);fetch(r.href,s)}})();const Tl="modulepreload",Fl=function(e,t){return new URL(e,t).href},ur={},R=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){let d=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};const l=document.getElementsByTagName("link"),a=document.querySelector("meta[property=csp-nonce]"),c=a?.nonce||a?.getAttribute("nonce");r=d(i.map(u=>{if(u=Fl(u,n),u in ur)return;ur[u]=!0;const p=u.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(n)for(let k=l.length-1;k>=0;k--){const y=l[k];if(y.href===u&&(!p||y.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${u}"]${h}`))return;const v=document.createElement("link");if(v.rel=p?"stylesheet":Tl,p||(v.as="script"),v.crossOrigin="",v.href=u,c&&v.setAttribute("nonce",c),document.head.appendChild(v),p)return new Promise((k,y)=>{v.addEventListener("load",k),v.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${u}`)))})}))}function s(l){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=l,window.dispatchEvent(a),!a.defaultPrevented)throw l}return r.then(l=>{for(const a of l||[])a.status==="rejected"&&s(a.reason);return t().catch(s)})},Pl="infineon-design-system-stencil",mt={hydratedSelectorName:"hydrated",lazyLoad:!0,propChangeCallback:!0,shadowDom:!0,slotRelocation:!0,state:!0,updatable:!0};function Ol(){}const Rl=Ol,Dl='@font-face{font-family:"Source Sans 3";font-style:normal;font-weight:400;src:url("https://cdn.jsdelivr.net/npm/@infineon/design-system-tokens@5.0.0/dist/fonts/source-sans-3/SourceSans3-Regular.ttf.woff2") format("woff2"), url("https://cdn.jsdelivr.net/npm/@infineon/design-system-tokens@5.0.0/dist/fonts/source-sans-3/SourceSans3-Regular.ttf.woff") format("woff")}@font-face{font-family:"Source Sans 3";font-style:normal;font-weight:600;src:url("https://cdn.jsdelivr.net/npm/@infineon/design-system-tokens@5.0.0/dist/fonts/source-sans-3/SourceSans3-Semibold.ttf.woff2") format("woff2"), url("https://cdn.jsdelivr.net/npm/@infineon/design-system-tokens@5.0.0/dist/fonts/source-sans-3/SourceSans3-Semibold.ttf.woff") format("woff")}@font-face{font-family:"Source Sans 3";font-style:italic;font-weight:400;src:url("https://cdn.jsdelivr.net/npm/@infineon/design-system-tokens@5.0.0/dist/fonts/source-sans-3/SourceSans3-It.ttf.woff2") format("woff2"), url("https://cdn.jsdelivr.net/npm/@infineon/design-system-tokens@5.0.0/dist/fonts/source-sans-3/SourceSans3-It.ttf.woff") format("woff")}:root{--ifx-font-family:"Source Sans 3", "Arial, sans-serif"}ifx-icon:empty{display:none}';var Ml=Object.defineProperty,zl=(e,t)=>{for(var i in t)Ml(e,i,{get:t[i],enumerable:!0})},Hl="http://www.w3.org/2000/svg",ql="http://www.w3.org/1999/xhtml",ls=(e=>(e.Undefined="undefined",e.Null="null",e.String="string",e.Number="number",e.SpecialNumber="number",e.Boolean="boolean",e.BigInt="bigint",e))(ls||{}),as=(e=>(e.Array="array",e.Date="date",e.Map="map",e.Object="object",e.RegularExpression="regexp",e.Set="set",e.Channel="channel",e.Symbol="symbol",e))(as||{}),Ui="type",Wi="value",on="serialized:",Bl=(e,t)=>{var i;const n=t.$cmpMeta$;Object.entries((i=n.$members$)!=null?i:{}).map(([s,[l]])=>{if(l&31||l&32){const a=e[s],c=Nl(Object.getPrototypeOf(e),s)||Object.getOwnPropertyDescriptor(e,s);c&&Object.defineProperty(e,s,{get(){return c.get.call(this)},set(d){c.set.call(this,d)},configurable:!0,enumerable:!0}),e[s]=t.$instanceValues$.has(s)?t.$instanceValues$.get(s):a}})};function Nl(e,t){for(;e;){const i=Object.getOwnPropertyDescriptor(e,t);if(i?.get)return i;e=Object.getPrototypeOf(e)}}var Te=e=>{if(e.__stencil__getHostRef)return e.__stencil__getHostRef()},Ap=(e,t)=>{t&&(e.__stencil__getHostRef=()=>t,t.$lazyInstance$=e,t.$cmpMeta$.$flags$&512&&mt.state&&Bl(e,t))},jl=(e,t)=>{const i={$flags$:0,$hostElement$:e,$cmpMeta$:t,$instanceValues$:new Map,$serializerValues$:new Map};i.$onInstancePromise$=new Promise(r=>i.$onInstanceResolve$=r),i.$onReadyPromise$=new Promise(r=>i.$onReadyResolve$=r),e["s-p"]=[],e["s-rc"]=[],i.$fetchedCbList$=[];const n=i;return e.__stencil__getHostRef=()=>n,n},dr=(e,t)=>t in e,L=(e,t)=>(0,console.error)(e,t),Gi=new Map,Vl=(e,t,i)=>{const n=e.$tagName$.replace(/-/g,"_"),r=e.$lazyBundleId$;if(!r)return;const s=Gi.get(r);if(s)return s[n];{const l=a=>(Gi.set(r,a),a[n]);switch(r){case"ifx-action-list":return R(()=>import("./ifx-action-list.entry-fj0IN7uq.js"),__vite__mapDeps([0,1,2]),import.meta.url).then(l,L);case"ifx-action-list-item":return R(()=>import("./ifx-action-list-item.entry-DEAWRQaj.js"),__vite__mapDeps([3,4]),import.meta.url).then(l,L);case"ifx-breadcrumb":return R(()=>import("./ifx-breadcrumb.entry-CvoNKble.js"),__vite__mapDeps([5,1,2]),import.meta.url).then(l,L);case"ifx-breadcrumb-item":return R(()=>import("./ifx-breadcrumb-item.entry-DX0tm92Y.js"),[],import.meta.url).then(l,L);case"ifx-breadcrumb-item-label":return R(()=>import("./ifx-breadcrumb-item-label.entry-DTzelxQP.js"),[],import.meta.url).then(l,L);case"ifx-card":return R(()=>import("./ifx-card.entry-3hzAeWnq.js"),__vite__mapDeps([6,1,2]),import.meta.url).then(l,L);case"ifx-card-headline":return R(()=>import("./ifx-card-headline.entry-pZuKeUHi.js"),[],import.meta.url).then(l,L);case"ifx-card-image":return R(()=>import("./ifx-card-image.entry-Ccjdx8ag.js"),[],import.meta.url).then(l,L);case"ifx-card-links":return R(()=>import("./ifx-card-links.entry-BvPxxyOK.js"),[],import.meta.url).then(l,L);case"ifx-card-overline":return R(()=>import("./ifx-card-overline.entry-CLwy_UAZ.js"),[],import.meta.url).then(l,L);case"ifx-card-text":return R(()=>import("./ifx-card-text.entry-Da8J4S7z.js"),[],import.meta.url).then(l,L);case"ifx-checkbox-group":return R(()=>import("./ifx-checkbox-group.entry-DrQ1ClST.js"),__vite__mapDeps([7,1,2]),import.meta.url).then(l,L);case"ifx-content-switcher":return R(()=>import("./ifx-content-switcher.entry-DqU_L_-C.js"),__vite__mapDeps([8,1,2]),import.meta.url).then(l,L);case"ifx-content-switcher-item":return R(()=>import("./ifx-content-switcher-item.entry-C-Lkxzpg.js"),[],import.meta.url).then(l,L);case"ifx-date-picker":return R(()=>import("./ifx-date-picker.entry-Bfk4R50n.js"),__vite__mapDeps([9,1,2]),import.meta.url).then(l,L);case"ifx-download":return R(()=>import("./ifx-download.entry-7mDj40WO.js"),[],import.meta.url).then(l,L);case"ifx-dropdown":return R(()=>import("./ifx-dropdown.entry-BsDMNgr3.js"),__vite__mapDeps([10,1,2,11]),import.meta.url).then(l,L);case"ifx-dropdown-header":return R(()=>import("./ifx-dropdown-header.entry-CfxV1uu3.js"),[],import.meta.url).then(l,L);case"ifx-dropdown-item":return R(()=>import("./ifx-dropdown-item.entry-DrEbT79q.js"),[],import.meta.url).then(l,L);case"ifx-dropdown-menu":return R(()=>import("./ifx-dropdown-menu.entry-d9K84ure.js"),[],import.meta.url).then(l,L);case"ifx-dropdown-separator":return R(()=>import("./ifx-dropdown-separator.entry-CDTR7U6_.js"),[],import.meta.url).then(l,L);case"ifx-dropdown-trigger":return R(()=>import("./ifx-dropdown-trigger.entry-ClUjynzN.js"),[],import.meta.url).then(l,L);case"ifx-dropdown-trigger-button":return R(()=>import("./ifx-dropdown-trigger-button.entry-DYHoGIV2.js"),[],import.meta.url).then(l,L);case"ifx-faq":return R(()=>import("./ifx-faq.entry-Dd1j7qIQ.js"),[],import.meta.url).then(l,L);case"ifx-file-upload":return R(()=>import("./ifx-file-upload.entry-DSxb-wmC.js"),__vite__mapDeps([12,1,2]),import.meta.url).then(l,L);case"ifx-filter-bar":return R(()=>import("./ifx-filter-bar.entry-BF4TAVpN.js"),[],import.meta.url).then(l,L);case"ifx-filter-search":return R(()=>import("./ifx-filter-search.entry-Ce00gkB9.js"),[],import.meta.url).then(l,L);case"ifx-filter-type-group":return R(()=>import("./ifx-filter-type-group.entry-DBPofstq.js"),[],import.meta.url).then(l,L);case"ifx-footer":return R(()=>import("./ifx-footer.entry-DtSkjyFI.js"),__vite__mapDeps([13,1,2]),import.meta.url).then(l,L);case"ifx-footer-column":return R(()=>import("./ifx-footer-column.entry-BixVfiY-.js"),[],import.meta.url).then(l,L);case"ifx-icons-preview":return R(()=>import("./ifx-icons-preview.entry-BjwCsk0f.js"),__vite__mapDeps([14,15]),import.meta.url).then(l,L);case"ifx-list":return R(()=>import("./ifx-list.entry-CGr8bxjQ.js"),[],import.meta.url).then(l,L);case"ifx-list-entry":return R(()=>import("./ifx-list-entry.entry-Bowheg-S.js"),[],import.meta.url).then(l,L);case"ifx-navbar":return R(()=>import("./ifx-navbar.entry-LCwWxuBA.js"),__vite__mapDeps([16,2]),import.meta.url).then(l,L);case"ifx-navbar-item":return R(()=>import("./ifx-navbar-item.entry-BI3ON_rY.js"),[],import.meta.url).then(l,L);case"ifx-navbar-profile":return R(()=>import("./ifx-navbar-profile.entry-IG0LLnje.js"),[],import.meta.url).then(l,L);case"ifx-overview-table":return R(()=>import("./ifx-overview-table.entry-C7IaWMdf.js"),[],import.meta.url).then(l,L);case"ifx-radio-button-group":return R(()=>import("./ifx-radio-button-group.entry-Cz8XkYDa.js"),__vite__mapDeps([17,1,2]),import.meta.url).then(l,L);case"ifx-search-bar":return R(()=>import("./ifx-search-bar.entry-BjPYYzO8.js"),__vite__mapDeps([18,1,2]),import.meta.url).then(l,L);case"ifx-segment":return R(()=>import("./ifx-segment.entry-lGhe5wSo.js"),[],import.meta.url).then(l,L);case"ifx-segmented-control":return R(()=>import("./ifx-segmented-control.entry-C6mi6Fnt.js"),__vite__mapDeps([19,1,2]),import.meta.url).then(l,L);case"ifx-set-filter":return R(()=>import("./ifx-set-filter.entry-vdWaoq10.js"),[],import.meta.url).then(l,L);case"ifx-sidebar":return R(()=>import("./ifx-sidebar.entry-BjhfMzqt.js"),__vite__mapDeps([20,2]),import.meta.url).then(l,L);case"ifx-sidebar-item":return R(()=>import("./ifx-sidebar-item.entry-fNKhOleI.js"),[],import.meta.url).then(l,L);case"ifx-sidebar-title":return R(()=>import("./ifx-sidebar-title.entry-BBe-TTYT.js"),[],import.meta.url).then(l,L);case"ifx-slider":return R(()=>import("./ifx-slider.entry-D6FUezCw.js"),__vite__mapDeps([21,1,2]),import.meta.url).then(l,L);case"ifx-status":return R(()=>import("./ifx-status.entry-CtFC1Ysw.js"),__vite__mapDeps([22,1,2]),import.meta.url).then(l,L);case"ifx-step":return R(()=>import("./ifx-step.entry-uAl9ILfi.js"),[],import.meta.url).then(l,L);case"ifx-stepper":return R(()=>import("./ifx-stepper.entry-60qXBHW8.js"),__vite__mapDeps([23,1,2]),import.meta.url).then(l,L);case"ifx-switch":return R(()=>import("./ifx-switch.entry-CauWTxXX.js"),__vite__mapDeps([24,1,2]),import.meta.url).then(l,L);case"ifx-tab":return R(()=>import("./ifx-tab.entry-CIXjd4D2.js"),[],import.meta.url).then(l,L);case"ifx-tabs":return R(()=>import("./ifx-tabs.entry-DzDq5VBn.js"),__vite__mapDeps([25,1,2]),import.meta.url).then(l,L);case"ifx-templates-ui":return R(()=>import("./ifx-templates-ui.entry-DlNni5On.js"),[],import.meta.url).then(l,L);case"ifx-textarea":return R(()=>import("./ifx-textarea.entry-DTASy2K9.js"),__vite__mapDeps([26,1,2]),import.meta.url).then(l,L);case"ifx-tooltip":return R(()=>import("./ifx-tooltip.entry-BRodzFu0.js"),__vite__mapDeps([27,1,2,11]),import.meta.url).then(l,L);case"ifx-tree-view":return R(()=>import("./ifx-tree-view.entry-Dq8Z9Dwb.js"),__vite__mapDeps([28,1,2]),import.meta.url).then(l,L);case"ifx-tree-view-item":return R(()=>import("./ifx-tree-view-item.entry-DBA3jU2k.js"),[],import.meta.url).then(l,L);case"ifx-notification":return R(()=>import("./ifx-notification.entry-D_CDfQxC.js"),__vite__mapDeps([29,1,2]),import.meta.url).then(l,L);case"ifx-progress-bar":return R(()=>import("./ifx-progress-bar.entry-C5PMQwXT.js"),__vite__mapDeps([30,1,2]),import.meta.url).then(l,L);case"ifx-radio-button":return R(()=>import("./ifx-radio-button.entry-CdKcXq_X.js"),__vite__mapDeps([31,1,2]),import.meta.url).then(l,L);case"ifx-search-field":return R(()=>import("./ifx-search-field.entry-CHWzXgoy.js"),__vite__mapDeps([32,4,1,2]),import.meta.url).then(l,L);case"ifx-button":return R(()=>import("./ifx-button.entry-BWo8b6HF.js"),__vite__mapDeps([33,4,1,2]),import.meta.url).then(l,L);case"ifx-icon-button":return R(()=>import("./ifx-icon-button.entry-DaNhwfGR.js"),__vite__mapDeps([34,4,1,2]),import.meta.url).then(l,L);case"ifx-indicator":return R(()=>import("./ifx-indicator.entry-x45X9y6f.js"),__vite__mapDeps([35,1,2]),import.meta.url).then(l,L);case"ifx-checkbox":return R(()=>import("./ifx-checkbox.entry-CgUq3fkr.js"),__vite__mapDeps([36,1,2]),import.meta.url).then(l,L);case"ifx-link":return R(()=>import("./ifx-link.entry-rkkgLEpA.js"),__vite__mapDeps([37,4,1,2]),import.meta.url).then(l,L);case"ifx-icon":return R(()=>import("./ifx-icon.entry-lLRFJzyu.js"),__vite__mapDeps([38,15,1,2]),import.meta.url).then(l,L);case"ifx-filter-accordion":return R(()=>import("./ifx-filter-accordion.entry-Dq3H0KJl.js"),[],import.meta.url).then(l,L);case"ifx-select":return R(()=>import("./ifx-select.entry-Bj1Anrc4.js"),__vite__mapDeps([39,1,2]),import.meta.url).then(l,L);case"ifx-basic-table":return R(()=>import("./ifx-basic-table.entry-135TWMyx.js"),__vite__mapDeps([40,41,4,1,2]),import.meta.url).then(l,L);case"ifx-modal":return R(()=>import("./ifx-modal.entry-BJu5AdTF.js"),__vite__mapDeps([42,1,2]),import.meta.url).then(l,L);case"ifx-accordion_2":return R(()=>import("./ifx-accordion_2.entry-a1Qu5oRZ.js"),__vite__mapDeps([43,1,2]),import.meta.url).then(l,L);case"ifx-alert_2":return R(()=>import("./ifx-alert_2.entry-Corqa3e9.js"),__vite__mapDeps([44,1,2]),import.meta.url).then(l,L);case"ifx-multiselect_2":return R(()=>import("./ifx-multiselect_2.entry-BhK290Pt.js"),__vite__mapDeps([45,1,2]),import.meta.url).then(l,L);case"ifx-spinner_2":return R(()=>import("./ifx-spinner_2.entry-BoXGCj7w.js"),__vite__mapDeps([46,4,1,2]),import.meta.url).then(l,L);case"ifx-chip_3":return R(()=>import("./ifx-chip_3.entry-DCF62X0l.js"),__vite__mapDeps([47,1,2]),import.meta.url).then(l,L);case"ifx-table":return R(()=>import("./ifx-table.entry-D9hPtSFo.js"),__vite__mapDeps([48,41,4,1,2]),import.meta.url).then(l,L)}}return R(()=>import(`./${r}.entry.js`),[],import.meta.url).then(l=>(Gi.set(r,l),l[n]),l=>{L(l,t.$hostElement$)})},wi=new Map,Ul="r",Wl="o",cn="s",Gl="t",Kl="c",ii="s-id",un="sty-id",fr="c-id",Yl="{visibility:hidden}.hydrated{visibility:inherit}",os="slot-fb{display:contents}slot-fb[hidden]{display:none}",pr="http://www.w3.org/1999/xlink",ie=typeof window<"u"?window:{};ie.HTMLElement;var re={$flags$:0,$resourcesUrl$:"",jmp:e=>e(),raf:e=>requestAnimationFrame(e),ael:(e,t,i,n)=>e.addEventListener(t,i,n),rel:(e,t,i,n)=>e.removeEventListener(t,i,n),ce:(e,t)=>new CustomEvent(e,t)},Zl=mt.shadowDom,Jl=(()=>{var e;let t=!1;try{(e=ie.document)==null||e.addEventListener("e",null,Object.defineProperty({},"passive",{get(){t=!0}}))}catch{}return t})(),Xl=e=>Promise.resolve(e),Ri=(()=>{try{return new CSSStyleSheet,typeof new CSSStyleSheet().replaceSync=="function"}catch{}return!1})(),dn=Ri?!!ie.document&&Object.getOwnPropertyDescriptor(ie.document.adoptedStyleSheets,"length").writable:!1,fn=!1,mr=[],cs=[],Ql=(e,t)=>i=>{e.push(i),fn||(fn=!0,re.$flags$&4?Pn(pn):re.raf(pn))},hr=e=>{for(let t=0;t<e.length;t++)try{e[t](performance.now())}catch(i){L(i)}e.length=0},pn=()=>{hr(mr),hr(cs),(fn=mr.length>0)&&re.raf(pn)},Pn=e=>Xl().then(e),ea=Ql(cs),Ep=e=>{const t=new URL(e,re.$resourcesUrl$);return t.origin!==ie.location.origin?t.href:t.pathname},On=e=>(e=typeof e,e==="object"||e==="function");function us(e){var t,i,n;return(n=(i=(t=e.head)==null?void 0:t.querySelector('meta[name="csp-nonce"]'))==null?void 0:i.getAttribute("content"))!=null?n:void 0}var ta=e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),ia=class wt{static fromLocalValue(t){const i=t[Ui],n=Wi in t?t[Wi]:void 0;switch(i){case"string":return n;case"boolean":return n;case"bigint":return BigInt(n);case"undefined":return;case"null":return null;case"number":return n==="NaN"?NaN:n==="-0"?-0:n==="Infinity"?1/0:n==="-Infinity"?-1/0:n;case"array":return n.map(d=>wt.fromLocalValue(d));case"date":return new Date(n);case"map":const r=new Map;for(const[d,u]of n){const p=typeof d=="object"&&d!==null?wt.fromLocalValue(d):d,h=wt.fromLocalValue(u);r.set(p,h)}return r;case"object":const s={};for(const[d,u]of n)s[d]=wt.fromLocalValue(u);return s;case"regexp":const{pattern:l,flags:a}=n;return new RegExp(l,a);case"set":const c=new Set;for(const d of n)c.add(wt.fromLocalValue(d));return c;case"symbol":return Symbol(n);default:throw new Error(`Unsupported type: ${i}`)}}static fromLocalValueArray(t){return t.map(i=>wt.fromLocalValue(i))}static isLocalValueObject(t){if(typeof t!="object"||t===null||!t.hasOwnProperty(Ui))return!1;const i=t[Ui];return Object.values({...ls,...as}).includes(i)?i!=="null"&&i!=="undefined"?t.hasOwnProperty(Wi):!0:!1}},na={};zl(na,{err:()=>ds,map:()=>ra,ok:()=>mn,unwrap:()=>sa,unwrapErr:()=>la});var mn=e=>({isOk:!0,isErr:!1,value:e}),ds=e=>({isOk:!1,isErr:!0,value:e});function ra(e,t){if(e.isOk){const i=t(e.value);return i instanceof Promise?i.then(n=>mn(n)):mn(i)}if(e.isErr){const i=e.value;return ds(i)}throw"should never get here"}var sa=e=>{if(e.isOk)return e.value;throw e.value},la=e=>{if(e.isErr)return e.value;throw e.value};function aa(e){return typeof e!="string"||!e.startsWith(on)?e:ia.fromLocalValue(JSON.parse(atob(e.slice(on.length))))}function oa(e){if(!Ri)return;const t=new CSSStyleSheet;return t.replaceSync(e),t}var jt;function ca(e){var t;const i=this.attachShadow({mode:"open",delegatesFocus:!!(e.$flags$&16)});jt===void 0&&(jt=(t=oa(Dl))!=null?t:null),jt&&(dn?i.adoptedStyleSheets.push(jt):i.adoptedStyleSheets=[...i.adoptedStyleSheets,jt])}var fs=e=>{const t=dt(e,"childNodes");e.tagName&&e.tagName.includes("-")&&e["s-cr"]&&e.tagName!=="SLOT-FB"&&ps(t,e.tagName).forEach(n=>{n.nodeType===1&&n.tagName==="SLOT-FB"&&(da(n,Rn(n),!1).length?n.hidden=!0:n.hidden=!1)});let i=0;for(i=0;i<t.length;i++){const n=t[i];n.nodeType===1&&dt(n,"childNodes").length&&fs(n)}},ua=e=>{const t=[];for(let i=0;i<e.length;i++){const n=e[i]["s-nr"]||void 0;n&&n.isConnected&&t.push(n)}return t};function ps(e,t,i){let n=0,r=[],s;for(;n<e.length;n++)s=e[n],s["s-sr"]&&(!t||s["s-hn"]===t)&&i===void 0&&r.push(s),r=[...r,...ps(s.childNodes,t,i)];return r}var da=(e,t,i=!0)=>{const n=[];(i&&e["s-sr"]||!e["s-sr"])&&n.push(e);let r=e;for(;r=r.nextSibling;)Rn(r)===t&&(i||!r["s-sr"])&&n.push(r);return n},gr=(e,t)=>e.nodeType===1?e.getAttribute("slot")===null&&t===""||e.getAttribute("slot")===t:e["s-sn"]===t?!0:t==="",fa=(e,t,i,n)=>{if(e["s-ol"]&&e["s-ol"].isConnected)return;const r=document.createTextNode("");if(r["s-nr"]=e,!t["s-cr"]||!t["s-cr"].parentNode)return;const s=t["s-cr"].parentNode,l=dt(s,"appendChild");if(typeof n<"u"){r["s-oo"]=n;const a=dt(s,"childNodes"),c=[r];a.forEach(d=>{d["s-nr"]&&c.push(d)}),c.sort((d,u)=>!d["s-oo"]||d["s-oo"]<(u["s-oo"]||0)?-1:!u["s-oo"]||u["s-oo"]<d["s-oo"]?1:0),c.forEach(d=>l.call(s,d))}else l.call(s,r);e["s-ol"]=r,e["s-sh"]=t["s-hn"]},Rn=e=>typeof e["s-sn"]=="string"?e["s-sn"]:e.nodeType===1&&e.getAttribute("slot")||void 0;function ms(e){if(e.assignedElements||e.assignedNodes||!e["s-sr"])return;const t=i=>(function(n){const r=[],s=this["s-sn"];n?.flatten&&console.error(`
