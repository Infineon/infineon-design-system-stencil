...
</' + 'template>`,Ad=Y({__name:"IfxSegmentedControlExample",setup(e){return Z(()=>{X(()=>{K.highlightAll()})}),(t,i)=>(Q(),ee("div",null,[i[1]||(i[1]=o("ifx-segmented-control",{caption:"Caption text to describe the controls",label:"Group Label",size:"regular",error:"false",required:"false"},[o("ifx-segment",{value:"Value1",icon:"star-16"}),o("ifx-segment",{value:"Value2",icon:"star-16"}),o("ifx-segment",{value:"Value3",icon:"star-16"}),o("ifx-segment",{value:"Value4",icon:"star-16"}),o("ifx-segment",{value:"Value5",icon:"star-16"})],-1)),o("details",{class:"code-details"},[i[0]||(i[0]=o("summary",null,"View Code",-1)),o("pre",null,[o("code",{class:"language-markup"},J(Id))])])]))}}),Ed=`<script setup lang="ts">
...
</' + 'template>`,jd=Y({__name:"IfxTablePaginationExample",setup(e){const t=i=>{console.log("ifxSelectionChange:",i)};return Z(()=>{X(()=>{K.highlightAll()})}),(i,n)=>(Q(),ee("div",null,[o("ifx-table",{"row-height":"default",cols:'[{"headerName":"Make","field":"make","sortable":true,"sort":"desc","unSortIcon":true},{"headerName":"Model","field":"model","sortable":true,"unSortIcon":true},{"headerName":"Price","field":"price"},{"headerName":"Age","field":"age"}]',rows:'[{"make":"Toyota","model":"Celica","price":35000,"age":10},{"make":"Ford","model":"Mondeo","price":32000,"age":12},{"make":"Porsche","model":"Boxster","price":72000},{"make":"Bmw","model":"x","price":72000},{"make":"Mercedes","model":"y","price":72000},{"make":"Ferrari","model":"z","price":72000},{"make":"Chrysler","model":"a","price":72000},{"make":"Range rover","model":"b","price":72000},{"make":"Tesla","model":"x","price":72000},{"make":"Audi","model":"3","price":72000},{"make":"Landrover","model":"x","price":72000}]',"enable-selection":"false","table-height":"auto",pagination:"true","server-side-pagination":"false","pagination-items-per-page":'[{"value":"10","selected":true}, {"value":"20","selected":false}, {"value":"30","selected":false}]',"filter-orientation":"none",variant:"default","on:ifxSelectionChange":t},null,32),o("details",{class:"code-details"},[n[0]||(n[0]=o("summary",null,"View Code",-1)),o("pre",null,[o("code",{class:"language-markup"},J(Nd))])])]))}}),Vd=`<script setup lang="ts">
const handleChange = (event: CustomEvent) => {
  console.log('ifxChange:', event);
  // Add your handler logic here
};
