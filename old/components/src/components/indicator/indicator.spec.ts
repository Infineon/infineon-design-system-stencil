...
describe('ifx-indicator', () => {
  ...
  it('renders dot variant correctly', async () => {
    ...
    const numberContainer = page.root.shadowRoot.querySelector('.number__container');
  ...
  it('displays the provided number value', async () => {
    ...
    const numberWrapper = page.root.shadowRoot.querySelector('.number__wrapper');
  ...
  it('sets aria-label attribute correctly', async () => {
    ...
    const container = page.root.shadowRoot.querySelector('.indicator__container');
  ...
  it('changes from number to dot variant correctly', async () => {
    ...
    let numberContainer = page.root.shadowRoot.querySelector('.number__container');
