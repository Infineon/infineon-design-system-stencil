...
describe('ifx-link', () => {
    ...
    it('handles different variants correctly', async () => {
        ...
        expect(boldPage.root.shadowRoot.querySelector('a').className).toContain('bold');
        ...
        expect(titlePage.root.shadowRoot.querySelector('a').className).toContain('title');
        ...
        expect(underlinedPage.root.shadowRoot.querySelector('a').className).toContain('underlined');
        ...
        expect(menuPage.root.shadowRoot.querySelector('a').className).toContain('menu');
    });
    ...
    it('handles different sizes correctly', async () => {
        ...
        expect(smallPage.root.shadowRoot.querySelector('a').className).toContain('small');
        ...
        expect(mediumPage.root.shadowRoot.querySelector('a').className).toContain('medium');
        ...
        expect(largePage.root.shadowRoot.querySelector('a').className).toContain('large');
        ...
        expect(xlPage.root.shadowRoot.querySelector('a').className).toContain('extraLarge');
    });
