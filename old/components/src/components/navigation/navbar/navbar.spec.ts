...
describe('ifx-navbar', () => {
    ...
    beforeEach(() => {
        ...
        (Navbar.prototype as any).addEventListenersToHandleCustomFocusState = jest.fn();
        (Navbar.prototype as any).setItemMenuPosition = jest.fn().mockResolvedValue(undefined);
    ...
    it('renders with default props', async () => {
        ...
        const navbarWrapper = page.root.shadowRoot.querySelector('.navbar__wrapper');
        expect(navbarWrapper).toBeTruthy();

        // Logo should be visible by default
        const logo = page.root.shadowRoot.querySelector('.navbar__container-left-logo');
    ...
    it('renders with custom application name', async () => {
        ...
        const appName = page.root.shadowRoot.querySelector('.navbar__container-left-logo h6');
    ...
    it('sets custom logo href and target', async () => {
        ...
        const logoLink = page.root.shadowRoot.querySelector('.navbar__container-left-logo-default a');
    ...
    it('renders with left menu items', async () => {
      ...
      `,
        ...
        const leftItemSlot = page.root.shadowRoot.querySelector('slot[name="left-item"]');
    ...
    it('renders with right menu items', async () => {
      ...
      `,
        ...
        // Check if the slot exists
        const rightItemSlot = page.root.shadowRoot.querySelector('slot[name="right-item"]');
    ...
    it('renders with search bar slot', async () => {
      ...
      `,
        ...
        const searchBarSlot = page.root.shadowRoot.querySelector('slot[name="search-bar-right"]');
    ...
    it('emits ifxNavbarMobileMenuIsOpen event when sidebar is toggled', async () => {
        ...
        expect((Navbar.prototype as any).handleBodyScroll).toHaveBeenCalledWith('hide');
    });
