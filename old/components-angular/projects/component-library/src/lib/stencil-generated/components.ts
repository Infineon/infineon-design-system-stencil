...
export class MinimalComponent {
  ...
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['ifxTestEvent']);
  }
}


export declare interface MinimalComponent extends Components.MinimalComponent {
  /**
   * Event emitted when the main item area is clicked
   */
  ifxTestEvent: EventEmitter<CustomEvent<any>>;
}
...
@Component({
  selector: 'minimal-component-wrapper',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['listAriaLabel'],
...
export declare interface MinimalComponentWrapper extends Components.MinimalComponentWrapper {}
