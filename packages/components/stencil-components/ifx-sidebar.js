...
const Sidebar = /*@__PURE__*/ proxyCustomElement(class Sidebar extends HTMLElement {
  ...
  addEventListenersToHandleCustomFocusState() {
    ...
    if (slot) {
      ...
      const aElements = sidebarFooterWrapperTopLinks === null || sidebarFooterWrapperTopLinks === void 0 ? void 0 : sidebarFooterWrapperTopLinks.querySelectorAll('a');
...
const IfxSidebar = Sidebar;
const defineCustomElement = defineCustomElement$1;

export { IfxSidebar, defineCustomElement };

//# sourceMappingURL=ifx-sidebar.js.map