...
const ChoicesJs = /*@__PURE__*/getDefaultExportFromCjs(choices);
...
const Choices = /*@__PURE__*/ proxyCustomElement(class Choices extends HTMLElement$1 {
  constructor() {
    ...
    this.ifxError = false;
    this.ifxErrorMessage = "Error";
    this.ifxLabel = "";
    this.ifxDisabled = false;
    this.ifxPlaceholderValue = "Placeholder";
    this.ifxOptions = undefined;
    this.ifxSize = 'medium (40px)';
      ...
      case 'single':
        this.element =
          h("div", { class: `ifx-select-container ${this.getSizeClass()}` }, this.ifxLabel ?
            ...
            h("div", { class: "ifx-error-message-wrapper" }, h("span", null, this.ifxErrorMessage)) : null);
        break;
      // to be implemented later
      //   case 'multiple':
      //     this.element =
  ...
  static get style() { return selectCss; }
    ...
    "items": [16],
    "choices": [1],
    "renderChoiceLimit": [2, "render-choice-limit"],
    "maxItemCount": [2, "max-item-count"],
    "addItems": [4, "add-items"],
    "removeItems": [4, "remove-items"],
    "removeItemButton": [4, "remove-item-button"],
    "editItems": [4, "edit-items"],
    "duplicateItemsAllowed": [4, "duplicate-items-allowed"],
    "delimiter": [1],
    "paste": [4],
    "searchEnabled": [4, "search-enabled"],
    "searchChoices": [4, "search-choices"],
    "searchFields": [1, "search-fields"],
    "searchFloor": [2, "search-floor"],
    "searchResultLimit": [2, "search-result-limit"],
    "position": [1],
    "resetScrollPosition": [4, "reset-scroll-position"],
    "shouldSort": [4, "should-sort"],
    "shouldSortItems": [4, "should-sort-items"],
    "sorter": [16],
    "placeholder": [8],
    "placeholderValue": [1, "placeholder-value"],
    "searchPlaceholderValue": [1, "search-placeholder-value"],
    "prependValue": [1, "prepend-value"],
    "appendValue": [1, "append-value"],
    "renderSelectedChoices": [1, "render-selected-choices"],
    "loadingText": [1, "loading-text"],
    "noResultsText": [1, "no-results-text"],
    "noChoicesText": [1, "no-choices-text"],
    "itemSelectText": [1, "item-select-text"],
    "addItemText": [1, "add-item-text"],
    "maxItemText": [1, "max-item-text"],
    "uniqueItemText": [1, "unique-item-text"],
    "classNames": [16],
    "fuseOptions": [16],
    "addItemFilter": [1, "add-item-filter"],
    "customAddItemText": [1, "custom-add-item-text"],
    "callbackOnInit": [16],
    "callbackOnCreateTemplates": [16],
    "valueComparer": [16],
    "ifxError": [4, "ifx-error"],
    "ifxErrorMessage": [1, "ifx-error-message"],
    "ifxLabel": [1, "ifx-label"],
    "ifxDisabled": [4, "ifx-disabled"],
    "ifxPlaceholderValue": [1, "ifx-placeholder-value"],
    "ifxOptions": [1, "ifx-options"],
    "ifxSize": [1, "ifx-size"],
    "ifxSelectedOption": [32],
    "handleChange": [64],
    "highlightItem": [64],
    "unhighlightItem": [64],
    "highlightAll": [64],
    "unhighlightAll": [64],
    "removeActiveItemsByValue": [64],
    "removeActiveItems": [64],
    "removeHighlightedItems": [64],
    "showDropdown": [64],
    "hideDropdown": [64],
    "getValue": [64],
    "setValue": [64],
...
function defineCustomElement() {
  ...
  const components = ["ifx-select", "ifx-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "ifx-select":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, Choices);
      }
      break;
    case "ifx-icon":
      if (!customElements.get(tagName)) {
