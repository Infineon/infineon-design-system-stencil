...
import AccordionElementsMobile from '../../storybook/assets/components/accordion/accordion-elements-mobile.png';
import AccordionElements from '../../storybook/assets/components/accordion/accordion-elements.png';
import AccordionStates from '../../storybook/assets/components/accordion/accordion-states.png';
