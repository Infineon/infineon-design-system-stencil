...
## Note
When using in React, if you wish to dynamically update the content of an accordion-item, please add a ``key`` attribute on the accordion-item in order to trigger an internal re-render.
