...
`);
    ...
    it('should open dropdown when clicked', async () => {
        ...
        const wrapper = page.root.shadowRoot.querySelector('.chip__wrapper') as HTMLElement;
    ...
    it('should handle multiple selections in multi variant', async () => {
        ...
        const selectedOptions = page.root.shadowRoot.querySelector('.label__selected-options');
    ...
    it('should clear all selections when unselect button is clicked', async () => {
        ...
        const unselectButton = page.root.shadowRoot.querySelector('.wrapper__unselect-button');
