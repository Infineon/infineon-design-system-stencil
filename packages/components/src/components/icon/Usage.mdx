...
import IconColorAlignment from '../../storybook/stories/assets/icon/icon-color-alignment.png';
import IconAlignment from '../../storybook/stories/assets/icon/icon-alignment.png';
import IconSizes from '../../storybook/stories/assets/icon/icon-sizes.png';
import IconStructure from '../../storybook/stories/assets/icon/icon-structure.png';
import IconSizeAlignment from '../../storybook/stories/assets/icon/icon-size-alignment.png';
import IconVariants from '../../storybook/stories/assets/icon/icon-variants.png';
import IconTextColorBrand from '../../storybook/stories/assets/icon/icon-text-color-brand.png';
import IconTextColorDark from '../../storybook/stories/assets/icon/icon-text-color-dark.png';
import IconTextColorWhite from '../../storybook/stories/assets/icon/icon-text-color-white.png';
