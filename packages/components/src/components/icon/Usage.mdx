...
import IconColorAlignment from '../../stories/assets/icon/icon-color-alignment.png';
import IconAlignment from '../../stories/assets/icon/icon-alignment.png';
import IconSizes from '../../stories/assets/icon/icon-sizes.png';
import IconStructure from '../../stories/assets/icon/icon-structure.png';
import IconSizeAlignment from '../../stories/assets/icon/icon-size-alignment.png';
import IconVariants from '../../stories/assets/icon/icon-variants.png';
import IconTextColorBrand from '../../stories/assets/icon/icon-text-color-brand.png';
import IconTextColorDark from '../../stories/assets/icon/icon-text-color-dark.png';
import IconTextColorWhite from '../../stories/assets/icon/icon-text-color-white.png';
