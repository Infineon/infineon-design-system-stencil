...
import IconColorAlignment from '../../stories/assets/components/icon/icon-color-alignment.png';
import IconAlignment from '../../stories/assets/components/icon/icon-alignment.png';
import IconSizes from '../../stories/assets/components/icon/icon-sizes.png';
import IconStructure from '../../stories/assets/components/icon/icon-structure.png';
import IconSizeAlignment from '../../stories/assets/components/icon/icon-size-alignment.png';
import IconVariants from '../../stories/assets/components/icon/icon-variants.png';
import IconTextColorBrand from '../../stories/assets/components/icon/icon-text-color-brand.png';
import IconTextColorDark from '../../stories/assets/components/icon/icon-text-color-dark.png';
import IconTextColorWhite from '../../stories/assets/components/icon/icon-text-color-white.png';
