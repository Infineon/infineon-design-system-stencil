...
import LinkBold from '../../storybook/assets/components/link/link-bold.png';
import LinkBoldStates from '../../storybook/assets/components/link/link-bold-states.png';
import LinkTitle from '../../storybook/assets/components/link/link-title.png';
import LinkUnderline from '../../storybook/assets/components/link/link-underline.png';
import LinkUnderlineStates from '../../storybook/assets/components/link/link-underline-states.png';
import LinkTitleStates from '../../storybook/assets/components/link/link-title-states.png';
import LinkMenu from '../../storybook/assets/components/link/link-menu.png';
import LinkMenuStates from '../../storybook/assets/components/link/link-menu-states.png';
import LinkInline from '../../storybook/assets/components/link/link-inline.png';
import LinkInlineStates from '../../storybook/assets/components/link/link-inline-states.png';
import LinkInlineError from '../../storybook/assets/components/link/link-inline-error.png';
import LinkInlineErrorStates from '../../storybook/assets/components/link/link-inline-error-states.png';
import LinkMouseInteraction from '../../storybook/assets/components/link/link-mouse-interaction.png';
import LinkIconLeft from '../../storybook/assets/components/link/link-icon-left.png';
import LinkIconRight from '../../storybook/assets/components/link/link-icon-right.png';
import LinkIconPlacementLeft from '../../storybook/assets/components/link/link-icon-placement-left.png';
import LinkIconPlacementRight from '../../storybook/assets/components/link/link-icon-placement-right.png';
import LinkFontSizeAlignment from '../../storybook/assets/components/link/link-font-size-alignment.png';
import LinkSizes from '../../storybook/assets/components/link/link-sizes.png';
