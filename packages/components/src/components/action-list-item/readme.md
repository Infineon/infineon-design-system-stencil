...
| --------------- | ----------------- | ---------------------------------------------- | --------- | ----------- |
| `description`   | `description`     | The description text displayed below the title | `string`  | `undefined` |
| `disabled`      | `disabled`        | Controls whether the item is disabled          | `boolean` | `false`     |
