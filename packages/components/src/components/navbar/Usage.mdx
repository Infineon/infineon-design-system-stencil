...
import HeaderDefaultAnatomy720 from '../../../public-storybook/images/navbar/header-default-anatomy_=720px.png';
import HeaderDefaultAnatomy1440 from '../../../public-storybook/images/navbar/header-default-anatomy_=1440px.png';
...
## Anatomy of desktop navigation
<img src={HeaderDefaultAnatomy1440} alt="Anatomy Header Navigation Default above 1440px" />
...
## Anatomy of mobile navigation
<img src={HeaderDefaultAnatomy720} alt="Anatomy Header Navigation Default below 720px" />
...
<img src={HeaderMainItemsExample} alt="Anatomy Header Main Items" />
...
<img src={HeaderSecondaryNavigationItemsExample} alt="Anatomy Header Main Items" />
...
## Breakpoints
<img src={HeaderOverviewBreakpoints} alt="Header Breakpoints" />
...
***
Check out the Figma component: **[Header Navigation](https://www.figma.com/file/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?type=design&node-id=19241-12529&mode=design&t=2lNZOOqATnlJOKBG-4)**
***