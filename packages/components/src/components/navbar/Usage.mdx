...
import HeaderDefaultAnatomySmall from '../../../public-storybook/images/navbar/header-default-anatomy_=720px.png';
import HeaderDefaultAnatomyLarge from '../../../public-storybook/images/navbar/header-default-anatomy_=1440px.png';
...
<img src={HeaderDefaultAnatomyLarge} alt="Anatomy Header Navigation Default above 1440px" />
...
<img src={HeaderDefaultAnatomySmall} alt="Anatomy Header Navigation Default below 720px" />
