...
describe('ifx-modal', () => {
  beforeEach(() => {
    ...
    IfxModal.prototype.isModalContentContainerHeightReachedViewport = jest.fn(() => Promise.resolve(false));
  ...
  it('renders with different sizes', async () => {
    ...
    const contentContainer = page.root.shadowRoot.querySelector('.modal-content-container');
  ...
  it('respects showCloseButton prop', async () => {
    ...
    const closeButton1 = page1.root.shadowRoot.querySelector('.modal-close-button');
    ...
    const closeButton2 = page2.root.shadowRoot.querySelector('.modal-close-button');
