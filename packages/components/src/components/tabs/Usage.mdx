...
import TabsAnatomy from '../../storybook/assets/components/tabs/tabs-anatomy.png';
import TabsDesktopHorizontal from '../../storybook/assets/components/tabs/tabs-desktop-horizontal.png';
import TabsDesktopVertical from '../../storybook/assets/components/tabs/tabs-desktop-vertical.png';
import TabsMobileHorizontal from '../../storybook/assets/components/tabs/tabs-mobile-horizontal.png';
import TabsStates from '../../storybook/assets/components/tabs/tabs-states.png';
import TabsSize from '../../storybook/assets/components/tabs/tabs-size.png';
import TabsMouseInteraction from '../../storybook/assets/components/tabs/tabs-mouse-interaction.png';
import TabsAdvanced from '../../storybook/assets/components/tabs/tabs-advanced.png';
import TabsSticky from '../../storybook/assets/components/tabs/tabs-sticky.png';
...
### Advanced
This variant enhances the standard tab with a subline text and an optional indicator (label or number), providing additional context and visual cues.
<img src={TabsAdvanced} alt="Tabs Advanced" />

## Sticky behaviour
Enables the tab to stick to the top of the viewport, remaining visible and accessible as the user scrolls down the page.
<img src={TabsSticky} alt="Tabs Sticky" />
