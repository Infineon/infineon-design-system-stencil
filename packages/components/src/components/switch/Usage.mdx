...
import SwitchAnatomy from '../../storybook/assets/components/switch/switch-anatomy.png';
import SwitchMouseInteraction from '../../storybook/assets/components/switch/switch-mouse-interaction.png';
import SwitchStates from '../../storybook/assets/components/switch/switch-states.png';
