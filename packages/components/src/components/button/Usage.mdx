...
import ButtonVariantPrimary from '../../storybook/assets/components/button/button-variant-primary.png';
import PrimaryButtonStates from '../../storybook/assets/components/button/primary-button-states.png';
import ButtonVariantSecondary from '../../storybook/assets/components/button/button-variant-secondary.png';
import SecondaryButtonStates from '../../storybook/assets/components/button/secondary-button-states.png';
import ButtonVariantTertiary from '../../storybook/assets/components/button/button-variant-tertiary.png';
import TertiaryButtonStates from '../../storybook/assets/components/button/tertiary-button-states.png';
import ButtonVariantError from '../../storybook/assets/components/button/button-variant-error.png';
import ErrorButtonStates from '../../storybook/assets/components/button/error-button-states.png';
import ButtonIconLeft from '../../storybook/assets/components/button/button-icon-left.png';
import ButtonIconRight from '../../storybook/assets/components/button/button-icon-right.png';
import ButtonSizes from '../../storybook/assets/components/button/button-sizes.png';
import ButtonGroupingByImportance from '../../storybook/assets/components/button/button-grouping-by-importance.png';
import ButtonComponentPattern from '../../storybook/assets/components/button/button-component-pattern.png';
