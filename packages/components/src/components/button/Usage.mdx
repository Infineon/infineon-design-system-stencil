...
### Error
Should be used for actions that result in a destructive action, such as deleting a record. The error button has a high-contrast, attention-grabbing style — try to limit its use per page as much as possible.
...
## Size
<img src={ButtonSizes} alt="Button Sizes" width="50%"/>
...
***
Check out the Figma component: **[Button](https://www.figma.com/file/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?type=design&node-id=2610-6235&mode=design&t=xVWOPkYnUvh53BSW-4)**
***