...
| [<img src={ButtonFigmaComponent} alt="Button Figma Component" width="50%" />](https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=2389-2466) | [<img src={ButtonComponentPattern} alt="Button Component Pattern" width="50%" />](https://www.figma.com/design/ojJZvk4cyAizP9Lr984CEe/Infineon-DDS-%7C-Design-patterns?node-id=36-40673) |
|---|---|
