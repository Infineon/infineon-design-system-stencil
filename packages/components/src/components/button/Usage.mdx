...
## Icon button
This button variant uses only an icon and is the most minimal style. It is perfect for information dense scenarios with only a limited amount of free interface space.
...
### Size
The Icon button is available only in two different sizes: 32px and 40px
