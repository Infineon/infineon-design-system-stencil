...
import SidebarSections from '../../../storybook/assets/components/sidebar/sidebar-sections.png';
import SidebarAnatomy from '../../../storybook/assets/components/sidebar/sidebar-anatomy.png';
import SidebarExpandedAnatomy from '../../../storybook/assets/components/sidebar/sidebar-expanded-anatomy.png';
import NavigationBarVariant from '../../../storybook/assets/components/navbar/navigation-bar-variant.png';
...
| Resources                                                                                                                             |
|---------------------------------------------------------------------------------------------------------------------------------------|
| [Figma sidebar navigation component →](https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=23998-13854) |
