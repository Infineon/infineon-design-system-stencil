						...
						<div class="sidebar__footer-wrapper">
							{(this.internalTermsofUse ||
								...
								<div class="sidebar__footer-wrapper-top-links">
									{this.internalTermsofUse !== "" && (
										<a target={this.footerHrefTarget} href={this.internalTermsofUse}>
											Terms of use
										</a>
									)}
									{this.internalImprint !== "" && (
										<a target={this.footerHrefTarget} href={this.internalImprint}>
											Imprint
										</a>
									)}
									{this.internalPrivacyPolicy !== "" && (
										<a target={this.footerHrefTarget} href={this.internalPrivacyPolicy}>
											Privacy policy
										</a>
									)}
								</div>
