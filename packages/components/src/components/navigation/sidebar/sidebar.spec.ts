...
describe('ifx-sidebar', () => {
  ...
  beforeAll(() => {
    ...
    (Sidebar.prototype as any)._originalExpandActiveItems = originalExpandActiveItems;
  });

  afterAll(() => {
    // Restore original method after tests
    if ((Sidebar.prototype as any)._originalExpandActiveItems) {
      Sidebar.prototype.expandActiveItems = (Sidebar.prototype as any)._originalExpandActiveItems;
