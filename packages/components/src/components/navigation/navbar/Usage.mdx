...
import ButtonGroupingByImportance from '../../../storybook/assets/components/button/button-grouping-by-importance.png';
import HeaderDefaultAnatomySmall from '../../../storybook/assets/components/navbar/header-default-anatomy_720px.png';
import HeaderDefaultAnatomyLarge from '../../../storybook/assets/components/navbar/header-default-anatomy_1440px.png';
import HeaderMainItemsExample from '../../../storybook/assets/components/navbar/header-main-items-example.png';
import HeaderMobileNavigation from '../../../storybook/assets/components/navbar/header-mobile-navigation.png';
import HeaderOverviewBreakpoints from '../../../storybook/assets/components/navbar/header-overview-breakpoints.png';
import HeaderSecondaryNavigationItemsExample from '../../../storybook/assets/components/navbar/header-secondary-navigation-items-example.png';
import NavigationSubmenuDividerItem from '../../../storybook/assets/components/navbar/navigation-submenu-divider-item.png';
import NavigationSubmenuItemsStates from '../../../storybook/assets/components/navbar/navigation-submenu-items-states.png';
import NavigationSubmenuItems from '../../../storybook/assets/components/navbar/navigation-submenu-items.png';
import NavigationSubmenuMultilvlItems from '../../../storybook/assets/components/navbar/navigation-submenu-multilvl-items.png';
...
| Resources                                                                                                                   |
|-----------------------------------------------------------------------------------------------------------------------------|
| [Figma navbar component →](https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=2432-2895) |
