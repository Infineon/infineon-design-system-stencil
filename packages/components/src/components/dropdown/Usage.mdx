...
import DropdownMenuVariants from '../../storybook/assets/components/dropdown/dropdown-menu-variants.png';
import DropdownMenuTrigger from '../../storybook/assets/components/dropdown/dropdown-menu-trigger.png';
import DropdownMenuStates from '../../storybook/assets/components/dropdown/dropdown-menu-states.png';
import DropdownMenuSizes from '../../storybook/assets/components/dropdown/dropdown-menu-sizes.png';
import DropdownMenuScrollBehavior from '../../storybook/assets/components/dropdown/dropdown-menu-scroll-behavior.png';
import DropdownMenuFilterSearch from '../../storybook/assets/components/dropdown/dropdown-menu-filter-search.png';
import DropdownMenuFilterSearchFlow from '../../storybook/assets/components/dropdown/dropdown-menu-filter-search-flow.png';
...
## Size
There are two dropdown menu sizes: M and S. 
