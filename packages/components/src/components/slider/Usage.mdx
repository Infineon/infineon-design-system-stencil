...
import RangeSliderDefault from '../../storybook/assets/components/slider/range-slider-default.png';
import RangeSliderStates from '../../storybook/assets/components/slider/range-slider-states.png';
import SliderAnatomy from '../../storybook/assets/components/slider/slider-anatomy.png';
import SliderDefault from '../../storybook/assets/components/slider/slider-default.png';
import SliderStates from '../../storybook/assets/components/slider/slider-states.png';
import SliderVariants from '../../storybook/assets/components/slider/slider-variants.png';
