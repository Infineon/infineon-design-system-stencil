...
import IconButtonGroupingByFunction from '../../storybook/assets/components/icon-button/icon-button-grouping-by-function.png';
import IconButtonGroupingByImportance from '../../storybook/assets/components/icon-button/icon-button-grouping-by-importance.png';
import IconButtonInteraction from '../../storybook/assets/components/icon-button/icon-button-interaction.png';
import IconButtonPrimaryStates from '../../storybook/assets/components/icon-button/icon-button-primary-states.png';
import IconButtonSecondaryStates from '../../storybook/assets/components/icon-button/icon-button-secondary-states.png';
import IconButtonTertiaryStates from '../../storybook/assets/components/icon-button/icon-button-tertiary-states.png';
import IconButtonSizes from '../../storybook/assets/components/icon-button/icon-button-sizes.png';
import IconButtonStyles from '../../storybook/assets/components/icon-button/icon-button-styles.png';
import IconButtonVariantPrimary from '../../storybook/assets/components/icon-button/icon-button-variant-primary.png';
import IconButtonVariantSecondary from '../../storybook/assets/components/icon-button/icon-button-variant-secondary.png';
import IconButtonVariantTertiary from '../../storybook/assets/components/icon-button/icon-button-variant-tertiary.png';
...
<img src={IconButtonVariantPrimary} alt="Icon Button Variant Primary" />
...
<img src={IconButtonVariantSecondary} alt="Icon Button Variant Secondary" />
...
<img src={IconButtonVariantTertiary} alt="Icon Button Variant Tertiary" />

#### States
<img src={IconButtonTertiaryStates} alt="Icon Button Tertiary States" />

## Style
Our design system provides two different styles: round and square.
...
### XS
Our smallest size which should be handled as a function item. It can be used alone or in an icon group. This size is only available for the tertiary icon button.
