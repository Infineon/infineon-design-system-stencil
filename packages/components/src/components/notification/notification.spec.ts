...
describe('ifx-notification', () => {
  it('renders with default props', async () => {
    ...
    const wrapper = page.root.shadowRoot.querySelector('.ifx-notification__wrapper');
    expect(wrapper).toBeTruthy();
    
    // Should have success class by default
    expect(wrapper.classList.contains('ifx-notification__wrapper--success')).toBeTruthy();
    
    // Content should be in the slot
    const slotContainer = page.root.shadowRoot.querySelector('.ifx-notification__slot');
  ...
  it('renders with different variants', async () => {
    ...
    for (const variant of variants) {
      ...
      const wrapper = page.root.shadowRoot.querySelector('.ifx-notification__wrapper');
      expect(wrapper.classList.contains(`ifx-notification__wrapper--${variant}`)).toBeTruthy();
    }
  });
  ...
  it('renders with an icon', async () => {
    ...
    const iconElement = page.root.shadowRoot.querySelector('.ifx-notification__icon ifx-icon');
  ...
  it('renders with link', async () => {
    ...
    const linkContainer = page.root.shadowRoot.querySelector('.ifx-notification__link');
  ...
  it('renders with custom link target', async () => {
    ...
    const link = page.root.shadowRoot.querySelector('.ifx-notification__link ifx-link');
