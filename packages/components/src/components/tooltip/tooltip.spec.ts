...
describe('ifx-tooltip', () => {
  it('renders with default props', async () => {
    ...
    const tooltipContainer = page.root.shadowRoot.querySelector('.tooltip__container');
    expect(tooltipContainer).toBeTruthy();
    
    // Default variant should be compact
    const tooltipCompact = page.root.shadowRoot.querySelector('.tooltip-compact');
  ...
  it('renders with dismissible variant', async () => {
    ...
    const tooltipDismissible = page.root.shadowRoot.querySelector('.tooltip-dismissible');
    expect(tooltipDismissible).toBeTruthy();
    
    // Check header and content
    const header = tooltipDismissible.querySelector('.tooltip-dismissible-header');
  ...
  it('renders with extended variant', async () => {
    ...
    const tooltipExtended = page.root.shadowRoot.querySelector('.tooltip-extended');
