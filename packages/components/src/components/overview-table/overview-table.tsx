									...
									<td>
										<ul>
											<li>
												...
												<span>
													Includes essential functionality such as
													expand/collapse behavior and minimal customization
													options
												</span>
											</li>
											<li>
											...
											<li>
												...
												<span>
													Provides a simple and lightweight way to organize and
													display collapsible content
												</span>
											</li>
										</ul>
									</td>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a lightweight and customizable interface for
													presenting alerts, including options for different
													alert types (e.g., primary, success, danger, warning)
													and basic styling configurations
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a simple and customizable way to display a
													sequential trail of links or indicators, representing
													the user's current location within a hierarchy of
													content
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											...
											<li>
												...
												<span>
													Incorporated dropdown-menu for individual items
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Includes basic styling options such as colors, sizes,
													and states, providing essential functionality for
													initiating actions
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a structured and customizable layout,
													featuring elements such as headings, images, text, and
													buttons
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a simple and customizable checkbox input,
													allowing users to toggle between checked and unchecked
													states
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a simple and customizable interface for
													grouping multiple checkbox inputs
												</span>
											</li>
											<li>
												<span>
												...
												<span>
													Allows users to set and display group label, caption
													text and caption icon
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a simple and customizable interface,
													representing discrete units of information or user
													interactions, such as labels, categories, or removable
													entities
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Incorporated dropdown-menu for individual item
													selection
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a flexible and intuitive interface for
													dynamically switching between different content
													sections or views within a web application
												</span>
											</li>
											<li>
												<span>
												...
												<span>
													Offers a customizable mechanism for users to toggle
													and display diverse content panels, facilitating
													seamless navigation and interaction with varying
													information or functional contexts
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a customized wrapper and theming for the
													standard date picker element, enhancing its appearance
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a versatile and interactive user interface
													element for presenting a list of options or actions
												</span>
											</li>
											<li>
												<span>
												...
												<span>
													Ensures consistent behavior and compatibility with web
													standards for a reliable user experience, while
													intentionally limiting customization options to
													emphasize a standardized appearance and behavior
												</span>
											</li>
										</ul>
									</td>
										...
										<ul>
											<li>
												...
												<span>
													...
													to transfer files from their devices to a web
													application
												</span>
											</li>
											<li>
												...
												<span>
													Supports manual file selection and drag-drop
													interactions
												</span>
											</li>
											<li>
												...
												<span>
													Offers real-time feedback on upload progress and
													status, file type validation, and customizable upload
													buttons
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a standardized and customizable way to
													display essential information, navigation links, and
													branding at the bottom of web pages or application
													interfaces
												</span>
											</li>
											<li>
												...
												<span>
													...
													organizing copyright notices, contact details, sitemap
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a compact and interactive icon-based button
													element
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a compact and configurable display for
													showcasing numeric data or dot indicator
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a flexible and customizable element for
													creating hyperlinks within a web application
												</span>
											</li>
											<li>
												<span>
												...
												<span>
													Offers essential functionality for defining clickable
													text or elements
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Small, Medium, Large, Extra Large size variants
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Bold, Underlined, Title, Menu state variants
												</span>
											</li>
										</ul>
									</td>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a customizable modal window, typically used
													for displaying contextual information, user
													interactions, or additional content without navigating
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a standardized and customizable navigation
													bar for organizing and presenting essential links,
													menus, branding, and interactive elements within a web
													application
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a flexible and visually distinct container for
													presenting informative, warning, or error messages to
													users, enhancing the overall user experience with
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a configurable set of controls for navigating
													through sequential pages of content, typically used
													for displaying large datasets or segmented information
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a customizable and dynamic bar that visually
													represents the advancement of a process, typically
													used to convey loading status, or task completion
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a customizable radio input, allowing users to
													make a single selection from a predefined list of
													options, typically used for multiple-choice selection
													or exclusive input
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a customizable interface for grouping
													multiple radio-button inputs
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a dynamic and customizable input area that
													allows users to input search terms and trigger search
													actions, typically used for querying and filtering
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers an interactive and adaptable input area that
													allows users to enter search terms and trigger search
													actions, facilitating efficient querying and filtering
													of content within the application
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a clear and interactive interface for users
													to make mutually exclusive selections among multiple
													options within a web application
												</span>
											</li>
											<li>
												<span>
												...
												<span>
													Offers a customizable set of segmented buttons or
													tabs, allowing users to toggle between different
													choices or views, typically used for filtering,
													categorization, or navigation purposes
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a configurable and collapsible panel that
													typically occupies the side of the screen, allowing
													users to access additional sections, or menus while
													maintaining the main content area
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides an interactive and customizable input control
													for selecting a value within a defined range, often
													used for settings such as volume control, data
													selection, or numerical input
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a customizable and animated symbol that conveys
													to users that a task is in progress, typically used to
													signify loading content, data retrieval, or pending
													operations
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a visual indicator for conveying the state,
													status, or condition of an item, process, or entity
													within a web application
												</span>
											</li>
										</ul>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Ocean, Orange, Grey, Light-grey, Red, Green and Berry
													color variants
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a customizable and intuitive control that
													allows users to navigate through sequential steps
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides an interactive and customizable interface for
													toggling between two states, typically representing an
													on/off or active/inactive status within a web
													application
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a customizable and interactive layout that
													allows users to switch between different content
													panels, typically used for organizing related
													information or functional sections
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Offers a customizable and accessible interface that
													allows users to input and modify text, facilitating
													various data entry and form submission tasks
												</span>
											</li>
											<li>
												<span>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a simple and informative interface for
													displaying supplementary text or contextual
													information when users interact with specific elements
													within a web application
												</span>
											</li>
											<li>
									...
									<td>
										<ul>
											<li>
												...
												<span>
													Provides a structured and expandable interface for
													presenting hierarchical data
												</span>
											</li>
											<li>
												<span>
												...
												<span>
													Enables users to navigate complex information
													architectures by expanding or collapsing nodes
												</span>
											</li>
											<li>
												<span>
