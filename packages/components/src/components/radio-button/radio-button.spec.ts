...
describe('ifx-radio-button', () => {
  it('renders with default props', async () => {
    ...
    const container = page.root.shadowRoot.querySelector('.radioButton__container');
  ...
  it('renders checked state correctly', async () => {
    ...
    const mark = page.root.shadowRoot.querySelector('.radioButton__wrapper-mark');
  ...
  const fallbackInput = page.root.querySelector('._ifx-radiobutton-fallback') as HTMLInputElement;
