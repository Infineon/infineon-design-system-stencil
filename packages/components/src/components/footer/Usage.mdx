...
import FooterDefaultAnatomy from '../../storybook/assets/components/footer/footer-default-anatomy.png';
import FooterLarge from '../../storybook/assets/components/footer/footer-large.png';
import FooterMedium from '../../storybook/assets/components/footer/footer-medium.png';
import FooterSmall from '../../storybook/assets/components/footer/footer-small.png';
import FooterMobile from '../../storybook/assets/components/footer/footer-mobile.png';
