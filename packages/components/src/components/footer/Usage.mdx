...
import FooterDefaultAnatomy from '../../stories/assets/components/footer/footer-default-anatomy.png';
import FooterLarge from '../../stories/assets/components/footer/footer-large.png';
import FooterMedium from '../../stories/assets/components/footer/footer-medium.png';
import FooterSmall from '../../stories/assets/components/footer/footer-small.png';
import FooterMobile from '../../stories/assets/components/footer/footer-mobile.png';
