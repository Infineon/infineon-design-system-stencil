...
import ProgressBarSize4px from '../../stories/assets/components/progress-bar/progressbar-4px.png';
import ProgressBarSize20px from '../../stories/assets/components/progress-bar/progressbar-20px.png';
import ProgressBarAnatomy from '../../stories/assets/components/progress-bar/progressbar-anatomy.png';
