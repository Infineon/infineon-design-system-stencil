...
import ProgressBarSize4px from '../../storybook/assets/components/progress-bar/progressbar-4px.png';
import ProgressBarSize20px from '../../storybook/assets/components/progress-bar/progressbar-20px.png';
import ProgressBarAnatomy from '../../storybook/assets/components/progress-bar/progressbar-anatomy.png';
