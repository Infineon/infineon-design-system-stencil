...
import BreadcrumbAnatomy from '../../storybook/assets/components/breadcrumb/breadcrumb-anatomy.png';
import BreadcrumbMouseInteraction from '../../storybook/assets/components/breadcrumb/breadcrumb-mouse-interaction.png';
import BreadcrumbStates from '../../storybook/assets/components/breadcrumb/breadcrumb-states.png';
import BreadcrumbPositioningDesktop from '../../storybook/assets/components/breadcrumb/breadcrumb-positioning-desktop.png';
import BreadcrumbPositioningMobile from '../../storybook/assets/components/breadcrumb/breadcrumb-positioning-mobile.png';
