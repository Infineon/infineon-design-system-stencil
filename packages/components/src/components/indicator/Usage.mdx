...
import NumberIndicatorStyle from '../../../public-storybook/images/indicator/indicator-style.png';
import NumberIndicatorUse from '../../../public-storybook/images/indicator/indicator-use.png';
