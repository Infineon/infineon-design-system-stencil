...
describe('ifx-segmented-control', () => {
  it('renders with default props', async () => {
    ...
    const controlsContainer = page.root.shadowRoot.querySelector('.group__controls');
  ...
  it('emits ifxChange event when segment is selected', async () => {
    ...
    const segmentDiv = segment2.shadowRoot.querySelector('.segment') as HTMLElement;
    segmentDiv.click();
...
describe('ifx-segment', () => {
  ...
  it('emits segmentSelect event on click when not selected', async () => {
    ...
    const segmentDiv = page.root.shadowRoot.querySelector('.segment') as HTMLElement;
    segmentDiv.click();
