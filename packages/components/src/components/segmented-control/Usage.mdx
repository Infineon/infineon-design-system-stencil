...
import SegmentedControlStates from '../../stories/assets/components/segmented-control/segmented-control-states.png';
import SegmentedControlAnatomy from '../../stories/assets/components/segmented-control/segmented-control-anatomy.png';
