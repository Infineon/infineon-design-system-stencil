...
import FileUploadButtonExample from '../../../public-storybook/images/file-upload/file-upload-upload-button-example.png';
...
<img src={FileUploadButton} alt="File Upload Button" />
...
<img src={FileUploadDropzone} alt="File Upload Dropzone" />
...
<img src={FileUploadListItemStates} alt="File Upload List Item States" />
...
### Using as dropzone
> We highly recommend to set the dropzone width to 100%.
