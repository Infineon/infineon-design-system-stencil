...
| `paginationItemsPerPage`    | `pagination-items-per-page`   | Number of items per page.                                 | `string \| { value: string \| number; selected?: boolean; label?: string; }[]`              | `undefined` |
...
| `showSidebarFiltersButton`  | `show-sidebar-filters-button` |                                                           | `boolean`                                                                                   | `true`      |
