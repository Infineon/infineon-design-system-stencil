...
import TableBasicVersionCellButtonItems from '../../stories/assets/components/table-basic-version/table-cell-button-items.png';
import TableBasicVersionCellCheckboxItems from '../../stories/assets/components/table-basic-version/table-cell-checkbox-items.png';
import TableBasicVersionCellStatusItems from '../../stories/assets/components/table-basic-version/table-cell-status-items.png';
import TableBasicVersionCellTextItems from '../../stories/assets/components/table-basic-version/table-cell-text-items.png';
import TableBasicVersionCellTreeItems from '../../stories/assets/components/table-basic-version/table-cell-tree-items.png';
import TableBasicVersionContentTemplateItems from '../../stories/assets/components/table-basic-version/table-content-template-items.png';
import TableBasicVersionExampleCompact from '../../stories/assets/components/table-basic-version/table-example-compact.png';
import TableBasicVersionExampleDefault from '../../stories/assets/components/table-basic-version/table-example-default.png';
import TableBasicVersionHeaderTemplateItems from '../../stories/assets/components/table-basic-version/table-header-template-items.png';
import TableBasicVersionHeaderSortingItems from '../../stories/assets/components/table-basic-version/table-header-sorting-items.png';
import TableBasicVersionHeaderContentLogic from '../../stories/assets/components/table-basic-version/table-header-content-logic.png';
import TableBasicVersionHeaderColumnActionReorder from '../../stories/assets/components/table-basic-version/table-header-column-action-reorder.png';
import TableBasicVersionHeaderColumnActionResize from '../../stories/assets/components/table-basic-version/table-header-column-action-resize.png';
import TableBasicVersionHeaderContentLogicZebra from '../../stories/assets/components/table-basic-version/table-header-content-logic-zebra.png';
