...
import TableBasicVersionCellButtonItems from '../../storybook/assets/components/table-basic-version/table-cell-button-items.png';
import TableBasicVersionCellCheckboxItems from '../../storybook/assets/components/table-basic-version/table-cell-checkbox-items.png';
import TableBasicVersionCellStatusItems from '../../storybook/assets/components/table-basic-version/table-cell-status-items.png';
import TableBasicVersionCellTextItems from '../../storybook/assets/components/table-basic-version/table-cell-text-items.png';
import TableBasicVersionCellTreeItems from '../../storybook/assets/components/table-basic-version/table-cell-tree-items.png';
import TableBasicVersionContentTemplateItems from '../../storybook/assets/components/table-basic-version/table-content-template-items.png';
import TableBasicVersionExampleCompact from '../../storybook/assets/components/table-basic-version/table-example-compact.png';
import TableBasicVersionExampleDefault from '../../storybook/assets/components/table-basic-version/table-example-default.png';
import TableBasicVersionHeaderTemplateItems from '../../storybook/assets/components/table-basic-version/table-header-template-items.png';
import TableBasicVersionHeaderSortingItems from '../../storybook/assets/components/table-basic-version/table-header-sorting-items.png';
import TableBasicVersionHeaderContentLogic from '../../storybook/assets/components/table-basic-version/table-header-content-logic.png';
import TableBasicVersionHeaderColumnActionReorder from '../../storybook/assets/components/table-basic-version/table-header-column-action-reorder.png';
import TableBasicVersionHeaderColumnActionResize from '../../storybook/assets/components/table-basic-version/table-header-column-action-resize.png';
import TableBasicVersionHeaderContentLogicZebra from '../../storybook/assets/components/table-basic-version/table-header-content-logic-zebra.png';
...
| Resources                                                                                                              |
|------------------------------------------------------------------------------------------------------------------------|
| [Figma table component →](https://www.figma.com/design/zPvPwPgb4EsYFXKC2nhzSG/Infineon-DDS-%7C-Main?node-id=2436-3945) |
...
### With zebra stripes
- Zebra striping eases orientation in large datasets, making it easier for users to navigate and understand the information.
- Key usage guideline:
    - Use zebra striping only for tables with more than 10 rows.
    - If a table uses very dynamic datasets (with items fewer or more than 10 rows), use zebra striping to maintain consistency.
<img src={TableBasicVersionHeaderContentLogicZebra} alt="Table Header Content Logic Zebra" />
