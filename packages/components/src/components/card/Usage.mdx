...
import CardAnatomy from '../../stories/assets/components/card/card-anatomy.png';
import CardFirstActionArea from '../../stories/assets/components/card/card-first-action-area.png';
import CardHorizontalAlign from '../../stories/assets/components/card/card-horizontal-alignment.png';
import CardHorizontalFirstActionArea from '../../stories/assets/components/card/card-horizontal-first-action-area.png';
import CardHorizontalMobile from '../../stories/assets/components/card/card-horizontal-mobile.png';
import CardHorizontalSecondActionArea from '../../stories/assets/components/card/card-horizontal-second-action-area.png';
import CardHorizontalStates from '../../stories/assets/components/card/card-horizontal-states.png';
import CardSecondActionArea from '../../stories/assets/components/card/card-second-action-area.png';
import CardSimple from '../../stories/assets/components/card/card-simple.png';
import CardStates from '../../stories/assets/components/card/card-states.png';
import CardWithButton from '../../stories/assets/components/card/card-with-button.png';
import CardWithLink from '../../stories/assets/components/card/card-with-link.png';
import CardWithRedirectLink from '../../stories/assets/components/card/card-with-redirect-link.png';
