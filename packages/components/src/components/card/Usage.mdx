...
import CardAnatomy from '../../storybook/assets/components/card/card-anatomy.png';
import CardFirstActionArea from '../../storybook/assets/components/card/card-first-action-area.png';
import CardHorizontalAlign from '../../storybook/assets/components/card/card-horizontal-alignment.png';
import CardHorizontalFirstActionArea from '../../storybook/assets/components/card/card-horizontal-first-action-area.png';
import CardHorizontalMobile from '../../storybook/assets/components/card/card-horizontal-mobile.png';
import CardHorizontalSecondActionArea from '../../storybook/assets/components/card/card-horizontal-second-action-area.png';
import CardHorizontalStates from '../../storybook/assets/components/card/card-horizontal-states.png';
import CardSecondActionArea from '../../storybook/assets/components/card/card-second-action-area.png';
import CardSimple from '../../storybook/assets/components/card/card-simple.png';
import CardStates from '../../storybook/assets/components/card/card-states.png';
import CardWithButton from '../../storybook/assets/components/card/card-with-button.png';
import CardWithLink from '../../storybook/assets/components/card/card-with-link.png';
import CardWithRedirectLink from '../../storybook/assets/components/card/card-with-redirect-link.png';
