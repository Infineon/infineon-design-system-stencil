...
import SearchBarInteracion from '../../stories/assets/components/search-bar/search-bar-interaction.png';
import SearchBarMobile from '../../stories/assets/components/search-bar/search-bar-mobile.png';
