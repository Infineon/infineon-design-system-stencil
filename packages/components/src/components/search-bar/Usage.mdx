...
import SearchBarInteracion from '../../storybook/assets/components/search-bar/search-bar-interaction.png';
import SearchBarMobile from '../../storybook/assets/components/search-bar/search-bar-mobile.png';
