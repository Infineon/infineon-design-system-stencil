  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => IfxSliderNgModuleValueAccessor),
      multi: true
    }
  ],
  standalone: false
})
export class IfxSliderNgModuleValueAccessor extends ValueAccessor {
...
export { IfxSliderNgModuleValueAccessor as IfxSliderValueAccessor };