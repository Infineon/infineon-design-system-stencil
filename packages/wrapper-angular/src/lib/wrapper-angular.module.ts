...
import { IfxCounterNgModuleValueAccessor } from "./ifx-counter-value-accessor";
...
@NgModule({
	declarations: [...DIRECTIVES, BooleanValueAccessor, TextValueAccessor, IfxCounterNgModuleValueAccessor, IfxModalNgModuleValueAccessor, IfxSliderNgModuleValueAccessor],
	exports: [...DIRECTIVES, BooleanValueAccessor, TextValueAccessor, IfxCounterNgModuleValueAccessor, IfxModalNgModuleValueAccessor, IfxSliderNgModuleValueAccessor],
