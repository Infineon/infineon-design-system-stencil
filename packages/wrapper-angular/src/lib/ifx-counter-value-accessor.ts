  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => IfxCounterNgModuleValueAccessor),
      multi: true
    }
  ],
  standalone: false
})
export class IfxCounterNgModuleValueAccessor extends ValueAccessor {
...
export { IfxCounterNgModuleValueAccessor as IfxCounterValueAccessor };