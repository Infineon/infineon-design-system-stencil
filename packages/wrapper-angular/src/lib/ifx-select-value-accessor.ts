	...
	providers: [
		{
			...
			useExisting: forwardRef(() => IfxSelectNgModuleValueAccessor),
			multi: true,
		},
	],
	standalone: false,
})
export class IfxSelectNgModuleValueAccessor extends ValueAccessor {
	override writeValue(value: string | null | undefined) {
		this.el.nativeElement.value = this.lastValue = value ?? "";
	}
}

export { IfxSelectNgModuleValueAccessor as IfxSelectValueAccessor };