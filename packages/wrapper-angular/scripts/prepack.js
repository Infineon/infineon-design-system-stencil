...
console.log(`Syncing version: ${distPackage.version} -> ${mainPackage.version}`);

distPackage.version = mainPackage.version;

if (distPackage.dependencies?.['@infineon/infineon-design-system-stencil'] === 'workspace:*') {
  distPackage.dependencies['@infineon/infineon-design-system-stencil'] = mainPackage.version;
