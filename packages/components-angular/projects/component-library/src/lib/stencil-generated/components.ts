...
@ProxyCmp({
  inputs: ['cols', 'rowHeight', 'rows', 'tableHeight']
})
@Component({
...
@ProxyCmp({
  inputs: ['disabled', 'fullWidth', 'href', 'size', 'target', 'theme', 'type', 'variant'],
  methods: ['setFocus']
})
@Component({
  selector: 'ifx-button',
...
@ProxyCmp({
  inputs: ['disabled', 'error', 'indeterminate', 'size', 'value'],
...
@ProxyCmp({
  inputs: ['placeholder', 'readOnly', 'size', 'value', 'variant']
})
@Component({
  selector: 'ifx-chip',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
export class IfxChip {
  ...
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['ifxChipChange']);
  }
}
...
export declare interface IfxChip extends Components.IfxChip {
  ...
  ifxChipChange: EventEmitter<CustomEvent<{ previousSelection: Array<IIfxChipChipItemSelectEvent>, currentSelection: Array<IIfxChipChipItemSelectEvent> }>>;
}
...
@ProxyCmp({
  inputs: ['disabled', 'error', 'size', 'success']
})
@Component({
...
@ProxyCmp({
  inputs: ['copyrightText', 'glossaryTarget', 'glossaryUrl', 'imprintTarget', 'imprintUrl', 'privacyPolicyTarget', 'privacyPolicyUrl', 'termsTarget', 'termsUrl', 'variant']
})
@Component({
  selector: 'ifx-footer',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
@ProxyCmp({
  inputs: ['alertIcon', 'cancelButtonLabel', 'caption', 'closeOnOverlayClick', 'okButtonLabel', 'opened', 'showCloseButton', 'size', 'variant']
})
@Component({
  selector: 'ifx-modal',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
@ProxyCmp({
  inputs: ['batchSize', 'disabled', 'error', 'errorMessage', 'label', 'maxItemCount', 'options', 'placeholder', 'showSearch', 'showSelectAll', 'size']
})
@Component({
...
@ProxyCmp({
  inputs: ['hideOnMobile', 'href', 'icon', 'showLabel', 'target'],
...
@ProxyCmp({
  inputs: ['disabled', 'isOpen', 'maxlength', 'value'],
...
@ProxyCmp({
  inputs: ['disabled', 'maxlength', 'placeholder', 'showDeleteIcon', 'size', 'value']
})
@Component({
...
@ProxyCmp({
  inputs: ['applicationName', 'copyrightText', 'imprint', 'initialCollapse', 'privacyPolicy', 'showFooter', 'showHeader', 'target', 'termsOfUse']
})
@Component({
...
@ProxyCmp({
  inputs: ['active', 'handleItemClick', 'href', 'icon', 'isActionItem', 'numberIndicator', 'target', 'value'],
...
@ProxyCmp({
  inputs: ['activeTabIndex', 'orientation']
})
@Component({
  selector: 'ifx-tabs',
  changeDetection: ChangeDetectionStrategy.OnPush,
...
export class IfxTabs {
  ...
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
    proxyOutputs(this, this.el, ['ifxTabChange']);
  }
}
...
export declare interface IfxTabs extends Components.IfxTabs {
  ...
  ifxTabChange: EventEmitter<CustomEvent<any>>;
}
...
@ProxyCmp({
  inputs: ['caption', 'disabled', 'error', 'icon', 'label', 'maxlength', 'optional', 'placeholder', 'required', 'size', 'success', 'value'],
  methods: ['reset']
})
@Component({
