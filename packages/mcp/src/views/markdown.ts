...
function generateFrameworkCode(
	...
	switch (framework) {
		case "react":
			return new ReactCodeFormatter().formatComponent(
				componentInfo,
				formatOptions,
			);
		case "vue":
			return new VueCodeFormatter().formatComponent(
				componentInfo,
				formatOptions,
			);
		case "angular":
			return new AngularCodeFormatter().formatComponent(
				componentInfo,
				formatOptions,
			);
		default:
			return new HTMLCodeFormatter().formatComponent(
				componentInfo,
				formatOptions,
			);
	}
