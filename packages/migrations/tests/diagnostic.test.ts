...
describe("compareDiagnostics", () => {
	test("sorts by code first", () => {
		const left: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a" };
		const right: MigrationDiagnostic = { code: "DDS002", severity: "warning", message: "b" };
		assert.ok(compareDiagnostics(left, right) < 0);
	});

	test("sorts by file path when codes match", () => {
		const left: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", filePath: "a.ts" };
		const right: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", filePath: "b.ts" };
		assert.ok(compareDiagnostics(left, right) < 0);
	});

	test("sorts by start offset", () => {
		const left: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", filePath: "x.ts", start: 10 };
		const right: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", filePath: "x.ts", start: 20 };
		assert.ok(compareDiagnostics(left, right) < 0);
	});

	test("sorts by end offset", () => {
		const left: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", filePath: "x.ts", start: 10, end: 15 };
		const right: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", filePath: "x.ts", start: 10, end: 20 };
		assert.ok(compareDiagnostics(left, right) < 0);
	});

	test("sorts by operation id", () => {
		const left: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", operationId: "a" };
		const right: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", operationId: "b" };
		assert.ok(compareDiagnostics(left, right) < 0);
	});

	test("diagnostics without a location sort before located diagnostics", () => {
		const left: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a" };
		const right: MigrationDiagnostic = { code: "DDS001", severity: "warning", message: "a", filePath: "x.ts", start: 0 };
		assert.ok(compareDiagnostics(left, right) < 0);
	});
