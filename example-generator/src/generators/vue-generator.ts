  ...
  generate(components: ComponentInfo[], config: GeneratorConfig): GenerationResult {
    ...
    try {
      ...
      for (const component of components) {
        ...
        const idSuffix = component.storyName && component.storyName !== 'Default' 
          ? `-${component.storyName.toLowerCase().replace(/\s+/g, '-')}` 
          : '';
        imports.push(`import ${componentClassName} from './generated/${componentClassName}.vue';`);
        componentTags.push(
          `    <section id="${component.component}-example${idSuffix}" class="component-example">\n` +
