...
export class FileUpdater implements IFileUpdater {
  ...
  updateFile(filePath: string, regions: Record<string, string>): boolean {
    ...
    for (const [regionName, newContent] of Object.entries(regions)) {
      ...
      const result = this.replaceRegion(content, startMarker, endMarker, newContent);
      if (result !== content) {
        content = result;
        updated = true;
      }
  ...
  protected getMarkersForRegion(regionName: string): [string, string] {
    const markerMap: Record<string, [string, string]> = {
      'imports': ['/* <AUTO-GENERATED-IMPORTS> */', '/* </AUTO-GENERATED-IMPORTS> */'],
      'components': ['/* <AUTO-GENERATED-COMPONENTS> */', '/* </AUTO-GENERATED-COMPONENTS> */'],
      'html-components': ['<!-- <AUTO-GENERATED-COMPONENTS> -->', '<!-- </AUTO-GENERATED-COMPONENTS> -->'],
      'html-scripts': ['/* <AUTO-GENERATED-SCRIPTS> */', '/* </AUTO-GENERATED-SCRIPTS> */'],
    };
  ...
  protected replaceRegion(
    ...
    const indentMatch = content.substring(0, match.index!).match(/[ \t]*$/);
